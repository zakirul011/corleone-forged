...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'dually-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'SIEGEL INNER | DF-4523', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper siegel-inner-df-4523 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>SIEGEL INNER <span>its easy to build</span></h3>
                                <h1>DF-4523</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/siegel-inner/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/siegel-inner/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/siegel-inner/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/siegel-inner/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/siegel-inner/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/siegel-inner/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/siegel-inner/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Accents/2.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/4.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/5.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/6.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/7.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/8.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/9.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/10.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/11.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/12.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/13.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/14.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/18.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/20.png" alt="">
                                            <img data-src="./img/siegel-inner/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Cap Letter/2.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/4.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/5.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/6.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/7.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/8.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/9.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/10.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/11.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/12.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/13.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/14.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/18.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/20.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Cap/2.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/4.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/5.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/6.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/7.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/8.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/9.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/10.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/11.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/12.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/13.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/14.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/18.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/20.png" alt="">
                                            <img data-src="./img/siegel-inner/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/siegel-inner/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Spike/2.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/4.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/5.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/6.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/7.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/8.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/9.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/10.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/11.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/12.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/13.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/14.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/18.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/20.png" alt="">
                                            <img data-src="./img/siegel-inner/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/siegel-inner/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Face/2.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/4.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/5.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/6.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/7.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/8.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/9.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/10.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/11.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/12.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/13.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/14.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/18.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/20.png" alt="">
                                            <img data-src="./img/siegel-inner/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/siegel-inner/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/siegel-inner/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./siegel-inner-df-4523.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
