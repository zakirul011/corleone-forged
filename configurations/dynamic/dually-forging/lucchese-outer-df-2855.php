...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'dually-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'LUCCHESE OUTER | DF-2855', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper lucchese-outer-df-2855 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>LUCCHESE OUTER <span>its easy to build</span></h3>
                                <h1>DF-2855</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/lucchese-outer/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/lucchese-outer/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/lucchese-outer/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/lucchese-outer/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/lucchese-outer/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/lucchese-outer/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Accents/2.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/4.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/5.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/6.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/7.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/8.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/9.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/10.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/11.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/12.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/13.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/14.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/18.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/20.png" alt="">
                                            <img data-src="./img/lucchese-outer/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Cap Letter/2.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/4.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/5.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/6.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/7.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/8.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/9.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/10.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/11.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/12.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/13.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/14.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/18.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/20.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Cap/2.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/4.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/5.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/6.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/7.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/8.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/9.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/10.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/11.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/12.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/13.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/14.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/18.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/20.png" alt="">
                                            <img data-src="./img/lucchese-outer/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/lucchese-outer/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Spike/2.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/4.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/5.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/6.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/7.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/8.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/9.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/10.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/11.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/12.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/13.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/14.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/18.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/20.png" alt="">
                                            <img data-src="./img/lucchese-outer/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Face/2.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/4.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/5.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/6.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/7.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/8.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/9.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/10.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/11.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/12.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/13.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/14.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/18.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/20.png" alt="">
                                            <img data-src="./img/lucchese-outer/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/lucchese-outer/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/lucchese-outer/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./lucchese-outer-df-2855.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
