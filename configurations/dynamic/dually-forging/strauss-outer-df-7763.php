...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'dually-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'STRAUSS OUTER | DF-7763', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper strauss-outer-df-7763 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>STRAUSS OUTER <span>its easy to build</span></h3>
                                <h1>DF-7763</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/strauss-outer/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strauss-outer/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strauss-outer/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strauss-outer/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strauss-outer/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strauss-outer/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/strauss-outer/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Accents/2.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/4.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/5.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/6.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/7.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/8.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/9.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/10.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/11.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/12.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/13.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/14.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/18.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/20.png" alt="">
                                            <img data-src="./img/strauss-outer/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Cap Letter/2.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/4.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/5.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/6.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/7.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/8.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/9.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/10.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/11.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/12.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/13.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/14.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/18.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/20.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Cap/2.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/4.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/5.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/6.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/7.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/8.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/9.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/10.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/11.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/12.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/13.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/14.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/18.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/20.png" alt="">
                                            <img data-src="./img/strauss-outer/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/strauss-outer/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Spike/2.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/4.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/5.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/6.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/7.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/8.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/9.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/10.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/11.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/12.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/13.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/14.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/18.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/20.png" alt="">
                                            <img data-src="./img/strauss-outer/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/strauss-outer/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Face/2.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/4.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/5.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/6.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/7.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/8.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/9.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/10.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/11.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/12.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/13.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/14.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/18.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/20.png" alt="">
                                            <img data-src="./img/strauss-outer/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strauss-outer/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/strauss-outer/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./strauss-outer-df-7763.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
