...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'concave-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'ROCCO | CF-1260', 'face' => $face, 'accents' => $accents, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper rocco-cf-1260 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>ROCCO <span>its easy to build</span></h3>
                                <h1>CF-1260</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/rocco/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/rocco/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/rocco/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/rocco/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/rocco/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/rocco/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/rocco/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/rocco/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Face/2.png" alt="">
                                            <img data-src="./img/rocco/Face/4.png" alt="">
                                            <img data-src="./img/rocco/Face/5.png" alt="">
                                            <img data-src="./img/rocco/Face/6.png" alt="">
                                            <img data-src="./img/rocco/Face/7.png" alt="">
                                            <img data-src="./img/rocco/Face/8.png" alt="">
                                            <img data-src="./img/rocco/Face/9.png" alt="">
                                            <img data-src="./img/rocco/Face/10.png" alt="">
                                            <img data-src="./img/rocco/Face/11.png" alt="">
                                            <img data-src="./img/rocco/Face/12.png" alt="">
                                            <img data-src="./img/rocco/Face/13.png" alt="">
                                            <img data-src="./img/rocco/Face/14.png" alt="">
                                            <img data-src="./img/rocco/Face/18.png" alt="">
                                            <img data-src="./img/rocco/Face/20.png" alt="">
                                            <img data-src="./img/rocco/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Accents/2.png" alt="">
                                            <img data-src="./img/rocco/Accents/4.png" alt="">
                                            <img data-src="./img/rocco/Accents/5.png" alt="">
                                            <img data-src="./img/rocco/Accents/6.png" alt="">
                                            <img data-src="./img/rocco/Accents/7.png" alt="">
                                            <img data-src="./img/rocco/Accents/8.png" alt="">
                                            <img data-src="./img/rocco/Accents/9.png" alt="">
                                            <img data-src="./img/rocco/Accents/10.png" alt="">
                                            <img data-src="./img/rocco/Accents/11.png" alt="">
                                            <img data-src="./img/rocco/Accents/12.png" alt="">
                                            <img data-src="./img/rocco/Accents/13.png" alt="">
                                            <img data-src="./img/rocco/Accents/14.png" alt="">
                                            <img data-src="./img/rocco/Accents/18.png" alt="">
                                            <img data-src="./img/rocco/Accents/20.png" alt="">
                                            <img data-src="./img/rocco/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Cap Letter/2.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/4.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/5.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/6.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/7.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/8.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/9.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/10.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/11.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/12.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/13.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/14.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/18.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/20.png" alt="">
                                            <img data-src="./img/rocco/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Cap/2.png" alt="">
                                            <img data-src="./img/rocco/Cap/4.png" alt="">
                                            <img data-src="./img/rocco/Cap/5.png" alt="">
                                            <img data-src="./img/rocco/Cap/6.png" alt="">
                                            <img data-src="./img/rocco/Cap/7.png" alt="">
                                            <img data-src="./img/rocco/Cap/8.png" alt="">
                                            <img data-src="./img/rocco/Cap/9.png" alt="">
                                            <img data-src="./img/rocco/Cap/10.png" alt="">
                                            <img data-src="./img/rocco/Cap/11.png" alt="">
                                            <img data-src="./img/rocco/Cap/12.png" alt="">
                                            <img data-src="./img/rocco/Cap/13.png" alt="">
                                            <img data-src="./img/rocco/Cap/14.png" alt="">
                                            <img data-src="./img/rocco/Cap/18.png" alt="">
                                            <img data-src="./img/rocco/Cap/20.png" alt="">
                                            <img data-src="./img/rocco/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/rocco/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Bolts/2.png" alt="">
                                            <img data-src="./img/rocco/Bolts/4.png" alt="">
                                            <img data-src="./img/rocco/Bolts/5.png" alt="">
                                            <img data-src="./img/rocco/Bolts/6.png" alt="">
                                            <img data-src="./img/rocco/Bolts/7.png" alt="">
                                            <img data-src="./img/rocco/Bolts/8.png" alt="">
                                            <img data-src="./img/rocco/Bolts/9.png" alt="">
                                            <img data-src="./img/rocco/Bolts/10.png" alt="">
                                            <img data-src="./img/rocco/Bolts/11.png" alt="">
                                            <img data-src="./img/rocco/Bolts/12.png" alt="">
                                            <img data-src="./img/rocco/Bolts/13.png" alt="">
                                            <img data-src="./img/rocco/Bolts/14.png" alt="">
                                            <img data-src="./img/rocco/Bolts/18.png" alt="">
                                            <img data-src="./img/rocco/Bolts/20.png" alt="">
                                            <img data-src="./img/rocco/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/rocco/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/rocco/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/rocco/Inner Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/rocco/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./rocco-cf-1260.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
