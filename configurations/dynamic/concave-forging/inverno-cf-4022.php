...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'concave-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'INVERNO | CF-4022', 'faceletter' => $faceletter, 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper inverno-cf-4022 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/inverno/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/inverno/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/inverno/Inner Barrel/2.png" alt="">
                                        </div>
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./inverno-cf-4022.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
