                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/salerno/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Inner Barrel/2.png" alt="">
                                        </div>
