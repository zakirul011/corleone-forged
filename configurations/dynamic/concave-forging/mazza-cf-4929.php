...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'concave-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'MAZZA | CF-4929', 'faceletter' => $faceletter, 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap, 'outerbarrel' => $outerbarrel, 'innerbarrrel' => $innerbarrrel,'image_path' => $image_path    ));
    ...
    <div class="config-wrapper mazza-cf-4929 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>MAZZA <span>its easy to build</span></h3>
                                <h1>CF-4929</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/mazza/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/mazza/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/mazza/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/mazza/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/mazza/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/mazza/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/mazza/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/mazza/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Face/2.png" alt="">
                                            <img data-src="./img/mazza/Face/4.png" alt="">
                                            <img data-src="./img/mazza/Face/5.png" alt="">
                                            <img data-src="./img/mazza/Face/6.png" alt="">
                                            <img data-src="./img/mazza/Face/7.png" alt="">
                                            <img data-src="./img/mazza/Face/8.png" alt="">
                                            <img data-src="./img/mazza/Face/9.png" alt="">
                                            <img data-src="./img/mazza/Face/10.png" alt="">
                                            <img data-src="./img/mazza/Face/11.png" alt="">
                                            <img data-src="./img/mazza/Face/12.png" alt="">
                                            <img data-src="./img/mazza/Face/13.png" alt="">
                                            <img data-src="./img/mazza/Face/14.png" alt="">
                                            <img data-src="./img/mazza/Face/18.png" alt="">
                                            <img data-src="./img/mazza/Face/20.png" alt="">
                                            <img data-src="./img/mazza/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Face Letter/2.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/4.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/5.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/6.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/7.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/8.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/9.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/10.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/11.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/12.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/13.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/14.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/18.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/20.png" alt="">
                                            <img data-src="./img/mazza/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Accents/2.png" alt="">
                                            <img data-src="./img/mazza/Accents/4.png" alt="">
                                            <img data-src="./img/mazza/Accents/5.png" alt="">
                                            <img data-src="./img/mazza/Accents/6.png" alt="">
                                            <img data-src="./img/mazza/Accents/7.png" alt="">
                                            <img data-src="./img/mazza/Accents/8.png" alt="">
                                            <img data-src="./img/mazza/Accents/9.png" alt="">
                                            <img data-src="./img/mazza/Accents/10.png" alt="">
                                            <img data-src="./img/mazza/Accents/11.png" alt="">
                                            <img data-src="./img/mazza/Accents/12.png" alt="">
                                            <img data-src="./img/mazza/Accents/13.png" alt="">
                                            <img data-src="./img/mazza/Accents/14.png" alt="">
                                            <img data-src="./img/mazza/Accents/18.png" alt="">
                                            <img data-src="./img/mazza/Accents/20.png" alt="">
                                            <img data-src="./img/mazza/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Cap Letter/2.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/4.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/5.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/6.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/7.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/8.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/9.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/10.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/11.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/12.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/13.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/14.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/18.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/20.png" alt="">
                                            <img data-src="./img/mazza/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Cap/2.png" alt="">
                                            <img data-src="./img/mazza/Cap/4.png" alt="">
                                            <img data-src="./img/mazza/Cap/5.png" alt="">
                                            <img data-src="./img/mazza/Cap/6.png" alt="">
                                            <img data-src="./img/mazza/Cap/7.png" alt="">
                                            <img data-src="./img/mazza/Cap/8.png" alt="">
                                            <img data-src="./img/mazza/Cap/9.png" alt="">
                                            <img data-src="./img/mazza/Cap/10.png" alt="">
                                            <img data-src="./img/mazza/Cap/11.png" alt="">
                                            <img data-src="./img/mazza/Cap/12.png" alt="">
                                            <img data-src="./img/mazza/Cap/13.png" alt="">
                                            <img data-src="./img/mazza/Cap/14.png" alt="">
                                            <img data-src="./img/mazza/Cap/18.png" alt="">
                                            <img data-src="./img/mazza/Cap/20.png" alt="">
                                            <img data-src="./img/mazza/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/mazza/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/mazza/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/mazza/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/mazza/Inner Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/mazza/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./mazza-cf-4929.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
