...
<body>
    ...
    <div class="config-wrapper pitera-cf-8394 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>PITERA <span>its easy to build</span></h3>
                                <h1>CF-8394</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/pitera/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/pitera/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/pitera/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/pitera/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/pitera/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/pitera/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/pitera/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/pitera/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/pitera/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Face/2.png" alt="">
                                            <img data-src="./img/pitera/Face/4.png" alt="">
                                            <img data-src="./img/pitera/Face/5.png" alt="">
                                            <img data-src="./img/pitera/Face/6.png" alt="">
                                            <img data-src="./img/pitera/Face/7.png" alt="">
                                            <img data-src="./img/pitera/Face/8.png" alt="">
                                            <img data-src="./img/pitera/Face/9.png" alt="">
                                            <img data-src="./img/pitera/Face/10.png" alt="">
                                            <img data-src="./img/pitera/Face/11.png" alt="">
                                            <img data-src="./img/pitera/Face/12.png" alt="">
                                            <img data-src="./img/pitera/Face/13.png" alt="">
                                            <img data-src="./img/pitera/Face/14.png" alt="">
                                            <img data-src="./img/pitera/Face/18.png" alt="">
                                            <img data-src="./img/pitera/Face/20.png" alt="">
                                            <img data-src="./img/pitera/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Face Letter/2.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/4.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/5.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/6.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/7.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/8.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/9.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/10.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/11.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/12.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/13.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/14.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/18.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/20.png" alt="">
                                            <img data-src="./img/pitera/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Accents/2.png" alt="">
                                            <img data-src="./img/pitera/Accents/4.png" alt="">
                                            <img data-src="./img/pitera/Accents/5.png" alt="">
                                            <img data-src="./img/pitera/Accents/6.png" alt="">
                                            <img data-src="./img/pitera/Accents/7.png" alt="">
                                            <img data-src="./img/pitera/Accents/8.png" alt="">
                                            <img data-src="./img/pitera/Accents/9.png" alt="">
                                            <img data-src="./img/pitera/Accents/10.png" alt="">
                                            <img data-src="./img/pitera/Accents/11.png" alt="">
                                            <img data-src="./img/pitera/Accents/12.png" alt="">
                                            <img data-src="./img/pitera/Accents/13.png" alt="">
                                            <img data-src="./img/pitera/Accents/14.png" alt="">
                                            <img data-src="./img/pitera/Accents/18.png" alt="">
                                            <img data-src="./img/pitera/Accents/20.png" alt="">
                                            <img data-src="./img/pitera/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Cap Letter/2.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/4.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/5.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/6.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/7.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/8.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/9.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/10.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/11.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/12.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/13.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/14.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/18.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/20.png" alt="">
                                            <img data-src="./img/pitera/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Cap/2.png" alt="">
                                            <img data-src="./img/pitera/Cap/4.png" alt="">
                                            <img data-src="./img/pitera/Cap/5.png" alt="">
                                            <img data-src="./img/pitera/Cap/6.png" alt="">
                                            <img data-src="./img/pitera/Cap/7.png" alt="">
                                            <img data-src="./img/pitera/Cap/8.png" alt="">
                                            <img data-src="./img/pitera/Cap/9.png" alt="">
                                            <img data-src="./img/pitera/Cap/10.png" alt="">
                                            <img data-src="./img/pitera/Cap/11.png" alt="">
                                            <img data-src="./img/pitera/Cap/12.png" alt="">
                                            <img data-src="./img/pitera/Cap/13.png" alt="">
                                            <img data-src="./img/pitera/Cap/14.png" alt="">
                                            <img data-src="./img/pitera/Cap/18.png" alt="">
                                            <img data-src="./img/pitera/Cap/20.png" alt="">
                                            <img data-src="./img/pitera/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/pitera/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Bolts/2.png" alt="">
                                            <img data-src="./img/pitera/Bolts/4.png" alt="">
                                            <img data-src="./img/pitera/Bolts/5.png" alt="">
                                            <img data-src="./img/pitera/Bolts/6.png" alt="">
                                            <img data-src="./img/pitera/Bolts/7.png" alt="">
                                            <img data-src="./img/pitera/Bolts/8.png" alt="">
                                            <img data-src="./img/pitera/Bolts/9.png" alt="">
                                            <img data-src="./img/pitera/Bolts/10.png" alt="">
                                            <img data-src="./img/pitera/Bolts/11.png" alt="">
                                            <img data-src="./img/pitera/Bolts/12.png" alt="">
                                            <img data-src="./img/pitera/Bolts/13.png" alt="">
                                            <img data-src="./img/pitera/Bolts/14.png" alt="">
                                            <img data-src="./img/pitera/Bolts/18.png" alt="">
                                            <img data-src="./img/pitera/Bolts/20.png" alt="">
                                            <img data-src="./img/pitera/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/pitera/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/pitera/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/pitera/Inner Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/pitera/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./pitera-cf-8394.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
