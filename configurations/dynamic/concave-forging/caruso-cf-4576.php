...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'concave-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'CARUSO | CF-4576', 'faceletter' => $faceletter, 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper caruso-cf-4576 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>CARUSO <span>its easy to build</span></h3>
                                <h1>CF-4576</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/caruso/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/caruso/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/caruso/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/caruso/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/caruso/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/caruso/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/caruso/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/caruso/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/caruso/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Face/2.png" alt="">
                                            <img data-src="./img/caruso/Face/4.png" alt="">
                                            <img data-src="./img/caruso/Face/5.png" alt="">
                                            <img data-src="./img/caruso/Face/6.png" alt="">
                                            <img data-src="./img/caruso/Face/7.png" alt="">
                                            <img data-src="./img/caruso/Face/8.png" alt="">
                                            <img data-src="./img/caruso/Face/9.png" alt="">
                                            <img data-src="./img/caruso/Face/10.png" alt="">
                                            <img data-src="./img/caruso/Face/11.png" alt="">
                                            <img data-src="./img/caruso/Face/12.png" alt="">
                                            <img data-src="./img/caruso/Face/13.png" alt="">
                                            <img data-src="./img/caruso/Face/14.png" alt="">
                                            <img data-src="./img/caruso/Face/18.png" alt="">
                                            <img data-src="./img/caruso/Face/20.png" alt="">
                                            <img data-src="./img/caruso/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Face Letter/2.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/4.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/5.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/6.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/7.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/8.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/9.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/10.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/11.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/12.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/13.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/14.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/18.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/20.png" alt="">
                                            <img data-src="./img/caruso/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Accents/2.png" alt="">
                                            <img data-src="./img/caruso/Accents/4.png" alt="">
                                            <img data-src="./img/caruso/Accents/5.png" alt="">
                                            <img data-src="./img/caruso/Accents/6.png" alt="">
                                            <img data-src="./img/caruso/Accents/7.png" alt="">
                                            <img data-src="./img/caruso/Accents/8.png" alt="">
                                            <img data-src="./img/caruso/Accents/9.png" alt="">
                                            <img data-src="./img/caruso/Accents/10.png" alt="">
                                            <img data-src="./img/caruso/Accents/11.png" alt="">
                                            <img data-src="./img/caruso/Accents/12.png" alt="">
                                            <img data-src="./img/caruso/Accents/13.png" alt="">
                                            <img data-src="./img/caruso/Accents/14.png" alt="">
                                            <img data-src="./img/caruso/Accents/18.png" alt="">
                                            <img data-src="./img/caruso/Accents/20.png" alt="">
                                            <img data-src="./img/caruso/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Cap Letter/2.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/4.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/5.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/6.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/7.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/8.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/9.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/10.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/11.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/12.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/13.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/14.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/18.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/20.png" alt="">
                                            <img data-src="./img/caruso/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Cap/2.png" alt="">
                                            <img data-src="./img/caruso/Cap/4.png" alt="">
                                            <img data-src="./img/caruso/Cap/5.png" alt="">
                                            <img data-src="./img/caruso/Cap/6.png" alt="">
                                            <img data-src="./img/caruso/Cap/7.png" alt="">
                                            <img data-src="./img/caruso/Cap/8.png" alt="">
                                            <img data-src="./img/caruso/Cap/9.png" alt="">
                                            <img data-src="./img/caruso/Cap/10.png" alt="">
                                            <img data-src="./img/caruso/Cap/11.png" alt="">
                                            <img data-src="./img/caruso/Cap/12.png" alt="">
                                            <img data-src="./img/caruso/Cap/13.png" alt="">
                                            <img data-src="./img/caruso/Cap/14.png" alt="">
                                            <img data-src="./img/caruso/Cap/18.png" alt="">
                                            <img data-src="./img/caruso/Cap/20.png" alt="">
                                            <img data-src="./img/caruso/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/caruso/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Bolts/2.png" alt="">
                                            <img data-src="./img/caruso/Bolts/4.png" alt="">
                                            <img data-src="./img/caruso/Bolts/5.png" alt="">
                                            <img data-src="./img/caruso/Bolts/6.png" alt="">
                                            <img data-src="./img/caruso/Bolts/7.png" alt="">
                                            <img data-src="./img/caruso/Bolts/8.png" alt="">
                                            <img data-src="./img/caruso/Bolts/9.png" alt="">
                                            <img data-src="./img/caruso/Bolts/10.png" alt="">
                                            <img data-src="./img/caruso/Bolts/11.png" alt="">
                                            <img data-src="./img/caruso/Bolts/12.png" alt="">
                                            <img data-src="./img/caruso/Bolts/13.png" alt="">
                                            <img data-src="./img/caruso/Bolts/14.png" alt="">
                                            <img data-src="./img/caruso/Bolts/18.png" alt="">
                                            <img data-src="./img/caruso/Bolts/20.png" alt="">
                                            <img data-src="./img/caruso/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/caruso/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/caruso/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/caruso/Inner Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/caruso/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./caruso-cf-4576.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
