...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'concave-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'LEGGERO | CF-5323', 'faceletter' => $faceletter, 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper leggero-cf-5323 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>LEGGERO <span>its easy to build</span></h3>
                                <h1>CF-5323</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/leggero/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/leggero/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/leggero/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/leggero/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/leggero/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/leggero/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/leggero/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/leggero/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/leggero/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Face/2.png" alt="">
                                            <img data-src="./img/leggero/Face/4.png" alt="">
                                            <img data-src="./img/leggero/Face/5.png" alt="">
                                            <img data-src="./img/leggero/Face/6.png" alt="">
                                            <img data-src="./img/leggero/Face/7.png" alt="">
                                            <img data-src="./img/leggero/Face/8.png" alt="">
                                            <img data-src="./img/leggero/Face/9.png" alt="">
                                            <img data-src="./img/leggero/Face/10.png" alt="">
                                            <img data-src="./img/leggero/Face/11.png" alt="">
                                            <img data-src="./img/leggero/Face/12.png" alt="">
                                            <img data-src="./img/leggero/Face/13.png" alt="">
                                            <img data-src="./img/leggero/Face/14.png" alt="">
                                            <img data-src="./img/leggero/Face/18.png" alt="">
                                            <img data-src="./img/leggero/Face/20.png" alt="">
                                            <img data-src="./img/leggero/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Face Letter/2.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/4.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/5.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/6.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/7.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/8.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/9.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/10.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/11.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/12.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/13.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/14.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/18.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/20.png" alt="">
                                            <img data-src="./img/leggero/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Accents/2.png" alt="">
                                            <img data-src="./img/leggero/Accents/4.png" alt="">
                                            <img data-src="./img/leggero/Accents/5.png" alt="">
                                            <img data-src="./img/leggero/Accents/6.png" alt="">
                                            <img data-src="./img/leggero/Accents/7.png" alt="">
                                            <img data-src="./img/leggero/Accents/8.png" alt="">
                                            <img data-src="./img/leggero/Accents/9.png" alt="">
                                            <img data-src="./img/leggero/Accents/10.png" alt="">
                                            <img data-src="./img/leggero/Accents/11.png" alt="">
                                            <img data-src="./img/leggero/Accents/12.png" alt="">
                                            <img data-src="./img/leggero/Accents/13.png" alt="">
                                            <img data-src="./img/leggero/Accents/14.png" alt="">
                                            <img data-src="./img/leggero/Accents/18.png" alt="">
                                            <img data-src="./img/leggero/Accents/20.png" alt="">
                                            <img data-src="./img/leggero/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Cap Letter/2.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/4.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/5.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/6.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/7.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/8.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/9.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/10.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/11.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/12.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/13.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/14.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/18.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/20.png" alt="">
                                            <img data-src="./img/leggero/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Cap/2.png" alt="">
                                            <img data-src="./img/leggero/Cap/4.png" alt="">
                                            <img data-src="./img/leggero/Cap/5.png" alt="">
                                            <img data-src="./img/leggero/Cap/6.png" alt="">
                                            <img data-src="./img/leggero/Cap/7.png" alt="">
                                            <img data-src="./img/leggero/Cap/8.png" alt="">
                                            <img data-src="./img/leggero/Cap/9.png" alt="">
                                            <img data-src="./img/leggero/Cap/10.png" alt="">
                                            <img data-src="./img/leggero/Cap/11.png" alt="">
                                            <img data-src="./img/leggero/Cap/12.png" alt="">
                                            <img data-src="./img/leggero/Cap/13.png" alt="">
                                            <img data-src="./img/leggero/Cap/14.png" alt="">
                                            <img data-src="./img/leggero/Cap/18.png" alt="">
                                            <img data-src="./img/leggero/Cap/20.png" alt="">
                                            <img data-src="./img/leggero/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/leggero/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Bolts/2.png" alt="">
                                            <img data-src="./img/leggero/Bolts/4.png" alt="">
                                            <img data-src="./img/leggero/Bolts/5.png" alt="">
                                            <img data-src="./img/leggero/Bolts/6.png" alt="">
                                            <img data-src="./img/leggero/Bolts/7.png" alt="">
                                            <img data-src="./img/leggero/Bolts/8.png" alt="">
                                            <img data-src="./img/leggero/Bolts/9.png" alt="">
                                            <img data-src="./img/leggero/Bolts/10.png" alt="">
                                            <img data-src="./img/leggero/Bolts/11.png" alt="">
                                            <img data-src="./img/leggero/Bolts/12.png" alt="">
                                            <img data-src="./img/leggero/Bolts/13.png" alt="">
                                            <img data-src="./img/leggero/Bolts/14.png" alt="">
                                            <img data-src="./img/leggero/Bolts/18.png" alt="">
                                            <img data-src="./img/leggero/Bolts/20.png" alt="">
                                            <img data-src="./img/leggero/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/leggero/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/leggero/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/leggero/Inner Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/leggero/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./leggero-cf-5323.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
