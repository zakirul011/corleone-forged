...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'concave-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'STROLLO | CF-8936', 'faceletter' => $faceletter, 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper strollo-cf-8936 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>STROLLO <span>its easy to build</span></h3>
                                <h1>CF-8936</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/strollo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strollo/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strollo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strollo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strollo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strollo/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strollo/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/strollo/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/strollo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Face/2.png" alt="">
                                            <img data-src="./img/strollo/Face/4.png" alt="">
                                            <img data-src="./img/strollo/Face/5.png" alt="">
                                            <img data-src="./img/strollo/Face/6.png" alt="">
                                            <img data-src="./img/strollo/Face/7.png" alt="">
                                            <img data-src="./img/strollo/Face/8.png" alt="">
                                            <img data-src="./img/strollo/Face/9.png" alt="">
                                            <img data-src="./img/strollo/Face/10.png" alt="">
                                            <img data-src="./img/strollo/Face/11.png" alt="">
                                            <img data-src="./img/strollo/Face/12.png" alt="">
                                            <img data-src="./img/strollo/Face/13.png" alt="">
                                            <img data-src="./img/strollo/Face/14.png" alt="">
                                            <img data-src="./img/strollo/Face/18.png" alt="">
                                            <img data-src="./img/strollo/Face/20.png" alt="">
                                            <img data-src="./img/strollo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Face Letter/2.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/4.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/5.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/6.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/7.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/8.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/9.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/10.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/11.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/12.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/13.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/14.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/18.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/20.png" alt="">
                                            <img data-src="./img/strollo/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Accents/2.png" alt="">
                                            <img data-src="./img/strollo/Accents/4.png" alt="">
                                            <img data-src="./img/strollo/Accents/5.png" alt="">
                                            <img data-src="./img/strollo/Accents/6.png" alt="">
                                            <img data-src="./img/strollo/Accents/7.png" alt="">
                                            <img data-src="./img/strollo/Accents/8.png" alt="">
                                            <img data-src="./img/strollo/Accents/9.png" alt="">
                                            <img data-src="./img/strollo/Accents/10.png" alt="">
                                            <img data-src="./img/strollo/Accents/11.png" alt="">
                                            <img data-src="./img/strollo/Accents/12.png" alt="">
                                            <img data-src="./img/strollo/Accents/13.png" alt="">
                                            <img data-src="./img/strollo/Accents/14.png" alt="">
                                            <img data-src="./img/strollo/Accents/18.png" alt="">
                                            <img data-src="./img/strollo/Accents/20.png" alt="">
                                            <img data-src="./img/strollo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/strollo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Cap/2.png" alt="">
                                            <img data-src="./img/strollo/Cap/4.png" alt="">
                                            <img data-src="./img/strollo/Cap/5.png" alt="">
                                            <img data-src="./img/strollo/Cap/6.png" alt="">
                                            <img data-src="./img/strollo/Cap/7.png" alt="">
                                            <img data-src="./img/strollo/Cap/8.png" alt="">
                                            <img data-src="./img/strollo/Cap/9.png" alt="">
                                            <img data-src="./img/strollo/Cap/10.png" alt="">
                                            <img data-src="./img/strollo/Cap/11.png" alt="">
                                            <img data-src="./img/strollo/Cap/12.png" alt="">
                                            <img data-src="./img/strollo/Cap/13.png" alt="">
                                            <img data-src="./img/strollo/Cap/14.png" alt="">
                                            <img data-src="./img/strollo/Cap/18.png" alt="">
                                            <img data-src="./img/strollo/Cap/20.png" alt="">
                                            <img data-src="./img/strollo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/strollo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Bolts/2.png" alt="">
                                            <img data-src="./img/strollo/Bolts/4.png" alt="">
                                            <img data-src="./img/strollo/Bolts/5.png" alt="">
                                            <img data-src="./img/strollo/Bolts/6.png" alt="">
                                            <img data-src="./img/strollo/Bolts/7.png" alt="">
                                            <img data-src="./img/strollo/Bolts/8.png" alt="">
                                            <img data-src="./img/strollo/Bolts/9.png" alt="">
                                            <img data-src="./img/strollo/Bolts/10.png" alt="">
                                            <img data-src="./img/strollo/Bolts/11.png" alt="">
                                            <img data-src="./img/strollo/Bolts/12.png" alt="">
                                            <img data-src="./img/strollo/Bolts/13.png" alt="">
                                            <img data-src="./img/strollo/Bolts/14.png" alt="">
                                            <img data-src="./img/strollo/Bolts/18.png" alt="">
                                            <img data-src="./img/strollo/Bolts/20.png" alt="">
                                            <img data-src="./img/strollo/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/strollo/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/strollo/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/strollo/Inner Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/strollo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./strollo-cf-8936.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
