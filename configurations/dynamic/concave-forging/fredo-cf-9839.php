...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'concave-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'FREDO | CF-9839', 'faceletter' => $faceletter, 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper fredo-cf-9839 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>FREDO <span>its easy to build</span></h3>
                                <h1>CF-9839</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/fredo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fredo/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fredo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fredo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fredo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fredo/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fredo/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fredo/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/fredo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Face/2.png" alt="">
                                            <img data-src="./img/fredo/Face/4.png" alt="">
                                            <img data-src="./img/fredo/Face/5.png" alt="">
                                            <img data-src="./img/fredo/Face/6.png" alt="">
                                            <img data-src="./img/fredo/Face/7.png" alt="">
                                            <img data-src="./img/fredo/Face/8.png" alt="">
                                            <img data-src="./img/fredo/Face/9.png" alt="">
                                            <img data-src="./img/fredo/Face/10.png" alt="">
                                            <img data-src="./img/fredo/Face/11.png" alt="">
                                            <img data-src="./img/fredo/Face/12.png" alt="">
                                            <img data-src="./img/fredo/Face/13.png" alt="">
                                            <img data-src="./img/fredo/Face/14.png" alt="">
                                            <img data-src="./img/fredo/Face/18.png" alt="">
                                            <img data-src="./img/fredo/Face/20.png" alt="">
                                            <img data-src="./img/fredo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Face Letter/2.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/4.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/5.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/6.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/7.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/8.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/9.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/10.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/11.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/12.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/13.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/14.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/18.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/20.png" alt="">
                                            <img data-src="./img/fredo/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Accents/2.png" alt="">
                                            <img data-src="./img/fredo/Accents/4.png" alt="">
                                            <img data-src="./img/fredo/Accents/5.png" alt="">
                                            <img data-src="./img/fredo/Accents/6.png" alt="">
                                            <img data-src="./img/fredo/Accents/7.png" alt="">
                                            <img data-src="./img/fredo/Accents/8.png" alt="">
                                            <img data-src="./img/fredo/Accents/9.png" alt="">
                                            <img data-src="./img/fredo/Accents/10.png" alt="">
                                            <img data-src="./img/fredo/Accents/11.png" alt="">
                                            <img data-src="./img/fredo/Accents/12.png" alt="">
                                            <img data-src="./img/fredo/Accents/13.png" alt="">
                                            <img data-src="./img/fredo/Accents/14.png" alt="">
                                            <img data-src="./img/fredo/Accents/18.png" alt="">
                                            <img data-src="./img/fredo/Accents/20.png" alt="">
                                            <img data-src="./img/fredo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/fredo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Cap/2.png" alt="">
                                            <img data-src="./img/fredo/Cap/4.png" alt="">
                                            <img data-src="./img/fredo/Cap/5.png" alt="">
                                            <img data-src="./img/fredo/Cap/6.png" alt="">
                                            <img data-src="./img/fredo/Cap/7.png" alt="">
                                            <img data-src="./img/fredo/Cap/8.png" alt="">
                                            <img data-src="./img/fredo/Cap/9.png" alt="">
                                            <img data-src="./img/fredo/Cap/10.png" alt="">
                                            <img data-src="./img/fredo/Cap/11.png" alt="">
                                            <img data-src="./img/fredo/Cap/12.png" alt="">
                                            <img data-src="./img/fredo/Cap/13.png" alt="">
                                            <img data-src="./img/fredo/Cap/14.png" alt="">
                                            <img data-src="./img/fredo/Cap/18.png" alt="">
                                            <img data-src="./img/fredo/Cap/20.png" alt="">
                                            <img data-src="./img/fredo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/fredo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Bolts/2.png" alt="">
                                            <img data-src="./img/fredo/Bolts/4.png" alt="">
                                            <img data-src="./img/fredo/Bolts/5.png" alt="">
                                            <img data-src="./img/fredo/Bolts/6.png" alt="">
                                            <img data-src="./img/fredo/Bolts/7.png" alt="">
                                            <img data-src="./img/fredo/Bolts/8.png" alt="">
                                            <img data-src="./img/fredo/Bolts/9.png" alt="">
                                            <img data-src="./img/fredo/Bolts/10.png" alt="">
                                            <img data-src="./img/fredo/Bolts/11.png" alt="">
                                            <img data-src="./img/fredo/Bolts/12.png" alt="">
                                            <img data-src="./img/fredo/Bolts/13.png" alt="">
                                            <img data-src="./img/fredo/Bolts/14.png" alt="">
                                            <img data-src="./img/fredo/Bolts/18.png" alt="">
                                            <img data-src="./img/fredo/Bolts/20.png" alt="">
                                            <img data-src="./img/fredo/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/fredo/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/fredo/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fredo/Inner Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/fredo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./fredo-cf-9839.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
