...
<body>
 ...
 <header>
    ...
    <!-- CONFIG AREA -->
    <div class="config-wrapper sereno pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>SERENO <span>its easy to build</span></h3>
                                <h1>sf-4601</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/SERENO/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/SERENO/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/SERENO/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/SERENO/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/SERENO/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/SERENO/default/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/SERENO/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/SERENO/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/SERENO/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Accents/2.png" alt="">
                                            <img data-src="./img/SERENO/Accents/4.png" alt="">
                                            <img data-src="./img/SERENO/Accents/5.png" alt="">
                                            <img data-src="./img/SERENO/Accents/6.png" alt="">
                                            <img data-src="./img/SERENO/Accents/7.png" alt="">
                                            <img data-src="./img/SERENO/Accents/8.png" alt="">
                                            <img data-src="./img/SERENO/Accents/9.png" alt="">
                                            <img data-src="./img/SERENO/Accents/10.png" alt="">
                                            <img data-src="./img/SERENO/Accents/11.png" alt="">
                                            <img data-src="./img/SERENO/Accents/12.png" alt="">
                                            <img data-src="./img/SERENO/Accents/13.png" alt="">
                                            <img data-src="./img/SERENO/Accents/14.png" alt="">
                                            <img data-src="./img/SERENO/Accents/18.png" alt="">
                                            <img data-src="./img/SERENO/Accents/20.png" alt="">
                                            <img data-src="./img/SERENO/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Face Letter/2.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/4.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/5.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/6.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/7.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/8.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/9.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/10.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/11.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/12.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/13.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/14.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/18.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/20.png" alt="">
                                            <img data-src="./img/SERENO/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Face/2.png" alt="">
                                            <img data-src="./img/SERENO/Face/4.png" alt="">
                                            <img data-src="./img/SERENO/Face/5.png" alt="">
                                            <img data-src="./img/SERENO/Face/6.png" alt="">
                                            <img data-src="./img/SERENO/Face/7.png" alt="">
                                            <img data-src="./img/SERENO/Face/8.png" alt="">
                                            <img data-src="./img/SERENO/Face/9.png" alt="">
                                            <img data-src="./img/SERENO/Face/10.png" alt="">
                                            <img data-src="./img/SERENO/Face/11.png" alt="">
                                            <img data-src="./img/SERENO/Face/12.png" alt="">
                                            <img data-src="./img/SERENO/Face/13.png" alt="">
                                            <img data-src="./img/SERENO/Face/14.png" alt="">
                                            <img data-src="./img/SERENO/Face/18.png" alt="">
                                            <img data-src="./img/SERENO/Face/20.png" alt="">
                                            <img data-src="./img/SERENO/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Cap Letter/2.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/4.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/5.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/6.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/7.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/8.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/9.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/10.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/11.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/12.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/13.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/14.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/18.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/20.png" alt="">
                                            <img data-src="./img/SERENO/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Cap/2.png" alt="">
                                            <img data-src="./img/SERENO/Cap/4.png" alt="">
                                            <img data-src="./img/SERENO/Cap/5.png" alt="">
                                            <img data-src="./img/SERENO/Cap/6.png" alt="">
                                            <img data-src="./img/SERENO/Cap/7.png" alt="">
                                            <img data-src="./img/SERENO/Cap/8.png" alt="">
                                            <img data-src="./img/SERENO/Cap/9.png" alt="">
                                            <img data-src="./img/SERENO/Cap/10.png" alt="">
                                            <img data-src="./img/SERENO/Cap/11.png" alt="">
                                            <img data-src="./img/SERENO/Cap/12.png" alt="">
                                            <img data-src="./img/SERENO/Cap/13.png" alt="">
                                            <img data-src="./img/SERENO/Cap/14.png" alt="">
                                            <img data-src="./img/SERENO/Cap/18.png" alt="">
                                            <img data-src="./img/SERENO/Cap/20.png" alt="">
                                            <img data-src="./img/SERENO/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/SERENO/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Bolts/2.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/4.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/5.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/6.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/7.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/8.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/9.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/10.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/11.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/12.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/13.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/14.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/18.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/20.png" alt="">
                                            <img data-src="./img/SERENO/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Bolts/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Bolts/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/SERENO/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/SERENO/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/SERENO/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/SERENO/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./sereno-sf-6582.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
