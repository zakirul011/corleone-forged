...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Cyrus | SF-6794', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper cyrus pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>CYRUS <span>its easy to build</span></h3>
                                <h1>SF-6794</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/CYRUS/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/CYRUS/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/CYRUS/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/CYRUS/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/CYRUS/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/CYRUS/default/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/CYRUS/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/CYRUS/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/CYRUS/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Accents/2.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/4.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/5.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/6.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/7.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/8.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/9.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/10.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/11.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/12.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/13.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/14.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/18.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/20.png" alt="">
                                            <img data-src="./img/CYRUS/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Face Letter/2.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/4.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/5.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/6.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/7.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/8.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/9.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/10.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/11.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/12.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/13.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/14.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/18.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/20.png" alt="">
                                            <img data-src="./img/CYRUS/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Face/2.png" alt="">
                                            <img data-src="./img/CYRUS/Face/4.png" alt="">
                                            <img data-src="./img/CYRUS/Face/5.png" alt="">
                                            <img data-src="./img/CYRUS/Face/6.png" alt="">
                                            <img data-src="./img/CYRUS/Face/7.png" alt="">
                                            <img data-src="./img/CYRUS/Face/8.png" alt="">
                                            <img data-src="./img/CYRUS/Face/9.png" alt="">
                                            <img data-src="./img/CYRUS/Face/10.png" alt="">
                                            <img data-src="./img/CYRUS/Face/11.png" alt="">
                                            <img data-src="./img/CYRUS/Face/12.png" alt="">
                                            <img data-src="./img/CYRUS/Face/13.png" alt="">
                                            <img data-src="./img/CYRUS/Face/14.png" alt="">
                                            <img data-src="./img/CYRUS/Face/18.png" alt="">
                                            <img data-src="./img/CYRUS/Face/20.png" alt="">
                                            <img data-src="./img/CYRUS/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Cap Letter/2.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/4.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/5.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/6.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/7.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/8.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/9.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/10.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/11.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/12.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/13.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/14.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/18.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/20.png" alt="">
                                            <img data-src="./img/CYRUS/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Cap/2.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/4.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/5.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/6.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/7.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/8.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/9.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/10.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/11.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/12.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/13.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/14.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/18.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/20.png" alt="">
                                            <img data-src="./img/CYRUS/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/CYRUS/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Bolts/2.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/4.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/5.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/6.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/7.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/8.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/9.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/10.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/11.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/12.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/13.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/14.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/18.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/20.png" alt="">
                                            <img data-src="./img/CYRUS/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Bolts/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Bolts/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/CYRUS/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/CYRUS/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/CYRUS/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/CYRUS/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./cyrus-sf-6794.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
