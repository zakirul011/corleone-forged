...
<?php function includeWithVariables($filePath, $variables = array(), $print = true) {
 ...
 <header>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Veloce | SF-2487', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <!-- CONFIG AREA -->
    <div class="config-wrapper veloce pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>VELOCE <span>its easy to build</span></h3>
                                <h1>sf-2487</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/VELOCE/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VELOCE/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VELOCE/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VELOCE/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VELOCE/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VELOCE/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VELOCE/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/VELOCE/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Accents/2.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/4.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/5.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/6.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/7.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/8.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/9.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/10.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/11.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/12.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/13.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/14.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/18.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/20.png" alt="">
                                            <img data-src="./img/VELOCE/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Face Letter/2.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/4.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/5.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/6.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/7.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/8.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/9.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/10.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/11.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/12.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/13.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/14.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/18.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/20.png" alt="">
                                            <img data-src="./img/VELOCE/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Face/2.png" alt="">
                                            <img data-src="./img/VELOCE/Face/4.png" alt="">
                                            <img data-src="./img/VELOCE/Face/5.png" alt="">
                                            <img data-src="./img/VELOCE/Face/6.png" alt="">
                                            <img data-src="./img/VELOCE/Face/7.png" alt="">
                                            <img data-src="./img/VELOCE/Face/8.png" alt="">
                                            <img data-src="./img/VELOCE/Face/9.png" alt="">
                                            <img data-src="./img/VELOCE/Face/10.png" alt="">
                                            <img data-src="./img/VELOCE/Face/11.png" alt="">
                                            <img data-src="./img/VELOCE/Face/12.png" alt="">
                                            <img data-src="./img/VELOCE/Face/13.png" alt="">
                                            <img data-src="./img/VELOCE/Face/14.png" alt="">
                                            <img data-src="./img/VELOCE/Face/18.png" alt="">
                                            <img data-src="./img/VELOCE/Face/20.png" alt="">
                                            <img data-src="./img/VELOCE/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Cap Letter/2.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/4.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/5.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/6.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/7.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/8.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/9.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/10.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/11.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/12.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/13.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/14.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/18.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/20.png" alt="">
                                            <img data-src="./img/VELOCE/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Cap/2.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/4.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/5.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/6.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/7.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/8.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/9.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/10.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/11.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/12.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/13.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/14.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/18.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/20.png" alt="">
                                            <img data-src="./img/VELOCE/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/VELOCE/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/VELOCE/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/VELOCE/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VELOCE/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/VELOCE/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./veloce-sf-2487.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
