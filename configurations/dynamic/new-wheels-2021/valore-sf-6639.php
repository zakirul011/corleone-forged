...
<?php function includeWithVariables($filePath, $variables = array(), $print = true) {
 ...
 <header>
    ...
    <main>
        ...
        $image_path = $actual_linkf.'/new-wheels-2021/'.$file;
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Valore | SF-6639', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <!-- CONFIG AREA -->
    <div class="config-wrapper valore pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
	                    ...
	                    <div class="row g-0">
	                        ...
	                        <div class="col-lg-3 col-md-5">
	                            <div class="config-title">
	                                ...
	                                <h3>VALORE <span>its easy to build</span></h3>
	                                <h1>SF-6639</h1>
	                                ...
	                                <div class="config-navigation-wrap">
	                                    ...
	                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
	                                        <div class="navigation-slider">
	                                            <ul>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/accents.png" alt="">
	                                                    <span>accents</span>
	                                                </li>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/face-letter.png" alt="">
	                                                    <span>face-letter</span>
	                                                </li>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/face.png" alt="">
	                                                    <span>face</span>
	                                                </li>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/cap-letter.png" alt="">
	                                                    <span>cap-letter</span>
	                                                </li>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/cap.png" alt="">
	                                                    <span>cap</span>
	                                                </li>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/bolts.png" alt="">
	                                                    <span>Bolts</span>
	                                                </li>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/outer-barrel.png" alt="">
	                                                    <span>outer-barrel</span>
	                                                </li>
	                                                <li>
	                                                    <img src="./../assets/img/config-wheel/Navigation/inner-barrel.png" alt="">
	                        ...
	                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                                ...
                                <div class="preview-loader">
	                                ...
	                                <div class="config-main-wheel">
	                                    <img class="wheel-shadow" src="./../assets/img/config-wheel/wheel-shadow.png" alt="">
	                                ...
	                                <div class="config-part-wrap">
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Accents/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Accents/1.png" alt="">
	                                        </div>
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Accents/2.png" alt="">
	                                        </div>
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/1.png" alt="">
	                                        </div>
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Face Letter/2.png" alt="">
	                                        </div>
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Face/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Face/1.png" alt="">
	                                        </div>
	                                      <div class="config-part-category">
	                                          <img data-src="./../assets/img/config-wheel/Face/2.png" alt="">
	                                      </div>
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap Letter/1.png" alt="">
	                                        </div>
	                                       <div class="config-part-category">
	                                           <img data-src="./../assets/img/config-wheel/Cap Letter/2.png" alt="">
	                                       </div>
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Cap/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Cap/1.png" alt="">
	                                        </div>
	                                      <div class="config-part-category">
	                                          <img data-src="./../assets/img/config-wheel/Cap/2.png" alt="">
	                                      </div>
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/1.png" alt="">
	                                        </div>
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/2.png" alt="">
	                                        </div>
	                                        ...
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Bolts/21.png" alt="">
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/1.png" alt="">
	                                        </div>
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/2.png" alt="">
	                                        </div>
	                                        ...
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Outer Barrel/21.png" alt="">
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="config-part-page">
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/2.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/4.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/5.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/6.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/7.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/8.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/9.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/10.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/11.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/12.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/13.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/14.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/18.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/20.png" alt="">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/1.png" alt="">
	                                        </div>
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/2.png" alt="">
	                                        </div>
	                                        ...
	                                        <div class="config-part-category">
	                                            <img data-src="./../assets/img/config-wheel/Inner Barrel/21.png" alt="">
	                                        </div>
	                                    </div>
	                                            ...
	                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
	                                                ...
	                                                <div class="preview-wheel-wrap">
	                                                    <div class="preview-wheel mt-30">
	                                                        ...
	                                                        <img src="./../assets/img/config-wheel/default-model.png" class="preview">
	                ...
	                <div class="col-lg-12">
	                    <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
	                        ...
	                        <div class="black-shop">
	                            <a href="./valore-sf-6639.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
	                        </div>
