...
<?php function includeWithVariables($filePath, $variables = array(), $print = true) {
 ...
 <header>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Vorace | SF-9252', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <!-- CONFIG AREA -->
    <div class="config-wrapper vorace pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>VORACE <span>its easy to build</span></h3>
                                <h1>sf-9352</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/VORACE/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VORACE/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VORACE/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VORACE/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VORACE/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VORACE/default/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VORACE/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VORACE/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/VORACE/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Accents/2.png" alt="">
                                            <img data-src="./img/VORACE/Accents/4.png" alt="">
                                            <img data-src="./img/VORACE/Accents/5.png" alt="">
                                            <img data-src="./img/VORACE/Accents/6.png" alt="">
                                            <img data-src="./img/VORACE/Accents/7.png" alt="">
                                            <img data-src="./img/VORACE/Accents/8.png" alt="">
                                            <img data-src="./img/VORACE/Accents/9.png" alt="">
                                            <img data-src="./img/VORACE/Accents/10.png" alt="">
                                            <img data-src="./img/VORACE/Accents/11.png" alt="">
                                            <img data-src="./img/VORACE/Accents/12.png" alt="">
                                            <img data-src="./img/VORACE/Accents/13.png" alt="">
                                            <img data-src="./img/VORACE/Accents/14.png" alt="">
                                            <img data-src="./img/VORACE/Accents/18.png" alt="">
                                            <img data-src="./img/VORACE/Accents/20.png" alt="">
                                            <img data-src="./img/VORACE/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Face Letter/2.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/4.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/5.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/6.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/7.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/8.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/9.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/10.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/11.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/12.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/13.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/14.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/18.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/20.png" alt="">
                                            <img data-src="./img/VORACE/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Face/2.png" alt="">
                                            <img data-src="./img/VORACE/Face/4.png" alt="">
                                            <img data-src="./img/VORACE/Face/5.png" alt="">
                                            <img data-src="./img/VORACE/Face/6.png" alt="">
                                            <img data-src="./img/VORACE/Face/7.png" alt="">
                                            <img data-src="./img/VORACE/Face/8.png" alt="">
                                            <img data-src="./img/VORACE/Face/9.png" alt="">
                                            <img data-src="./img/VORACE/Face/10.png" alt="">
                                            <img data-src="./img/VORACE/Face/11.png" alt="">
                                            <img data-src="./img/VORACE/Face/12.png" alt="">
                                            <img data-src="./img/VORACE/Face/13.png" alt="">
                                            <img data-src="./img/VORACE/Face/14.png" alt="">
                                            <img data-src="./img/VORACE/Face/18.png" alt="">
                                            <img data-src="./img/VORACE/Face/20.png" alt="">
                                            <img data-src="./img/VORACE/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Cap Letter/2.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/4.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/5.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/6.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/7.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/8.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/9.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/10.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/11.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/12.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/13.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/14.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/18.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/20.png" alt="">
                                            <img data-src="./img/VORACE/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Cap/2.png" alt="">
                                            <img data-src="./img/VORACE/Cap/4.png" alt="">
                                            <img data-src="./img/VORACE/Cap/5.png" alt="">
                                            <img data-src="./img/VORACE/Cap/6.png" alt="">
                                            <img data-src="./img/VORACE/Cap/7.png" alt="">
                                            <img data-src="./img/VORACE/Cap/8.png" alt="">
                                            <img data-src="./img/VORACE/Cap/9.png" alt="">
                                            <img data-src="./img/VORACE/Cap/10.png" alt="">
                                            <img data-src="./img/VORACE/Cap/11.png" alt="">
                                            <img data-src="./img/VORACE/Cap/12.png" alt="">
                                            <img data-src="./img/VORACE/Cap/13.png" alt="">
                                            <img data-src="./img/VORACE/Cap/14.png" alt="">
                                            <img data-src="./img/VORACE/Cap/18.png" alt="">
                                            <img data-src="./img/VORACE/Cap/20.png" alt="">
                                            <img data-src="./img/VORACE/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/VORACE/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Bolts/2.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/4.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/5.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/6.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/7.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/8.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/9.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/10.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/11.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/12.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/13.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/14.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/18.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/20.png" alt="">
                                            <img data-src="./img/VORACE/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Bolts/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Bolts/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/VORACE/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/VORACE/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VORACE/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/VORACE/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./vorace-sf-9352.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
