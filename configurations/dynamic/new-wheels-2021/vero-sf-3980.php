...
<body>
 ...
 <header>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Vero | SF-3980', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <!-- CONFIG AREA -->
    <div class="config-wrapper vero pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>VERO <span>its easy to build</span></h3>
                                <h1>sf-3980</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/VERO/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VERO/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VERO/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VERO/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VERO/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VERO/default/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VERO/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/VERO/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/VERO/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Accents/2.png" alt="">
                                            <img data-src="./img/VERO/Accents/4.png" alt="">
                                            <img data-src="./img/VERO/Accents/5.png" alt="">
                                            <img data-src="./img/VERO/Accents/6.png" alt="">
                                            <img data-src="./img/VERO/Accents/7.png" alt="">
                                            <img data-src="./img/VERO/Accents/8.png" alt="">
                                            <img data-src="./img/VERO/Accents/9.png" alt="">
                                            <img data-src="./img/VERO/Accents/10.png" alt="">
                                            <img data-src="./img/VERO/Accents/11.png" alt="">
                                            <img data-src="./img/VERO/Accents/12.png" alt="">
                                            <img data-src="./img/VERO/Accents/13.png" alt="">
                                            <img data-src="./img/VERO/Accents/14.png" alt="">
                                            <img data-src="./img/VERO/Accents/18.png" alt="">
                                            <img data-src="./img/VERO/Accents/20.png" alt="">
                                            <img data-src="./img/VERO/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Face Letter/2.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/4.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/5.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/6.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/7.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/8.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/9.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/10.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/11.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/12.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/13.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/14.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/18.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/20.png" alt="">
                                            <img data-src="./img/VERO/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Face/2.png" alt="">
                                            <img data-src="./img/VERO/Face/4.png" alt="">
                                            <img data-src="./img/VERO/Face/5.png" alt="">
                                            <img data-src="./img/VERO/Face/6.png" alt="">
                                            <img data-src="./img/VERO/Face/7.png" alt="">
                                            <img data-src="./img/VERO/Face/8.png" alt="">
                                            <img data-src="./img/VERO/Face/9.png" alt="">
                                            <img data-src="./img/VERO/Face/10.png" alt="">
                                            <img data-src="./img/VERO/Face/11.png" alt="">
                                            <img data-src="./img/VERO/Face/12.png" alt="">
                                            <img data-src="./img/VERO/Face/13.png" alt="">
                                            <img data-src="./img/VERO/Face/14.png" alt="">
                                            <img data-src="./img/VERO/Face/18.png" alt="">
                                            <img data-src="./img/VERO/Face/20.png" alt="">
                                            <img data-src="./img/VERO/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Cap Letter/2.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/4.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/5.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/6.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/7.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/8.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/9.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/10.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/11.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/12.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/13.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/14.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/18.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/20.png" alt="">
                                            <img data-src="./img/VERO/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Cap/2.png" alt="">
                                            <img data-src="./img/VERO/Cap/4.png" alt="">
                                            <img data-src="./img/VERO/Cap/5.png" alt="">
                                            <img data-src="./img/VERO/Cap/6.png" alt="">
                                            <img data-src="./img/VERO/Cap/7.png" alt="">
                                            <img data-src="./img/VERO/Cap/8.png" alt="">
                                            <img data-src="./img/VERO/Cap/9.png" alt="">
                                            <img data-src="./img/VERO/Cap/10.png" alt="">
                                            <img data-src="./img/VERO/Cap/11.png" alt="">
                                            <img data-src="./img/VERO/Cap/12.png" alt="">
                                            <img data-src="./img/VERO/Cap/13.png" alt="">
                                            <img data-src="./img/VERO/Cap/14.png" alt="">
                                            <img data-src="./img/VERO/Cap/18.png" alt="">
                                            <img data-src="./img/VERO/Cap/20.png" alt="">
                                            <img data-src="./img/VERO/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/VERO/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Bolts/2.png" alt="">
                                            <img data-src="./img/VERO/Bolts/4.png" alt="">
                                            <img data-src="./img/VERO/Bolts/5.png" alt="">
                                            <img data-src="./img/VERO/Bolts/6.png" alt="">
                                            <img data-src="./img/VERO/Bolts/7.png" alt="">
                                            <img data-src="./img/VERO/Bolts/8.png" alt="">
                                            <img data-src="./img/VERO/Bolts/9.png" alt="">
                                            <img data-src="./img/VERO/Bolts/10.png" alt="">
                                            <img data-src="./img/VERO/Bolts/11.png" alt="">
                                            <img data-src="./img/VERO/Bolts/12.png" alt="">
                                            <img data-src="./img/VERO/Bolts/13.png" alt="">
                                            <img data-src="./img/VERO/Bolts/14.png" alt="">
                                            <img data-src="./img/VERO/Bolts/18.png" alt="">
                                            <img data-src="./img/VERO/Bolts/20.png" alt="">
                                            <img data-src="./img/VERO/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Bolts/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Bolts/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/VERO/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/VERO/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/VERO/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/VERO/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./vero-sf-3980.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
