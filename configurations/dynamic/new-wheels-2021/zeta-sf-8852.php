 ...
 <header>
    ...
    <main>
     ...
     <?php 
      ...
      print_r(var_dump(mail("zararhadi@gmail.com","My subject",'test mesaaaage'))); exit;
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Zeta | SF-8852', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
...
print_r($email_content); 
        ...
        # Send the email.
        $success = mail('sales@corleoneforged.com', $subject, $email_content, $headers);
        $success = mail('mehak.nayyab786@gmail.com', $subject, $email_content, $headers);

        $success = mail('mehak.nayyab786@gmail.com', 'test emails', 'test message');
...
print_r($success); exit;
    ...
    <!-- CONFIG AREA -->
    <div class="config-wrapper zeta pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>ZETA <span>its easy to build</span></h3>
                                <h1>sf-8852</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/ZETA/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ZETA/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ZETA/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ZETA/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ZETA/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ZETA/default/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ZETA/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ZETA/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/ZETA/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Accents/2.png" alt="">
                                            <img data-src="./img/ZETA/Accents/4.png" alt="">
                                            <img data-src="./img/ZETA/Accents/5.png" alt="">
                                            <img data-src="./img/ZETA/Accents/6.png" alt="">
                                            <img data-src="./img/ZETA/Accents/7.png" alt="">
                                            <img data-src="./img/ZETA/Accents/8.png" alt="">
                                            <img data-src="./img/ZETA/Accents/9.png" alt="">
                                            <img data-src="./img/ZETA/Accents/10.png" alt="">
                                            <img data-src="./img/ZETA/Accents/11.png" alt="">
                                            <img data-src="./img/ZETA/Accents/12.png" alt="">
                                            <img data-src="./img/ZETA/Accents/13.png" alt="">
                                            <img data-src="./img/ZETA/Accents/14.png" alt="">
                                            <img data-src="./img/ZETA/Accents/18.png" alt="">
                                            <img data-src="./img/ZETA/Accents/20.png" alt="">
                                            <img data-src="./img/ZETA/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Face Letter/2.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/4.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/5.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/6.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/7.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/8.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/9.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/10.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/11.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/12.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/13.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/14.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/18.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/20.png" alt="">
                                            <img data-src="./img/ZETA/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Face/2.png" alt="">
                                            <img data-src="./img/ZETA/Face/4.png" alt="">
                                            <img data-src="./img/ZETA/Face/5.png" alt="">
                                            <img data-src="./img/ZETA/Face/6.png" alt="">
                                            <img data-src="./img/ZETA/Face/7.png" alt="">
                                            <img data-src="./img/ZETA/Face/8.png" alt="">
                                            <img data-src="./img/ZETA/Face/9.png" alt="">
                                            <img data-src="./img/ZETA/Face/10.png" alt="">
                                            <img data-src="./img/ZETA/Face/11.png" alt="">
                                            <img data-src="./img/ZETA/Face/12.png" alt="">
                                            <img data-src="./img/ZETA/Face/13.png" alt="">
                                            <img data-src="./img/ZETA/Face/14.png" alt="">
                                            <img data-src="./img/ZETA/Face/18.png" alt="">
                                            <img data-src="./img/ZETA/Face/20.png" alt="">
                                            <img data-src="./img/ZETA/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Cap Letter/2.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/4.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/5.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/6.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/7.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/8.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/9.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/10.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/11.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/12.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/13.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/14.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/18.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/20.png" alt="">
                                            <img data-src="./img/ZETA/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Cap/2.png" alt="">
                                            <img data-src="./img/ZETA/Cap/4.png" alt="">
                                            <img data-src="./img/ZETA/Cap/5.png" alt="">
                                            <img data-src="./img/ZETA/Cap/6.png" alt="">
                                            <img data-src="./img/ZETA/Cap/7.png" alt="">
                                            <img data-src="./img/ZETA/Cap/8.png" alt="">
                                            <img data-src="./img/ZETA/Cap/9.png" alt="">
                                            <img data-src="./img/ZETA/Cap/10.png" alt="">
                                            <img data-src="./img/ZETA/Cap/11.png" alt="">
                                            <img data-src="./img/ZETA/Cap/12.png" alt="">
                                            <img data-src="./img/ZETA/Cap/13.png" alt="">
                                            <img data-src="./img/ZETA/Cap/14.png" alt="">
                                            <img data-src="./img/ZETA/Cap/18.png" alt="">
                                            <img data-src="./img/ZETA/Cap/20.png" alt="">
                                            <img data-src="./img/ZETA/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/ZETA/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Bolts/2.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/4.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/5.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/6.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/7.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/8.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/9.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/10.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/11.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/12.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/13.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/14.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/18.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/20.png" alt="">
                                            <img data-src="./img/ZETA/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Bolts/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Bolts/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/ZETA/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/ZETA/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/ZETA/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/ZETA/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./zeta-sf-8852.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
