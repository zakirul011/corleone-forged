...
<body>
 ...
 <header>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Nitti | SF-7171', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper nitti pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>NITTI <span>its easy to build</span></h3>
                                <h1>sf-7171</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/NITTI/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/NITTI/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/NITTI/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/NITTI/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/NITTI/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/NITTI/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/NITTI/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/NITTI/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Accents/2.png" alt="">
                                            <img data-src="./img/NITTI/Accents/4.png" alt="">
                                            <img data-src="./img/NITTI/Accents/5.png" alt="">
                                            <img data-src="./img/NITTI/Accents/6.png" alt="">
                                            <img data-src="./img/NITTI/Accents/7.png" alt="">
                                            <img data-src="./img/NITTI/Accents/8.png" alt="">
                                            <img data-src="./img/NITTI/Accents/9.png" alt="">
                                            <img data-src="./img/NITTI/Accents/10.png" alt="">
                                            <img data-src="./img/NITTI/Accents/11.png" alt="">
                                            <img data-src="./img/NITTI/Accents/12.png" alt="">
                                            <img data-src="./img/NITTI/Accents/13.png" alt="">
                                            <img data-src="./img/NITTI/Accents/14.png" alt="">
                                            <img data-src="./img/NITTI/Accents/18.png" alt="">
                                            <img data-src="./img/NITTI/Accents/20.png" alt="">
                                            <img data-src="./img/NITTI/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Face Letter/2.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/4.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/5.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/6.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/7.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/8.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/9.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/10.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/11.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/12.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/13.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/14.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/18.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/20.png" alt="">
                                            <img data-src="./img/NITTI/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Face/2.png" alt="">
                                            <img data-src="./img/NITTI/Face/4.png" alt="">
                                            <img data-src="./img/NITTI/Face/5.png" alt="">
                                            <img data-src="./img/NITTI/Face/6.png" alt="">
                                            <img data-src="./img/NITTI/Face/7.png" alt="">
                                            <img data-src="./img/NITTI/Face/8.png" alt="">
                                            <img data-src="./img/NITTI/Face/9.png" alt="">
                                            <img data-src="./img/NITTI/Face/10.png" alt="">
                                            <img data-src="./img/NITTI/Face/11.png" alt="">
                                            <img data-src="./img/NITTI/Face/12.png" alt="">
                                            <img data-src="./img/NITTI/Face/13.png" alt="">
                                            <img data-src="./img/NITTI/Face/14.png" alt="">
                                            <img data-src="./img/NITTI/Face/18.png" alt="">
                                            <img data-src="./img/NITTI/Face/20.png" alt="">
                                            <img data-src="./img/NITTI/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Cap Letter/2.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/4.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/5.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/6.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/7.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/8.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/9.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/10.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/11.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/12.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/13.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/14.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/18.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/20.png" alt="">
                                            <img data-src="./img/NITTI/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Cap/2.png" alt="">
                                            <img data-src="./img/NITTI/Cap/4.png" alt="">
                                            <img data-src="./img/NITTI/Cap/5.png" alt="">
                                            <img data-src="./img/NITTI/Cap/6.png" alt="">
                                            <img data-src="./img/NITTI/Cap/7.png" alt="">
                                            <img data-src="./img/NITTI/Cap/8.png" alt="">
                                            <img data-src="./img/NITTI/Cap/9.png" alt="">
                                            <img data-src="./img/NITTI/Cap/10.png" alt="">
                                            <img data-src="./img/NITTI/Cap/11.png" alt="">
                                            <img data-src="./img/NITTI/Cap/12.png" alt="">
                                            <img data-src="./img/NITTI/Cap/13.png" alt="">
                                            <img data-src="./img/NITTI/Cap/14.png" alt="">
                                            <img data-src="./img/NITTI/Cap/18.png" alt="">
                                            <img data-src="./img/NITTI/Cap/20.png" alt="">
                                            <img data-src="./img/NITTI/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/NITTI/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/NITTI/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/NITTI/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/NITTI/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/NITTI/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./nitti-sf-7171.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
