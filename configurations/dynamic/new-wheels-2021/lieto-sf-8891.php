...
<body>
 ...
 <header>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'new-wheels-2021/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'Lieto | SF-8891', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <!-- CONFIG AREA -->
    <div class="config-wrapper lieto pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>LIETO <span>its easy to build</span></h3>
                                <h1>SF-8891</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/LIETO/default/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/LIETO/default/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/LIETO/default/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/LIETO/default/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/LIETO/default/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/LIETO/default/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/LIETO/default/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/LIETO/default/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/LIETO/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Accents/2.png" alt="">
                                            <img data-src="./img/LIETO/Accents/4.png" alt="">
                                            <img data-src="./img/LIETO/Accents/5.png" alt="">
                                            <img data-src="./img/LIETO/Accents/6.png" alt="">
                                            <img data-src="./img/LIETO/Accents/7.png" alt="">
                                            <img data-src="./img/LIETO/Accents/8.png" alt="">
                                            <img data-src="./img/LIETO/Accents/9.png" alt="">
                                            <img data-src="./img/LIETO/Accents/10.png" alt="">
                                            <img data-src="./img/LIETO/Accents/11.png" alt="">
                                            <img data-src="./img/LIETO/Accents/12.png" alt="">
                                            <img data-src="./img/LIETO/Accents/13.png" alt="">
                                            <img data-src="./img/LIETO/Accents/14.png" alt="">
                                            <img data-src="./img/LIETO/Accents/18.png" alt="">
                                            <img data-src="./img/LIETO/Accents/20.png" alt="">
                                            <img data-src="./img/LIETO/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Face Letter/2.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/4.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/5.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/6.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/7.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/8.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/9.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/10.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/11.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/12.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/13.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/14.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/18.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/20.png" alt="">
                                            <img data-src="./img/LIETO/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Face/2.png" alt="">
                                            <img data-src="./img/LIETO/Face/4.png" alt="">
                                            <img data-src="./img/LIETO/Face/5.png" alt="">
                                            <img data-src="./img/LIETO/Face/6.png" alt="">
                                            <img data-src="./img/LIETO/Face/7.png" alt="">
                                            <img data-src="./img/LIETO/Face/8.png" alt="">
                                            <img data-src="./img/LIETO/Face/9.png" alt="">
                                            <img data-src="./img/LIETO/Face/10.png" alt="">
                                            <img data-src="./img/LIETO/Face/11.png" alt="">
                                            <img data-src="./img/LIETO/Face/12.png" alt="">
                                            <img data-src="./img/LIETO/Face/13.png" alt="">
                                            <img data-src="./img/LIETO/Face/14.png" alt="">
                                            <img data-src="./img/LIETO/Face/18.png" alt="">
                                            <img data-src="./img/LIETO/Face/20.png" alt="">
                                            <img data-src="./img/LIETO/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Cap Letter/2.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/4.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/5.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/6.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/7.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/8.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/9.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/10.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/11.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/12.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/13.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/14.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/18.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/20.png" alt="">
                                            <img data-src="./img/LIETO/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Cap/2.png" alt="">
                                            <img data-src="./img/LIETO/Cap/4.png" alt="">
                                            <img data-src="./img/LIETO/Cap/5.png" alt="">
                                            <img data-src="./img/LIETO/Cap/6.png" alt="">
                                            <img data-src="./img/LIETO/Cap/7.png" alt="">
                                            <img data-src="./img/LIETO/Cap/8.png" alt="">
                                            <img data-src="./img/LIETO/Cap/9.png" alt="">
                                            <img data-src="./img/LIETO/Cap/10.png" alt="">
                                            <img data-src="./img/LIETO/Cap/11.png" alt="">
                                            <img data-src="./img/LIETO/Cap/12.png" alt="">
                                            <img data-src="./img/LIETO/Cap/13.png" alt="">
                                            <img data-src="./img/LIETO/Cap/14.png" alt="">
                                            <img data-src="./img/LIETO/Cap/18.png" alt="">
                                            <img data-src="./img/LIETO/Cap/20.png" alt="">
                                            <img data-src="./img/LIETO/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/LIETO/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Bolts/2.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/4.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/5.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/6.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/7.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/8.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/9.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/10.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/11.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/12.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/13.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/14.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/18.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/20.png" alt="">
                                            <img data-src="./img/LIETO/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Bolts/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Bolts/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/LIETO/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Outer Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Outer Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Inner Barrel/2.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/4.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/5.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/6.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/7.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/8.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/9.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/10.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/11.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/12.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/13.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/14.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/18.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/20.png" alt="">
                                            <img data-src="./img/LIETO/Inner Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Inner Barrel/2.png" alt="">
                                        </div>
                                        ...
                                        <div class="config-part-category">
                                            <img data-src="./img/LIETO/Inner Barrel/21.png" alt="">
                                        </div>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/LIETO/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./lieto-sf-8891.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
