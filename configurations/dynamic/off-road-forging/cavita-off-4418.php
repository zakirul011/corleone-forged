...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'CAVITA | OFF-4418', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper cavita-off-4418 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>CAVITA <span>its easy to build</span></h3>
                                <h1>OFF-4418</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/cavita/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/cavita/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/cavita/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/cavita/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/cavita/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/cavita/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Accents/2.png" alt="">
                                            <img data-src="./img/cavita/Accents/4.png" alt="">
                                            <img data-src="./img/cavita/Accents/5.png" alt="">
                                            <img data-src="./img/cavita/Accents/6.png" alt="">
                                            <img data-src="./img/cavita/Accents/7.png" alt="">
                                            <img data-src="./img/cavita/Accents/8.png" alt="">
                                            <img data-src="./img/cavita/Accents/9.png" alt="">
                                            <img data-src="./img/cavita/Accents/10.png" alt="">
                                            <img data-src="./img/cavita/Accents/11.png" alt="">
                                            <img data-src="./img/cavita/Accents/12.png" alt="">
                                            <img data-src="./img/cavita/Accents/13.png" alt="">
                                            <img data-src="./img/cavita/Accents/14.png" alt="">
                                            <img data-src="./img/cavita/Accents/18.png" alt="">
                                            <img data-src="./img/cavita/Accents/20.png" alt="">
                                            <img data-src="./img/cavita/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Cap Letter/2.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/4.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/5.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/6.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/7.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/8.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/9.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/10.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/11.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/12.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/13.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/14.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/18.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/20.png" alt="">
                                            <img data-src="./img/cavita/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Cap/2.png" alt="">
                                            <img data-src="./img/cavita/Cap/4.png" alt="">
                                            <img data-src="./img/cavita/Cap/5.png" alt="">
                                            <img data-src="./img/cavita/Cap/6.png" alt="">
                                            <img data-src="./img/cavita/Cap/7.png" alt="">
                                            <img data-src="./img/cavita/Cap/8.png" alt="">
                                            <img data-src="./img/cavita/Cap/9.png" alt="">
                                            <img data-src="./img/cavita/Cap/10.png" alt="">
                                            <img data-src="./img/cavita/Cap/11.png" alt="">
                                            <img data-src="./img/cavita/Cap/12.png" alt="">
                                            <img data-src="./img/cavita/Cap/13.png" alt="">
                                            <img data-src="./img/cavita/Cap/14.png" alt="">
                                            <img data-src="./img/cavita/Cap/18.png" alt="">
                                            <img data-src="./img/cavita/Cap/20.png" alt="">
                                            <img data-src="./img/cavita/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/cavita/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/cavita/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Face/2.png" alt="">
                                            <img data-src="./img/cavita/Face/4.png" alt="">
                                            <img data-src="./img/cavita/Face/5.png" alt="">
                                            <img data-src="./img/cavita/Face/6.png" alt="">
                                            <img data-src="./img/cavita/Face/7.png" alt="">
                                            <img data-src="./img/cavita/Face/8.png" alt="">
                                            <img data-src="./img/cavita/Face/9.png" alt="">
                                            <img data-src="./img/cavita/Face/10.png" alt="">
                                            <img data-src="./img/cavita/Face/11.png" alt="">
                                            <img data-src="./img/cavita/Face/12.png" alt="">
                                            <img data-src="./img/cavita/Face/13.png" alt="">
                                            <img data-src="./img/cavita/Face/14.png" alt="">
                                            <img data-src="./img/cavita/Face/18.png" alt="">
                                            <img data-src="./img/cavita/Face/20.png" alt="">
                                            <img data-src="./img/cavita/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/cavita/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/cavita/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./cavita-off-4418.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
