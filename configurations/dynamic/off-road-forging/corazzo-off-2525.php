...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'CORAZZO | OFF-2525', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper corazzo-off-2525 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>CORAZZO <span>its easy to build</span></h3>
                                <h1>OFF-2525</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/corazzo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corazzo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corazzo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corazzo/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corazzo/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corazzo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/corazzo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Accents/2.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/4.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/5.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/6.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/7.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/8.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/9.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/10.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/11.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/12.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/13.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/14.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/18.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/20.png" alt="Accents">
                                            <img data-src="./img/corazzo/Accents/1.png" alt="Accents">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Accents/2.png" alt="Accents">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Cap Letter/2.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/4.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/5.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/6.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/7.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/8.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/9.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/10.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/11.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/12.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/13.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/14.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/18.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/20.png" alt="Cap Letter">
                                            <img data-src="./img/corazzo/Cap Letter/1.png" alt="Cap Letter">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Cap Letter/2.png" alt="Cap Letter">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Cap/2.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/4.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/5.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/6.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/7.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/8.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/9.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/10.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/11.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/12.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/13.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/14.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/18.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/20.png" alt="Cap">
                                            <img data-src="./img/corazzo/Cap/1.png" alt="Cap">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/corazzo/Cap/2.png" alt="Cap">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Spike/2.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/4.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/5.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/6.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/7.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/8.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/9.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/10.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/11.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/12.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/13.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/14.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/18.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/20.png" alt="Spike">
                                            <img data-src="./img/corazzo/Spike/1.png" alt="Spike">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Spike/2.png" alt="Spike">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Barrel Letter/2.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/4.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/5.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/6.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/7.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/8.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/9.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/10.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/11.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/12.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/13.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/14.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/18.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/20.png" alt="Barrel Letter">
                                            <img data-src="./img/corazzo/Barrel Letter/1.png" alt="Barrel Letter">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Barrel Letter/2.png" alt="Barrel Letter">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Face/2.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/4.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/5.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/6.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/7.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/8.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/9.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/10.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/11.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/12.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/13.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/14.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/18.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/20.png" alt="Face">
                                            <img data-src="./img/corazzo/Face/1.png" alt="Face">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Face/2.png" alt="Face">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/corazzo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./corazzo-off-2525.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
