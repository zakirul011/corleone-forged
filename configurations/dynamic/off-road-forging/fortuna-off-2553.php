...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'FORTUNA | OFF-2553', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper fortuna-off-2553 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                ...
                                                <li>
                                                    <img src="./img/fortuna/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/fortuna/Navigation/barrel-letter.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fortuna/Spike/2.png" alt="">
                                            <img data-src="./img/fortuna/Spike/4.png" alt="">
                                            <img data-src="./img/fortuna/Spike/5.png" alt="">
                                            <img data-src="./img/fortuna/Spike/6.png" alt="">
                                            <img data-src="./img/fortuna/Spike/7.png" alt="">
                                            <img data-src="./img/fortuna/Spike/8.png" alt="">
                                            <img data-src="./img/fortuna/Spike/9.png" alt="">
                                            <img data-src="./img/fortuna/Spike/10.png" alt="">
                                            <img data-src="./img/fortuna/Spike/11.png" alt="">
                                            <img data-src="./img/fortuna/Spike/12.png" alt="">
                                            <img data-src="./img/fortuna/Spike/13.png" alt="">
                                            <img data-src="./img/fortuna/Spike/14.png" alt="">
                                            <img data-src="./img/fortuna/Spike/18.png" alt="">
                                            <img data-src="./img/fortuna/Spike/20.png" alt="">
                                            <img data-src="./img/fortuna/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fortuna/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/fortuna/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/fortuna/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/fortuna/Barrel Letter/2.png" alt="">
                                        </div>
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./fortuna-off-2553.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
