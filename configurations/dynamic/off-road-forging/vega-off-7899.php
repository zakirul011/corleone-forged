...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'VEGA | OFF-7899', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper vega-off-7899 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>VEGA <span>its easy to build</span></h3>
                                <h1>OFF-7899</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/vega/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vega/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vega/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vega/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vega/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vega/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/vega/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Accents/2.png" alt="">
                                            <img data-src="./img/vega/Accents/4.png" alt="">
                                            <img data-src="./img/vega/Accents/5.png" alt="">
                                            <img data-src="./img/vega/Accents/6.png" alt="">
                                            <img data-src="./img/vega/Accents/7.png" alt="">
                                            <img data-src="./img/vega/Accents/8.png" alt="">
                                            <img data-src="./img/vega/Accents/9.png" alt="">
                                            <img data-src="./img/vega/Accents/10.png" alt="">
                                            <img data-src="./img/vega/Accents/11.png" alt="">
                                            <img data-src="./img/vega/Accents/12.png" alt="">
                                            <img data-src="./img/vega/Accents/13.png" alt="">
                                            <img data-src="./img/vega/Accents/14.png" alt="">
                                            <img data-src="./img/vega/Accents/18.png" alt="">
                                            <img data-src="./img/vega/Accents/20.png" alt="">
                                            <img data-src="./img/vega/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Cap Letter/2.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/4.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/5.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/6.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/7.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/8.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/9.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/10.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/11.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/12.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/13.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/14.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/18.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/20.png" alt="">
                                            <img data-src="./img/vega/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Cap/2.png" alt="">
                                            <img data-src="./img/vega/Cap/4.png" alt="">
                                            <img data-src="./img/vega/Cap/5.png" alt="">
                                            <img data-src="./img/vega/Cap/6.png" alt="">
                                            <img data-src="./img/vega/Cap/7.png" alt="">
                                            <img data-src="./img/vega/Cap/8.png" alt="">
                                            <img data-src="./img/vega/Cap/9.png" alt="">
                                            <img data-src="./img/vega/Cap/10.png" alt="">
                                            <img data-src="./img/vega/Cap/11.png" alt="">
                                            <img data-src="./img/vega/Cap/12.png" alt="">
                                            <img data-src="./img/vega/Cap/13.png" alt="">
                                            <img data-src="./img/vega/Cap/14.png" alt="">
                                            <img data-src="./img/vega/Cap/18.png" alt="">
                                            <img data-src="./img/vega/Cap/20.png" alt="">
                                            <img data-src="./img/vega/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/vega/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Spike/2.png" alt="">
                                            <img data-src="./img/vega/Spike/4.png" alt="">
                                            <img data-src="./img/vega/Spike/5.png" alt="">
                                            <img data-src="./img/vega/Spike/6.png" alt="">
                                            <img data-src="./img/vega/Spike/7.png" alt="">
                                            <img data-src="./img/vega/Spike/8.png" alt="">
                                            <img data-src="./img/vega/Spike/9.png" alt="">
                                            <img data-src="./img/vega/Spike/10.png" alt="">
                                            <img data-src="./img/vega/Spike/11.png" alt="">
                                            <img data-src="./img/vega/Spike/12.png" alt="">
                                            <img data-src="./img/vega/Spike/13.png" alt="">
                                            <img data-src="./img/vega/Spike/14.png" alt="">
                                            <img data-src="./img/vega/Spike/18.png" alt="">
                                            <img data-src="./img/vega/Spike/20.png" alt="">
                                            <img data-src="./img/vega/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/vega/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Face/2.png" alt="">
                                            <img data-src="./img/vega/Face/4.png" alt="">
                                            <img data-src="./img/vega/Face/5.png" alt="">
                                            <img data-src="./img/vega/Face/6.png" alt="">
                                            <img data-src="./img/vega/Face/7.png" alt="">
                                            <img data-src="./img/vega/Face/8.png" alt="">
                                            <img data-src="./img/vega/Face/9.png" alt="">
                                            <img data-src="./img/vega/Face/10.png" alt="">
                                            <img data-src="./img/vega/Face/11.png" alt="">
                                            <img data-src="./img/vega/Face/12.png" alt="">
                                            <img data-src="./img/vega/Face/13.png" alt="">
                                            <img data-src="./img/vega/Face/14.png" alt="">
                                            <img data-src="./img/vega/Face/18.png" alt="">
                                            <img data-src="./img/vega/Face/20.png" alt="">
                                            <img data-src="./img/vega/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vega/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/vega/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./vega-off-7899.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
