...
<body>
    ...
    <div class="config-wrapper brancata-off-2941 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>BRANCATA <span>its easy to build</span></h3>
                                <h1>OFF-2941</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/brancata/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brancata/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brancata/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brancata/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brancata/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brancata/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/brancata/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Accents/2.png" alt="">
                                            <img data-src="./img/brancata/Accents/4.png" alt="">
                                            <img data-src="./img/brancata/Accents/5.png" alt="">
                                            <img data-src="./img/brancata/Accents/6.png" alt="">
                                            <img data-src="./img/brancata/Accents/7.png" alt="">
                                            <img data-src="./img/brancata/Accents/8.png" alt="">
                                            <img data-src="./img/brancata/Accents/9.png" alt="">
                                            <img data-src="./img/brancata/Accents/10.png" alt="">
                                            <img data-src="./img/brancata/Accents/11.png" alt="">
                                            <img data-src="./img/brancata/Accents/12.png" alt="">
                                            <img data-src="./img/brancata/Accents/13.png" alt="">
                                            <img data-src="./img/brancata/Accents/14.png" alt="">
                                            <img data-src="./img/brancata/Accents/18.png" alt="">
                                            <img data-src="./img/brancata/Accents/20.png" alt="">
                                            <img data-src="./img/brancata/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Cap Letter/2.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/4.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/5.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/6.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/7.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/8.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/9.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/10.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/11.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/12.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/13.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/14.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/18.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/20.png" alt="">
                                            <img data-src="./img/brancata/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Cap/2.png" alt="">
                                            <img data-src="./img/brancata/Cap/4.png" alt="">
                                            <img data-src="./img/brancata/Cap/5.png" alt="">
                                            <img data-src="./img/brancata/Cap/6.png" alt="">
                                            <img data-src="./img/brancata/Cap/7.png" alt="">
                                            <img data-src="./img/brancata/Cap/8.png" alt="">
                                            <img data-src="./img/brancata/Cap/9.png" alt="">
                                            <img data-src="./img/brancata/Cap/10.png" alt="">
                                            <img data-src="./img/brancata/Cap/11.png" alt="">
                                            <img data-src="./img/brancata/Cap/12.png" alt="">
                                            <img data-src="./img/brancata/Cap/13.png" alt="">
                                            <img data-src="./img/brancata/Cap/14.png" alt="">
                                            <img data-src="./img/brancata/Cap/18.png" alt="">
                                            <img data-src="./img/brancata/Cap/20.png" alt="">
                                            <img data-src="./img/brancata/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/brancata/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Spike/2.png" alt="">
                                            <img data-src="./img/brancata/Spike/4.png" alt="">
                                            <img data-src="./img/brancata/Spike/5.png" alt="">
                                            <img data-src="./img/brancata/Spike/6.png" alt="">
                                            <img data-src="./img/brancata/Spike/7.png" alt="">
                                            <img data-src="./img/brancata/Spike/8.png" alt="">
                                            <img data-src="./img/brancata/Spike/9.png" alt="">
                                            <img data-src="./img/brancata/Spike/10.png" alt="">
                                            <img data-src="./img/brancata/Spike/11.png" alt="">
                                            <img data-src="./img/brancata/Spike/12.png" alt="">
                                            <img data-src="./img/brancata/Spike/13.png" alt="">
                                            <img data-src="./img/brancata/Spike/14.png" alt="">
                                            <img data-src="./img/brancata/Spike/18.png" alt="">
                                            <img data-src="./img/brancata/Spike/20.png" alt="">
                                            <img data-src="./img/brancata/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/brancata/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Face/2.png" alt="">
                                            <img data-src="./img/brancata/Face/4.png" alt="">
                                            <img data-src="./img/brancata/Face/5.png" alt="">
                                            <img data-src="./img/brancata/Face/6.png" alt="">
                                            <img data-src="./img/brancata/Face/7.png" alt="">
                                            <img data-src="./img/brancata/Face/8.png" alt="">
                                            <img data-src="./img/brancata/Face/9.png" alt="">
                                            <img data-src="./img/brancata/Face/10.png" alt="">
                                            <img data-src="./img/brancata/Face/11.png" alt="">
                                            <img data-src="./img/brancata/Face/12.png" alt="">
                                            <img data-src="./img/brancata/Face/13.png" alt="">
                                            <img data-src="./img/brancata/Face/14.png" alt="">
                                            <img data-src="./img/brancata/Face/18.png" alt="">
                                            <img data-src="./img/brancata/Face/20.png" alt="">
                                            <img data-src="./img/brancata/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brancata/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/brancata/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./brancata-off-2941.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
