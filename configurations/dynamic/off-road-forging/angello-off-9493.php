...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'ANGELLO | OFF-9493', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper angello-off-9493 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>ANGELLO <span>its easy to build</span></h3>
                                <h1>OFF-9493</h1>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/angello/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Accents/2.png" alt="">
                                            <img data-src="./img/angello/Accents/4.png" alt="">
                                            <img data-src="./img/angello/Accents/5.png" alt="">
                                            <img data-src="./img/angello/Accents/6.png" alt="">
                                            <img data-src="./img/angello/Accents/7.png" alt="">
                                            <img data-src="./img/angello/Accents/8.png" alt="">
                                            <img data-src="./img/angello/Accents/9.png" alt="">
                                            <img data-src="./img/angello/Accents/10.png" alt="">
                                            <img data-src="./img/angello/Accents/11.png" alt="">
                                            <img data-src="./img/angello/Accents/12.png" alt="">
                                            <img data-src="./img/angello/Accents/13.png" alt="">
                                            <img data-src="./img/angello/Accents/14.png" alt="">
                                            <img data-src="./img/angello/Accents/18.png" alt="">
                                            <img data-src="./img/angello/Accents/20.png" alt="">
                                            <img data-src="./img/angello/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Cap Letter/2.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/4.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/5.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/6.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/7.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/8.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/9.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/10.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/11.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/12.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/13.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/14.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/18.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/20.png" alt="">
                                            <img data-src="./img/angello/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Cap/2.png" alt="">
                                            <img data-src="./img/angello/Cap/4.png" alt="">
                                            <img data-src="./img/angello/Cap/5.png" alt="">
                                            <img data-src="./img/angello/Cap/6.png" alt="">
                                            <img data-src="./img/angello/Cap/7.png" alt="">
                                            <img data-src="./img/angello/Cap/8.png" alt="">
                                            <img data-src="./img/angello/Cap/9.png" alt="">
                                            <img data-src="./img/angello/Cap/10.png" alt="">
                                            <img data-src="./img/angello/Cap/11.png" alt="">
                                            <img data-src="./img/angello/Cap/12.png" alt="">
                                            <img data-src="./img/angello/Cap/13.png" alt="">
                                            <img data-src="./img/angello/Cap/14.png" alt="">
                                            <img data-src="./img/angello/Cap/18.png" alt="">
                                            <img data-src="./img/angello/Cap/20.png" alt="">
                                            <img data-src="./img/angello/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/angello/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Spike/2.png" alt="">
                                            <img data-src="./img/angello/Spike/4.png" alt="">
                                            <img data-src="./img/angello/Spike/5.png" alt="">
                                            <img data-src="./img/angello/Spike/6.png" alt="">
                                            <img data-src="./img/angello/Spike/7.png" alt="">
                                            <img data-src="./img/angello/Spike/8.png" alt="">
                                            <img data-src="./img/angello/Spike/9.png" alt="">
                                            <img data-src="./img/angello/Spike/10.png" alt="">
                                            <img data-src="./img/angello/Spike/11.png" alt="">
                                            <img data-src="./img/angello/Spike/12.png" alt="">
                                            <img data-src="./img/angello/Spike/13.png" alt="">
                                            <img data-src="./img/angello/Spike/14.png" alt="">
                                            <img data-src="./img/angello/Spike/18.png" alt="">
                                            <img data-src="./img/angello/Spike/20.png" alt="">
                                            <img data-src="./img/angello/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/angello/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Face/2.png" alt="">
                                            <img data-src="./img/angello/Face/4.png" alt="">
                                            <img data-src="./img/angello/Face/5.png" alt="">
                                            <img data-src="./img/angello/Face/6.png" alt="">
                                            <img data-src="./img/angello/Face/7.png" alt="">
                                            <img data-src="./img/angello/Face/8.png" alt="">
                                            <img data-src="./img/angello/Face/9.png" alt="">
                                            <img data-src="./img/angello/Face/10.png" alt="">
                                            <img data-src="./img/angello/Face/11.png" alt="">
                                            <img data-src="./img/angello/Face/12.png" alt="">
                                            <img data-src="./img/angello/Face/13.png" alt="">
                                            <img data-src="./img/angello/Face/14.png" alt="">
                                            <img data-src="./img/angello/Face/18.png" alt="">
                                            <img data-src="./img/angello/Face/20.png" alt="">
                                            <img data-src="./img/angello/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/angello/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/angello/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./angello-off-9493.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
