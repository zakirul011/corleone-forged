...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'SCALFINI | OFF-2487', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper scalfini-off-2487 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>SCALFINI <span>its easy to build</span></h3>
                                <h1>OFF-2487</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/scalfini/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/scalfini/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/scalfini/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/scalfini/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/scalfini/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/scalfini/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/scalfini/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Accents/2.png" alt="">
                                            <img data-src="./img/scalfini/Accents/4.png" alt="">
                                            <img data-src="./img/scalfini/Accents/5.png" alt="">
                                            <img data-src="./img/scalfini/Accents/6.png" alt="">
                                            <img data-src="./img/scalfini/Accents/7.png" alt="">
                                            <img data-src="./img/scalfini/Accents/8.png" alt="">
                                            <img data-src="./img/scalfini/Accents/9.png" alt="">
                                            <img data-src="./img/scalfini/Accents/10.png" alt="">
                                            <img data-src="./img/scalfini/Accents/11.png" alt="">
                                            <img data-src="./img/scalfini/Accents/12.png" alt="">
                                            <img data-src="./img/scalfini/Accents/13.png" alt="">
                                            <img data-src="./img/scalfini/Accents/14.png" alt="">
                                            <img data-src="./img/scalfini/Accents/18.png" alt="">
                                            <img data-src="./img/scalfini/Accents/20.png" alt="">
                                            <img data-src="./img/scalfini/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Cap Letter/2.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/4.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/5.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/6.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/7.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/8.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/9.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/10.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/11.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/12.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/13.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/14.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/18.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/20.png" alt="">
                                            <img data-src="./img/scalfini/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Cap/2.png" alt="">
                                            <img data-src="./img/scalfini/Cap/4.png" alt="">
                                            <img data-src="./img/scalfini/Cap/5.png" alt="">
                                            <img data-src="./img/scalfini/Cap/6.png" alt="">
                                            <img data-src="./img/scalfini/Cap/7.png" alt="">
                                            <img data-src="./img/scalfini/Cap/8.png" alt="">
                                            <img data-src="./img/scalfini/Cap/9.png" alt="">
                                            <img data-src="./img/scalfini/Cap/10.png" alt="">
                                            <img data-src="./img/scalfini/Cap/11.png" alt="">
                                            <img data-src="./img/scalfini/Cap/12.png" alt="">
                                            <img data-src="./img/scalfini/Cap/13.png" alt="">
                                            <img data-src="./img/scalfini/Cap/14.png" alt="">
                                            <img data-src="./img/scalfini/Cap/18.png" alt="">
                                            <img data-src="./img/scalfini/Cap/20.png" alt="">
                                            <img data-src="./img/scalfini/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/scalfini/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Spike/2.png" alt="">
                                            <img data-src="./img/scalfini/Spike/4.png" alt="">
                                            <img data-src="./img/scalfini/Spike/5.png" alt="">
                                            <img data-src="./img/scalfini/Spike/6.png" alt="">
                                            <img data-src="./img/scalfini/Spike/7.png" alt="">
                                            <img data-src="./img/scalfini/Spike/8.png" alt="">
                                            <img data-src="./img/scalfini/Spike/9.png" alt="">
                                            <img data-src="./img/scalfini/Spike/10.png" alt="">
                                            <img data-src="./img/scalfini/Spike/11.png" alt="">
                                            <img data-src="./img/scalfini/Spike/12.png" alt="">
                                            <img data-src="./img/scalfini/Spike/13.png" alt="">
                                            <img data-src="./img/scalfini/Spike/14.png" alt="">
                                            <img data-src="./img/scalfini/Spike/18.png" alt="">
                                            <img data-src="./img/scalfini/Spike/20.png" alt="">
                                            <img data-src="./img/scalfini/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/scalfini/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Face/2.png" alt="">
                                            <img data-src="./img/scalfini/Face/4.png" alt="">
                                            <img data-src="./img/scalfini/Face/5.png" alt="">
                                            <img data-src="./img/scalfini/Face/6.png" alt="">
                                            <img data-src="./img/scalfini/Face/7.png" alt="">
                                            <img data-src="./img/scalfini/Face/8.png" alt="">
                                            <img data-src="./img/scalfini/Face/9.png" alt="">
                                            <img data-src="./img/scalfini/Face/10.png" alt="">
                                            <img data-src="./img/scalfini/Face/11.png" alt="">
                                            <img data-src="./img/scalfini/Face/12.png" alt="">
                                            <img data-src="./img/scalfini/Face/13.png" alt="">
                                            <img data-src="./img/scalfini/Face/14.png" alt="">
                                            <img data-src="./img/scalfini/Face/18.png" alt="">
                                            <img data-src="./img/scalfini/Face/20.png" alt="">
                                            <img data-src="./img/scalfini/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/scalfini/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/scalfini/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./scalfini-off-2487.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
