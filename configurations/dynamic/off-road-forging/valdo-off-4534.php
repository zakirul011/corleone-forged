...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'VALDO | OFF-4534', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper valdo-off-4534 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>VALDO <span>its easy to build</span></h3>
                                <h1>OFF-4534</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/valdo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/valdo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/valdo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/valdo/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/valdo/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/valdo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/valdo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Accents/2.png" alt="">
                                            <img data-src="./img/valdo/Accents/4.png" alt="">
                                            <img data-src="./img/valdo/Accents/5.png" alt="">
                                            <img data-src="./img/valdo/Accents/6.png" alt="">
                                            <img data-src="./img/valdo/Accents/7.png" alt="">
                                            <img data-src="./img/valdo/Accents/8.png" alt="">
                                            <img data-src="./img/valdo/Accents/9.png" alt="">
                                            <img data-src="./img/valdo/Accents/10.png" alt="">
                                            <img data-src="./img/valdo/Accents/11.png" alt="">
                                            <img data-src="./img/valdo/Accents/12.png" alt="">
                                            <img data-src="./img/valdo/Accents/13.png" alt="">
                                            <img data-src="./img/valdo/Accents/14.png" alt="">
                                            <img data-src="./img/valdo/Accents/18.png" alt="">
                                            <img data-src="./img/valdo/Accents/20.png" alt="">
                                            <img data-src="./img/valdo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/valdo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Cap/2.png" alt="">
                                            <img data-src="./img/valdo/Cap/4.png" alt="">
                                            <img data-src="./img/valdo/Cap/5.png" alt="">
                                            <img data-src="./img/valdo/Cap/6.png" alt="">
                                            <img data-src="./img/valdo/Cap/7.png" alt="">
                                            <img data-src="./img/valdo/Cap/8.png" alt="">
                                            <img data-src="./img/valdo/Cap/9.png" alt="">
                                            <img data-src="./img/valdo/Cap/10.png" alt="">
                                            <img data-src="./img/valdo/Cap/11.png" alt="">
                                            <img data-src="./img/valdo/Cap/12.png" alt="">
                                            <img data-src="./img/valdo/Cap/13.png" alt="">
                                            <img data-src="./img/valdo/Cap/14.png" alt="">
                                            <img data-src="./img/valdo/Cap/18.png" alt="">
                                            <img data-src="./img/valdo/Cap/20.png" alt="">
                                            <img data-src="./img/valdo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/valdo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Spike/2.png" alt="">
                                            <img data-src="./img/valdo/Spike/4.png" alt="">
                                            <img data-src="./img/valdo/Spike/5.png" alt="">
                                            <img data-src="./img/valdo/Spike/6.png" alt="">
                                            <img data-src="./img/valdo/Spike/7.png" alt="">
                                            <img data-src="./img/valdo/Spike/8.png" alt="">
                                            <img data-src="./img/valdo/Spike/9.png" alt="">
                                            <img data-src="./img/valdo/Spike/10.png" alt="">
                                            <img data-src="./img/valdo/Spike/11.png" alt="">
                                            <img data-src="./img/valdo/Spike/12.png" alt="">
                                            <img data-src="./img/valdo/Spike/13.png" alt="">
                                            <img data-src="./img/valdo/Spike/14.png" alt="">
                                            <img data-src="./img/valdo/Spike/18.png" alt="">
                                            <img data-src="./img/valdo/Spike/20.png" alt="">
                                            <img data-src="./img/valdo/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/valdo/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Face/2.png" alt="">
                                            <img data-src="./img/valdo/Face/4.png" alt="">
                                            <img data-src="./img/valdo/Face/5.png" alt="">
                                            <img data-src="./img/valdo/Face/6.png" alt="">
                                            <img data-src="./img/valdo/Face/7.png" alt="">
                                            <img data-src="./img/valdo/Face/8.png" alt="">
                                            <img data-src="./img/valdo/Face/9.png" alt="">
                                            <img data-src="./img/valdo/Face/10.png" alt="">
                                            <img data-src="./img/valdo/Face/11.png" alt="">
                                            <img data-src="./img/valdo/Face/12.png" alt="">
                                            <img data-src="./img/valdo/Face/13.png" alt="">
                                            <img data-src="./img/valdo/Face/14.png" alt="">
                                            <img data-src="./img/valdo/Face/18.png" alt="">
                                            <img data-src="./img/valdo/Face/20.png" alt="">
                                            <img data-src="./img/valdo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/valdo/Face/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/valdo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./valdo-off-4534.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
