...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'ARTEMUS | OF-9458', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper artemus-of-9458 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Accents/2.png" alt="">
                                            <img src="./img/artemus/Accents/4.png" alt="">
                                            <img src="./img/artemus/Accents/5.png" alt="">
                                            <img src="./img/artemus/Accents/6.png" alt="">
                                            <img src="./img/artemus/Accents/7.png" alt="">
                                            <img src="./img/artemus/Accents/8.png" alt="">
                                            <img src="./img/artemus/Accents/9.png" alt="">
                                            <img src="./img/artemus/Accents/10.png" alt="">
                                            <img src="./img/artemus/Accents/11.png" alt="">
                                            <img src="./img/artemus/Accents/12.png" alt="">
                                            <img src="./img/artemus/Accents/13.png" alt="">
                                            <img src="./img/artemus/Accents/14.png" alt="">
                                            <img src="./img/artemus/Accents/18.png" alt="">
                                            <img src="./img/artemus/Accents/20.png" alt="">
                                            <img src="./img/artemus/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Cap Letter/2.png" alt="">
                                            <img src="./img/artemus/Cap Letter/4.png" alt="">
                                            <img src="./img/artemus/Cap Letter/5.png" alt="">
                                            <img src="./img/artemus/Cap Letter/6.png" alt="">
                                            <img src="./img/artemus/Cap Letter/7.png" alt="">
                                            <img src="./img/artemus/Cap Letter/8.png" alt="">
                                            <img src="./img/artemus/Cap Letter/9.png" alt="">
                                            <img src="./img/artemus/Cap Letter/10.png" alt="">
                                            <img src="./img/artemus/Cap Letter/11.png" alt="">
                                            <img src="./img/artemus/Cap Letter/12.png" alt="">
                                            <img src="./img/artemus/Cap Letter/13.png" alt="">
                                            <img src="./img/artemus/Cap Letter/14.png" alt="">
                                            <img src="./img/artemus/Cap Letter/18.png" alt="">
                                            <img src="./img/artemus/Cap Letter/20.png" alt="">
                                            <img src="./img/artemus/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Cap/2.png" alt="">
                                            <img src="./img/artemus/Cap/4.png" alt="">
                                            <img src="./img/artemus/Cap/5.png" alt="">
                                            <img src="./img/artemus/Cap/6.png" alt="">
                                            <img src="./img/artemus/Cap/7.png" alt="">
                                            <img src="./img/artemus/Cap/8.png" alt="">
                                            <img src="./img/artemus/Cap/9.png" alt="">
                                            <img src="./img/artemus/Cap/10.png" alt="">
                                            <img src="./img/artemus/Cap/11.png" alt="">
                                            <img src="./img/artemus/Cap/12.png" alt="">
                                            <img src="./img/artemus/Cap/13.png" alt="">
                                            <img src="./img/artemus/Cap/14.png" alt="">
                                            <img src="./img/artemus/Cap/18.png" alt="">
                                            <img src="./img/artemus/Cap/20.png" alt="">
                                            <img src="./img/artemus/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img src="./img/artemus/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Spike/2.png" alt="">
                                            <img src="./img/artemus/Spike/4.png" alt="">
                                            <img src="./img/artemus/Spike/5.png" alt="">
                                            <img src="./img/artemus/Spike/6.png" alt="">
                                            <img src="./img/artemus/Spike/7.png" alt="">
                                            <img src="./img/artemus/Spike/8.png" alt="">
                                            <img src="./img/artemus/Spike/9.png" alt="">
                                            <img src="./img/artemus/Spike/10.png" alt="">
                                            <img src="./img/artemus/Spike/11.png" alt="">
                                            <img src="./img/artemus/Spike/12.png" alt="">
                                            <img src="./img/artemus/Spike/13.png" alt="">
                                            <img src="./img/artemus/Spike/14.png" alt="">
                                            <img src="./img/artemus/Spike/18.png" alt="">
                                            <img src="./img/artemus/Spike/20.png" alt="">
                                            <img src="./img/artemus/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Barrel Letter/2.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/4.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/5.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/6.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/7.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/8.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/9.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/10.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/11.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/12.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/13.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/14.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/18.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/20.png" alt="">
                                            <img src="./img/artemus/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Face/2.png" alt="">
                                            <img src="./img/artemus/Face/4.png" alt="">
                                            <img src="./img/artemus/Face/5.png" alt="">
                                            <img src="./img/artemus/Face/6.png" alt="">
                                            <img src="./img/artemus/Face/7.png" alt="">
                                            <img src="./img/artemus/Face/8.png" alt="">
                                            <img src="./img/artemus/Face/9.png" alt="">
                                            <img src="./img/artemus/Face/10.png" alt="">
                                            <img src="./img/artemus/Face/11.png" alt="">
                                            <img src="./img/artemus/Face/12.png" alt="">
                                            <img src="./img/artemus/Face/13.png" alt="">
                                            <img src="./img/artemus/Face/14.png" alt="">
                                            <img src="./img/artemus/Face/18.png" alt="">
                                            <img src="./img/artemus/Face/20.png" alt="">
                                            <img src="./img/artemus/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img src="./img/artemus/Face/2.png" alt="">
                                        </div>
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./artemus-of-9458.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
