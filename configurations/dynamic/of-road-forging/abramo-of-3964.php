...
<body>
    ...
    <main>
        ...
        $image_path = $actual_linkf.'/off-road-forging/'.$file;
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'ABRAMO | OF-3964', 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'spike' => $spike
        , 'barrel' => $barrel, 'barrelletter' => $barrelletter,'image_path' => $image_path    ));
    ...
    <div class="config-wrapper abramo-of-3964 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>ABRAMO <span>its easy to build</span></h3>
                                <h1>OF-3964</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/abramo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/abramo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/abramo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/abramo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/abramo/Navigation/spike.png" alt="">
                                                    <span>spike</span>
                                                </li>
                                                <li>
                                                    <img src="./img/abramo/Navigation/barrel.png" alt="">
                                                    <span>barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/abramo/Navigation/barrel-letter.png" alt="">
                                                    <span>barrel-lette</span>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/abramo/default-model.png" alt="">
                                </div>    
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Accents/2.png" alt="">
                                            <img data-src="./img/abramo/Accents/4.png" alt="">
                                            <img data-src="./img/abramo/Accents/5.png" alt="">
                                            <img data-src="./img/abramo/Accents/6.png" alt="">
                                            <img data-src="./img/abramo/Accents/7.png" alt="">
                                            <img data-src="./img/abramo/Accents/8.png" alt="">
                                            <img data-src="./img/abramo/Accents/9.png" alt="">
                                            <img data-src="./img/abramo/Accents/10.png" alt="">
                                            <img data-src="./img/abramo/Accents/11.png" alt="">
                                            <img data-src="./img/abramo/Accents/12.png" alt="">
                                            <img data-src="./img/abramo/Accents/13.png" alt="">
                                            <img data-src="./img/abramo/Accents/14.png" alt="">
                                            <img data-src="./img/abramo/Accents/18.png" alt="">
                                            <img data-src="./img/abramo/Accents/20.png" alt="">
                                            <img data-src="./img/abramo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Face/2.png" alt="">
                                            <img data-src="./img/abramo/Face/4.png" alt="">
                                            <img data-src="./img/abramo/Face/5.png" alt="">
                                            <img data-src="./img/abramo/Face/6.png" alt="">
                                            <img data-src="./img/abramo/Face/7.png" alt="">
                                            <img data-src="./img/abramo/Face/8.png" alt="">
                                            <img data-src="./img/abramo/Face/9.png" alt="">
                                            <img data-src="./img/abramo/Face/10.png" alt="">
                                            <img data-src="./img/abramo/Face/11.png" alt="">
                                            <img data-src="./img/abramo/Face/12.png" alt="">
                                            <img data-src="./img/abramo/Face/13.png" alt="">
                                            <img data-src="./img/abramo/Face/14.png" alt="">
                                            <img data-src="./img/abramo/Face/18.png" alt="">
                                            <img data-src="./img/abramo/Face/20.png" alt="">
                                            <img data-src="./img/abramo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/abramo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Cap/2.png" alt="">
                                            <img data-src="./img/abramo/Cap/4.png" alt="">
                                            <img data-src="./img/abramo/Cap/5.png" alt="">
                                            <img data-src="./img/abramo/Cap/6.png" alt="">
                                            <img data-src="./img/abramo/Cap/7.png" alt="">
                                            <img data-src="./img/abramo/Cap/8.png" alt="">
                                            <img data-src="./img/abramo/Cap/9.png" alt="">
                                            <img data-src="./img/abramo/Cap/10.png" alt="">
                                            <img data-src="./img/abramo/Cap/11.png" alt="">
                                            <img data-src="./img/abramo/Cap/12.png" alt="">
                                            <img data-src="./img/abramo/Cap/13.png" alt="">
                                            <img data-src="./img/abramo/Cap/14.png" alt="">
                                            <img data-src="./img/abramo/Cap/18.png" alt="">
                                            <img data-src="./img/abramo/Cap/20.png" alt="">
                                            <img data-src="./img/abramo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/abramo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Spike/2.png" alt="">
                                            <img data-src="./img/abramo/Spike/4.png" alt="">
                                            <img data-src="./img/abramo/Spike/5.png" alt="">
                                            <img data-src="./img/abramo/Spike/6.png" alt="">
                                            <img data-src="./img/abramo/Spike/7.png" alt="">
                                            <img data-src="./img/abramo/Spike/8.png" alt="">
                                            <img data-src="./img/abramo/Spike/9.png" alt="">
                                            <img data-src="./img/abramo/Spike/10.png" alt="">
                                            <img data-src="./img/abramo/Spike/11.png" alt="">
                                            <img data-src="./img/abramo/Spike/12.png" alt="">
                                            <img data-src="./img/abramo/Spike/13.png" alt="">
                                            <img data-src="./img/abramo/Spike/14.png" alt="">
                                            <img data-src="./img/abramo/Spike/18.png" alt="">
                                            <img data-src="./img/abramo/Spike/20.png" alt="">
                                            <img data-src="./img/abramo/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img src="./img/abramo/Barrel/2.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/4.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/5.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/6.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/7.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/8.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/9.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/10.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/11.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/12.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/13.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/14.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/18.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/20.png" alt="Barrel">
                                            <img src="./img/abramo/Barrel/1.png" alt="Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img src="./img/abramo/Barrel/2.png" alt="Barrel">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/abramo/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/abramo/Barrel Letter/2.png" alt="">
                                        </div>
                                ...
                                <div class="config-pointer-wrap" data-html2canvas-ignore="true">
                                    ...
                                    <div class="config-pointer barrel">
                                        <h5 class="pointer-name">barrel</h5>
                                        <span class="pointer"></span>
                                    </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/abramo/default-model.png" class="preview">
                                    ...
                                    <div class="col-lg-11 col-md-5">
                                        ...
                                        <div class="choose-color-main">
                                            ...
                                            <div class="choose-color-title">
                                                ...
                                                <h5>Choose <span>Barrel Color</span></h5>
                        ...
                        <div class="col-12">
                            <div class="contact-form">
                                <form action="" method="post" class="maincls">
                                    ...
                                    <input class="color_name_data" type="hidden" name="barrel" value="">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./abramo-of-3964.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
