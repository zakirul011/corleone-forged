...
<body>
    ...
    <div class="config-wrapper masseria-of-9487 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./masseria-of-9487.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
