...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'off-road-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'CORAZZO | OF-2525', 'accents' => $accents, 'capletter' => $capletter,'cap' => $cap, 'spike' => $spike, 'barrelletter' => $barrelletter, 'face' => $face,'image_path' => $image_path ));
    ...
    <div class="config-wrapper corazzo-of-2525 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Accents/2.png" alt="">
                                            <img data-src="./img/corazzo/Accents/4.png" alt="">
                                            <img data-src="./img/corazzo/Accents/5.png" alt="">
                                            <img data-src="./img/corazzo/Accents/6.png" alt="">
                                            <img data-src="./img/corazzo/Accents/7.png" alt="">
                                            <img data-src="./img/corazzo/Accents/8.png" alt="">
                                            <img data-src="./img/corazzo/Accents/9.png" alt="">
                                            <img data-src="./img/corazzo/Accents/10.png" alt="">
                                            <img data-src="./img/corazzo/Accents/11.png" alt="">
                                            <img data-src="./img/corazzo/Accents/12.png" alt="">
                                            <img data-src="./img/corazzo/Accents/13.png" alt="">
                                            <img data-src="./img/corazzo/Accents/14.png" alt="">
                                            <img data-src="./img/corazzo/Accents/18.png" alt="">
                                            <img data-src="./img/corazzo/Accents/20.png" alt="">
                                            <img data-src="./img/corazzo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/corazzo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Cap/2.png" alt="">
                                            <img data-src="./img/corazzo/Cap/4.png" alt="">
                                            <img data-src="./img/corazzo/Cap/5.png" alt="">
                                            <img data-src="./img/corazzo/Cap/6.png" alt="">
                                            <img data-src="./img/corazzo/Cap/7.png" alt="">
                                            <img data-src="./img/corazzo/Cap/8.png" alt="">
                                            <img data-src="./img/corazzo/Cap/9.png" alt="">
                                            <img data-src="./img/corazzo/Cap/10.png" alt="">
                                            <img data-src="./img/corazzo/Cap/11.png" alt="">
                                            <img data-src="./img/corazzo/Cap/12.png" alt="">
                                            <img data-src="./img/corazzo/Cap/13.png" alt="">
                                            <img data-src="./img/corazzo/Cap/14.png" alt="">
                                            <img data-src="./img/corazzo/Cap/18.png" alt="">
                                            <img data-src="./img/corazzo/Cap/20.png" alt="">
                                            <img data-src="./img/corazzo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/corazzo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Spike/2.png" alt="">
                                            <img data-src="./img/corazzo/Spike/4.png" alt="">
                                            <img data-src="./img/corazzo/Spike/5.png" alt="">
                                            <img data-src="./img/corazzo/Spike/6.png" alt="">
                                            <img data-src="./img/corazzo/Spike/7.png" alt="">
                                            <img data-src="./img/corazzo/Spike/8.png" alt="">
                                            <img data-src="./img/corazzo/Spike/9.png" alt="">
                                            <img data-src="./img/corazzo/Spike/10.png" alt="">
                                            <img data-src="./img/corazzo/Spike/11.png" alt="">
                                            <img data-src="./img/corazzo/Spike/12.png" alt="">
                                            <img data-src="./img/corazzo/Spike/13.png" alt="">
                                            <img data-src="./img/corazzo/Spike/14.png" alt="">
                                            <img data-src="./img/corazzo/Spike/18.png" alt="">
                                            <img data-src="./img/corazzo/Spike/20.png" alt="">
                                            <img data-src="./img/corazzo/Spike/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Spike/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Barrel Letter/2.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/4.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/5.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/6.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/7.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/8.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/9.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/10.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/11.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/12.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/13.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/14.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/18.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/20.png" alt="">
                                            <img data-src="./img/corazzo/Barrel Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Barrel Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Face/2.png" alt="">
                                            <img data-src="./img/corazzo/Face/4.png" alt="">
                                            <img data-src="./img/corazzo/Face/5.png" alt="">
                                            <img data-src="./img/corazzo/Face/6.png" alt="">
                                            <img data-src="./img/corazzo/Face/7.png" alt="">
                                            <img data-src="./img/corazzo/Face/8.png" alt="">
                                            <img data-src="./img/corazzo/Face/9.png" alt="">
                                            <img data-src="./img/corazzo/Face/10.png" alt="">
                                            <img data-src="./img/corazzo/Face/11.png" alt="">
                                            <img data-src="./img/corazzo/Face/12.png" alt="">
                                            <img data-src="./img/corazzo/Face/13.png" alt="">
                                            <img data-src="./img/corazzo/Face/14.png" alt="">
                                            <img data-src="./img/corazzo/Face/18.png" alt="">
                                            <img data-src="./img/corazzo/Face/20.png" alt="">
                                            <img data-src="./img/corazzo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corazzo/Face/2.png" alt="">
                                        </div>
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./corazzo-of-2525.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
