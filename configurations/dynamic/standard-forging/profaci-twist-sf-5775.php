...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'PROFACI TWIST | SF-7399', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper profaci-twist-sf-5775 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>PROFACI TWIST <span>its easy to build</span></h3>
                                <h1>SF-7399</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/profaci-twist/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/profaci-twist/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Accents/2.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/4.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/5.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/6.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/7.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/8.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/9.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/10.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/11.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/12.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/13.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/14.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/18.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/20.png" alt="">
                                            <img data-src="./img/profaci-twist/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Face Letter/2.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/4.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/5.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/6.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/7.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/8.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/9.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/10.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/11.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/12.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/13.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/14.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/18.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/20.png" alt="">
                                            <img data-src="./img/profaci-twist/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Face/2.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/4.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/5.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/6.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/7.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/8.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/9.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/10.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/11.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/12.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/13.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/14.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/18.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/20.png" alt="">
                                            <img data-src="./img/profaci-twist/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Cap Letter/2.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/4.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/5.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/6.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/7.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/8.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/9.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/10.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/11.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/12.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/13.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/14.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/18.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/20.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Cap/2.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/4.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/5.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/6.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/7.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/8.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/9.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/10.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/11.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/12.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/13.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/14.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/18.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/20.png" alt="">
                                            <img data-src="./img/profaci-twist/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/profaci-twist/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Bolts/2.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/4.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/5.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/6.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/7.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/8.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/9.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/10.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/11.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/12.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/13.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/14.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/18.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/20.png" alt="">
                                            <img data-src="./img/profaci-twist/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/profaci-twist/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/profaci-twist/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/profaci-twist/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/profaci-twist/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./profaci-twist-sf-5775.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
