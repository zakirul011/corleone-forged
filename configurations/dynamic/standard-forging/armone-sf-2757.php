...
<body>
    ...
    <div class="config-wrapper armone-sf-2757 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>ARMONE <span>its easy to build</span></h3>
                                <h1>SF-2757</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/armone/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/armone/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/armone/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/armone/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/armone/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/armone/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/armone/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/armone/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/armone/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Accents/2.png" alt="">
                                            <img data-src="./img/armone/Accents/4.png" alt="">
                                            <img data-src="./img/armone/Accents/5.png" alt="">
                                            <img data-src="./img/armone/Accents/6.png" alt="">
                                            <img data-src="./img/armone/Accents/7.png" alt="">
                                            <img data-src="./img/armone/Accents/8.png" alt="">
                                            <img data-src="./img/armone/Accents/9.png" alt="">
                                            <img data-src="./img/armone/Accents/10.png" alt="">
                                            <img data-src="./img/armone/Accents/11.png" alt="">
                                            <img data-src="./img/armone/Accents/12.png" alt="">
                                            <img data-src="./img/armone/Accents/13.png" alt="">
                                            <img data-src="./img/armone/Accents/14.png" alt="">
                                            <img data-src="./img/armone/Accents/18.png" alt="">
                                            <img data-src="./img/armone/Accents/20.png" alt="">
                                            <img data-src="./img/armone/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Face Letter/2.png" alt="">
                                            <img data-src="./img/armone/Face Letter/4.png" alt="">
                                            <img data-src="./img/armone/Face Letter/5.png" alt="">
                                            <img data-src="./img/armone/Face Letter/6.png" alt="">
                                            <img data-src="./img/armone/Face Letter/7.png" alt="">
                                            <img data-src="./img/armone/Face Letter/8.png" alt="">
                                            <img data-src="./img/armone/Face Letter/9.png" alt="">
                                            <img data-src="./img/armone/Face Letter/10.png" alt="">
                                            <img data-src="./img/armone/Face Letter/11.png" alt="">
                                            <img data-src="./img/armone/Face Letter/12.png" alt="">
                                            <img data-src="./img/armone/Face Letter/13.png" alt="">
                                            <img data-src="./img/armone/Face Letter/14.png" alt="">
                                            <img data-src="./img/armone/Face Letter/18.png" alt="">
                                            <img data-src="./img/armone/Face Letter/20.png" alt="">
                                            <img data-src="./img/armone/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Face/2.png" alt="">
                                            <img data-src="./img/armone/Face/4.png" alt="">
                                            <img data-src="./img/armone/Face/5.png" alt="">
                                            <img data-src="./img/armone/Face/6.png" alt="">
                                            <img data-src="./img/armone/Face/7.png" alt="">
                                            <img data-src="./img/armone/Face/8.png" alt="">
                                            <img data-src="./img/armone/Face/9.png" alt="">
                                            <img data-src="./img/armone/Face/10.png" alt="">
                                            <img data-src="./img/armone/Face/11.png" alt="">
                                            <img data-src="./img/armone/Face/12.png" alt="">
                                            <img data-src="./img/armone/Face/13.png" alt="">
                                            <img data-src="./img/armone/Face/14.png" alt="">
                                            <img data-src="./img/armone/Face/18.png" alt="">
                                            <img data-src="./img/armone/Face/20.png" alt="">
                                            <img data-src="./img/armone/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Cap Letter/2.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/4.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/5.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/6.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/7.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/8.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/9.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/10.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/11.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/12.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/13.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/14.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/18.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/20.png" alt="">
                                            <img data-src="./img/armone/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Cap/2.png" alt="">
                                            <img data-src="./img/armone/Cap/4.png" alt="">
                                            <img data-src="./img/armone/Cap/5.png" alt="">
                                            <img data-src="./img/armone/Cap/6.png" alt="">
                                            <img data-src="./img/armone/Cap/7.png" alt="">
                                            <img data-src="./img/armone/Cap/8.png" alt="">
                                            <img data-src="./img/armone/Cap/9.png" alt="">
                                            <img data-src="./img/armone/Cap/10.png" alt="">
                                            <img data-src="./img/armone/Cap/11.png" alt="">
                                            <img data-src="./img/armone/Cap/12.png" alt="">
                                            <img data-src="./img/armone/Cap/13.png" alt="">
                                            <img data-src="./img/armone/Cap/14.png" alt="">
                                            <img data-src="./img/armone/Cap/18.png" alt="">
                                            <img data-src="./img/armone/Cap/20.png" alt="">
                                            <img data-src="./img/armone/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/armone/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Bolts/2.png" alt="">
                                            <img data-src="./img/armone/Bolts/4.png" alt="">
                                            <img data-src="./img/armone/Bolts/5.png" alt="">
                                            <img data-src="./img/armone/Bolts/6.png" alt="">
                                            <img data-src="./img/armone/Bolts/7.png" alt="">
                                            <img data-src="./img/armone/Bolts/8.png" alt="">
                                            <img data-src="./img/armone/Bolts/9.png" alt="">
                                            <img data-src="./img/armone/Bolts/10.png" alt="">
                                            <img data-src="./img/armone/Bolts/11.png" alt="">
                                            <img data-src="./img/armone/Bolts/12.png" alt="">
                                            <img data-src="./img/armone/Bolts/13.png" alt="">
                                            <img data-src="./img/armone/Bolts/14.png" alt="">
                                            <img data-src="./img/armone/Bolts/18.png" alt="">
                                            <img data-src="./img/armone/Bolts/20.png" alt="">
                                            <img data-src="./img/armone/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/armone/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/armone/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/armone/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/armone/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./armone-sf-2757.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
