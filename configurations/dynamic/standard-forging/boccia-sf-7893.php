...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'BOCCIA | SF-7893', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap, 'outerbarrel' => $outerbarrel, 'innerbarrrel' => $innerbarrrel,'image_path' => $image_path    ));
    ...
    <div class="config-wrapper boccia-sf-7893 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>BOCCIA <span>its easy to build</span></h3>
                                <h1>SF-7893</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/boccia/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/boccia/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/boccia/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/boccia/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/boccia/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/boccia/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/boccia/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/boccia/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Accents/2.png" alt="">
                                            <img data-src="./img/boccia/Accents/4.png" alt="">
                                            <img data-src="./img/boccia/Accents/5.png" alt="">
                                            <img data-src="./img/boccia/Accents/6.png" alt="">
                                            <img data-src="./img/boccia/Accents/7.png" alt="">
                                            <img data-src="./img/boccia/Accents/8.png" alt="">
                                            <img data-src="./img/boccia/Accents/9.png" alt="">
                                            <img data-src="./img/boccia/Accents/10.png" alt="">
                                            <img data-src="./img/boccia/Accents/11.png" alt="">
                                            <img data-src="./img/boccia/Accents/12.png" alt="">
                                            <img data-src="./img/boccia/Accents/13.png" alt="">
                                            <img data-src="./img/boccia/Accents/14.png" alt="">
                                            <img data-src="./img/boccia/Accents/18.png" alt="">
                                            <img data-src="./img/boccia/Accents/20.png" alt="">
                                            <img data-src="./img/boccia/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Face Letter/2.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/4.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/5.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/6.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/7.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/8.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/9.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/10.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/11.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/12.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/13.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/14.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/18.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/20.png" alt="">
                                            <img data-src="./img/boccia/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Face/2.png" alt="">
                                            <img data-src="./img/boccia/Face/4.png" alt="">
                                            <img data-src="./img/boccia/Face/5.png" alt="">
                                            <img data-src="./img/boccia/Face/6.png" alt="">
                                            <img data-src="./img/boccia/Face/7.png" alt="">
                                            <img data-src="./img/boccia/Face/8.png" alt="">
                                            <img data-src="./img/boccia/Face/9.png" alt="">
                                            <img data-src="./img/boccia/Face/10.png" alt="">
                                            <img data-src="./img/boccia/Face/11.png" alt="">
                                            <img data-src="./img/boccia/Face/12.png" alt="">
                                            <img data-src="./img/boccia/Face/13.png" alt="">
                                            <img data-src="./img/boccia/Face/14.png" alt="">
                                            <img data-src="./img/boccia/Face/18.png" alt="">
                                            <img data-src="./img/boccia/Face/20.png" alt="">
                                            <img data-src="./img/boccia/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Cap Letter/2.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/4.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/5.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/6.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/7.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/8.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/9.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/10.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/11.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/12.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/13.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/14.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/18.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/20.png" alt="">
                                            <img data-src="./img/boccia/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Cap/2.png" alt="">
                                            <img data-src="./img/boccia/Cap/4.png" alt="">
                                            <img data-src="./img/boccia/Cap/5.png" alt="">
                                            <img data-src="./img/boccia/Cap/6.png" alt="">
                                            <img data-src="./img/boccia/Cap/7.png" alt="">
                                            <img data-src="./img/boccia/Cap/8.png" alt="">
                                            <img data-src="./img/boccia/Cap/9.png" alt="">
                                            <img data-src="./img/boccia/Cap/10.png" alt="">
                                            <img data-src="./img/boccia/Cap/11.png" alt="">
                                            <img data-src="./img/boccia/Cap/12.png" alt="">
                                            <img data-src="./img/boccia/Cap/13.png" alt="">
                                            <img data-src="./img/boccia/Cap/14.png" alt="">
                                            <img data-src="./img/boccia/Cap/18.png" alt="">
                                            <img data-src="./img/boccia/Cap/20.png" alt="">
                                            <img data-src="./img/boccia/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/boccia/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/boccia/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/boccia/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/boccia/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/boccia/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./boccia-sf-7893.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
