...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'LUTHOR | SF-3238', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper luthor-sf-3238 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>LUTHOR <span>its easy to build</span></h3>
                                <h1>SF-3238</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/luthor/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/luthor/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/luthor/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/luthor/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/luthor/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/luthor/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/luthor/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/luthor/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/luthor/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Accents/2.png" alt="">
                                            <img data-src="./img/luthor/Accents/4.png" alt="">
                                            <img data-src="./img/luthor/Accents/5.png" alt="">
                                            <img data-src="./img/luthor/Accents/6.png" alt="">
                                            <img data-src="./img/luthor/Accents/7.png" alt="">
                                            <img data-src="./img/luthor/Accents/8.png" alt="">
                                            <img data-src="./img/luthor/Accents/9.png" alt="">
                                            <img data-src="./img/luthor/Accents/10.png" alt="">
                                            <img data-src="./img/luthor/Accents/11.png" alt="">
                                            <img data-src="./img/luthor/Accents/12.png" alt="">
                                            <img data-src="./img/luthor/Accents/13.png" alt="">
                                            <img data-src="./img/luthor/Accents/14.png" alt="">
                                            <img data-src="./img/luthor/Accents/18.png" alt="">
                                            <img data-src="./img/luthor/Accents/20.png" alt="">
                                            <img data-src="./img/luthor/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Face Letter/2.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/4.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/5.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/6.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/7.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/8.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/9.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/10.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/11.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/12.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/13.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/14.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/18.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/20.png" alt="">
                                            <img data-src="./img/luthor/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Face/2.png" alt="">
                                            <img data-src="./img/luthor/Face/4.png" alt="">
                                            <img data-src="./img/luthor/Face/5.png" alt="">
                                            <img data-src="./img/luthor/Face/6.png" alt="">
                                            <img data-src="./img/luthor/Face/7.png" alt="">
                                            <img data-src="./img/luthor/Face/8.png" alt="">
                                            <img data-src="./img/luthor/Face/9.png" alt="">
                                            <img data-src="./img/luthor/Face/10.png" alt="">
                                            <img data-src="./img/luthor/Face/11.png" alt="">
                                            <img data-src="./img/luthor/Face/12.png" alt="">
                                            <img data-src="./img/luthor/Face/13.png" alt="">
                                            <img data-src="./img/luthor/Face/14.png" alt="">
                                            <img data-src="./img/luthor/Face/18.png" alt="">
                                            <img data-src="./img/luthor/Face/20.png" alt="">
                                            <img data-src="./img/luthor/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Cap Letter/2.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/4.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/5.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/6.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/7.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/8.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/9.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/10.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/11.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/12.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/13.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/14.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/18.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/20.png" alt="">
                                            <img data-src="./img/luthor/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Cap/2.png" alt="">
                                            <img data-src="./img/luthor/Cap/4.png" alt="">
                                            <img data-src="./img/luthor/Cap/5.png" alt="">
                                            <img data-src="./img/luthor/Cap/6.png" alt="">
                                            <img data-src="./img/luthor/Cap/7.png" alt="">
                                            <img data-src="./img/luthor/Cap/8.png" alt="">
                                            <img data-src="./img/luthor/Cap/9.png" alt="">
                                            <img data-src="./img/luthor/Cap/10.png" alt="">
                                            <img data-src="./img/luthor/Cap/11.png" alt="">
                                            <img data-src="./img/luthor/Cap/12.png" alt="">
                                            <img data-src="./img/luthor/Cap/13.png" alt="">
                                            <img data-src="./img/luthor/Cap/14.png" alt="">
                                            <img data-src="./img/luthor/Cap/18.png" alt="">
                                            <img data-src="./img/luthor/Cap/20.png" alt="">
                                            <img data-src="./img/luthor/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/luthor/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Bolts/2.png" alt="">
                                            <img data-src="./img/luthor/Bolts/4.png" alt="">
                                            <img data-src="./img/luthor/Bolts/5.png" alt="">
                                            <img data-src="./img/luthor/Bolts/6.png" alt="">
                                            <img data-src="./img/luthor/Bolts/7.png" alt="">
                                            <img data-src="./img/luthor/Bolts/8.png" alt="">
                                            <img data-src="./img/luthor/Bolts/9.png" alt="">
                                            <img data-src="./img/luthor/Bolts/10.png" alt="">
                                            <img data-src="./img/luthor/Bolts/11.png" alt="">
                                            <img data-src="./img/luthor/Bolts/12.png" alt="">
                                            <img data-src="./img/luthor/Bolts/13.png" alt="">
                                            <img data-src="./img/luthor/Bolts/14.png" alt="">
                                            <img data-src="./img/luthor/Bolts/18.png" alt="">
                                            <img data-src="./img/luthor/Bolts/20.png" alt="">
                                            <img data-src="./img/luthor/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/luthor/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/luthor/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/luthor/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/luthor/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./luthor-sf-3238.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
