...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'BANDIDO | SF-7399', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper bandido-sf-7399 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>BANDIDO <span>its easy to build</span></h3>
                                <h1>SF-7399</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/bandido/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bandido/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bandido/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bandido/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bandido/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bandido/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bandido/Navigation/outer-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/bandido/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Accents/2.png" alt="">
                                            <img data-src="./img/bandido/Accents/4.png" alt="">
                                            <img data-src="./img/bandido/Accents/5.png" alt="">
                                            <img data-src="./img/bandido/Accents/6.png" alt="">
                                            <img data-src="./img/bandido/Accents/7.png" alt="">
                                            <img data-src="./img/bandido/Accents/8.png" alt="">
                                            <img data-src="./img/bandido/Accents/9.png" alt="">
                                            <img data-src="./img/bandido/Accents/10.png" alt="">
                                            <img data-src="./img/bandido/Accents/11.png" alt="">
                                            <img data-src="./img/bandido/Accents/12.png" alt="">
                                            <img data-src="./img/bandido/Accents/13.png" alt="">
                                            <img data-src="./img/bandido/Accents/14.png" alt="">
                                            <img data-src="./img/bandido/Accents/18.png" alt="">
                                            <img data-src="./img/bandido/Accents/20.png" alt="">
                                            <img data-src="./img/bandido/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Face Letter/2.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/4.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/5.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/6.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/7.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/8.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/9.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/10.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/11.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/12.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/13.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/14.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/18.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/20.png" alt="">
                                            <img data-src="./img/bandido/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Face/2.png" alt="">
                                            <img data-src="./img/bandido/Face/4.png" alt="">
                                            <img data-src="./img/bandido/Face/5.png" alt="">
                                            <img data-src="./img/bandido/Face/6.png" alt="">
                                            <img data-src="./img/bandido/Face/7.png" alt="">
                                            <img data-src="./img/bandido/Face/8.png" alt="">
                                            <img data-src="./img/bandido/Face/9.png" alt="">
                                            <img data-src="./img/bandido/Face/10.png" alt="">
                                            <img data-src="./img/bandido/Face/11.png" alt="">
                                            <img data-src="./img/bandido/Face/12.png" alt="">
                                            <img data-src="./img/bandido/Face/13.png" alt="">
                                            <img data-src="./img/bandido/Face/14.png" alt="">
                                            <img data-src="./img/bandido/Face/18.png" alt="">
                                            <img data-src="./img/bandido/Face/20.png" alt="">
                                            <img data-src="./img/bandido/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Cap Letter/2.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/4.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/5.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/6.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/7.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/8.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/9.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/10.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/11.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/12.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/13.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/14.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/18.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/20.png" alt="">
                                            <img data-src="./img/bandido/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Cap/2.png" alt="">
                                            <img data-src="./img/bandido/Cap/4.png" alt="">
                                            <img data-src="./img/bandido/Cap/5.png" alt="">
                                            <img data-src="./img/bandido/Cap/6.png" alt="">
                                            <img data-src="./img/bandido/Cap/7.png" alt="">
                                            <img data-src="./img/bandido/Cap/8.png" alt="">
                                            <img data-src="./img/bandido/Cap/9.png" alt="">
                                            <img data-src="./img/bandido/Cap/10.png" alt="">
                                            <img data-src="./img/bandido/Cap/11.png" alt="">
                                            <img data-src="./img/bandido/Cap/12.png" alt="">
                                            <img data-src="./img/bandido/Cap/13.png" alt="">
                                            <img data-src="./img/bandido/Cap/14.png" alt="">
                                            <img data-src="./img/bandido/Cap/18.png" alt="">
                                            <img data-src="./img/bandido/Cap/20.png" alt="">
                                            <img data-src="./img/bandido/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/bandido/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Bolts/2.png" alt="">
                                            <img data-src="./img/bandido/Bolts/4.png" alt="">
                                            <img data-src="./img/bandido/Bolts/5.png" alt="">
                                            <img data-src="./img/bandido/Bolts/6.png" alt="">
                                            <img data-src="./img/bandido/Bolts/7.png" alt="">
                                            <img data-src="./img/bandido/Bolts/8.png" alt="">
                                            <img data-src="./img/bandido/Bolts/9.png" alt="">
                                            <img data-src="./img/bandido/Bolts/10.png" alt="">
                                            <img data-src="./img/bandido/Bolts/11.png" alt="">
                                            <img data-src="./img/bandido/Bolts/12.png" alt="">
                                            <img data-src="./img/bandido/Bolts/13.png" alt="">
                                            <img data-src="./img/bandido/Bolts/14.png" alt="">
                                            <img data-src="./img/bandido/Bolts/18.png" alt="">
                                            <img data-src="./img/bandido/Bolts/20.png" alt="">
                                            <img data-src="./img/bandido/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/bandido/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bandido/Outer Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/bandido/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./bandido-sf-7399.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
