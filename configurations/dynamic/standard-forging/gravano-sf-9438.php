...
<body>
    ...
    <div class="config-wrapper gravano-sf-9438 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>GRAVANO <span>its easy to build</span></h3>
                                <h1>SF-9438</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/gravano/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gravano/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gravano/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gravano/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gravano/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gravano/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gravano/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gravano/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/gravano/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Accents/2.png" alt="">
                                            <img data-src="./img/gravano/Accents/4.png" alt="">
                                            <img data-src="./img/gravano/Accents/5.png" alt="">
                                            <img data-src="./img/gravano/Accents/6.png" alt="">
                                            <img data-src="./img/gravano/Accents/7.png" alt="">
                                            <img data-src="./img/gravano/Accents/8.png" alt="">
                                            <img data-src="./img/gravano/Accents/9.png" alt="">
                                            <img data-src="./img/gravano/Accents/10.png" alt="">
                                            <img data-src="./img/gravano/Accents/11.png" alt="">
                                            <img data-src="./img/gravano/Accents/12.png" alt="">
                                            <img data-src="./img/gravano/Accents/13.png" alt="">
                                            <img data-src="./img/gravano/Accents/14.png" alt="">
                                            <img data-src="./img/gravano/Accents/18.png" alt="">
                                            <img data-src="./img/gravano/Accents/20.png" alt="">
                                            <img data-src="./img/gravano/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Face Letter/2.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/4.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/5.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/6.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/7.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/8.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/9.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/10.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/11.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/12.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/13.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/14.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/18.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/20.png" alt="">
                                            <img data-src="./img/gravano/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Face/2.png" alt="">
                                            <img data-src="./img/gravano/Face/4.png" alt="">
                                            <img data-src="./img/gravano/Face/5.png" alt="">
                                            <img data-src="./img/gravano/Face/6.png" alt="">
                                            <img data-src="./img/gravano/Face/7.png" alt="">
                                            <img data-src="./img/gravano/Face/8.png" alt="">
                                            <img data-src="./img/gravano/Face/9.png" alt="">
                                            <img data-src="./img/gravano/Face/10.png" alt="">
                                            <img data-src="./img/gravano/Face/11.png" alt="">
                                            <img data-src="./img/gravano/Face/12.png" alt="">
                                            <img data-src="./img/gravano/Face/13.png" alt="">
                                            <img data-src="./img/gravano/Face/14.png" alt="">
                                            <img data-src="./img/gravano/Face/18.png" alt="">
                                            <img data-src="./img/gravano/Face/20.png" alt="">
                                            <img data-src="./img/gravano/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Cap Letter/2.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/4.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/5.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/6.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/7.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/8.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/9.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/10.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/11.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/12.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/13.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/14.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/18.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/20.png" alt="">
                                            <img data-src="./img/gravano/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Cap/2.png" alt="">
                                            <img data-src="./img/gravano/Cap/4.png" alt="">
                                            <img data-src="./img/gravano/Cap/5.png" alt="">
                                            <img data-src="./img/gravano/Cap/6.png" alt="">
                                            <img data-src="./img/gravano/Cap/7.png" alt="">
                                            <img data-src="./img/gravano/Cap/8.png" alt="">
                                            <img data-src="./img/gravano/Cap/9.png" alt="">
                                            <img data-src="./img/gravano/Cap/10.png" alt="">
                                            <img data-src="./img/gravano/Cap/11.png" alt="">
                                            <img data-src="./img/gravano/Cap/12.png" alt="">
                                            <img data-src="./img/gravano/Cap/13.png" alt="">
                                            <img data-src="./img/gravano/Cap/14.png" alt="">
                                            <img data-src="./img/gravano/Cap/18.png" alt="">
                                            <img data-src="./img/gravano/Cap/20.png" alt="">
                                            <img data-src="./img/gravano/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/gravano/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Bolts/2.png" alt="">
                                            <img data-src="./img/gravano/Bolts/4.png" alt="">
                                            <img data-src="./img/gravano/Bolts/5.png" alt="">
                                            <img data-src="./img/gravano/Bolts/6.png" alt="">
                                            <img data-src="./img/gravano/Bolts/7.png" alt="">
                                            <img data-src="./img/gravano/Bolts/8.png" alt="">
                                            <img data-src="./img/gravano/Bolts/9.png" alt="">
                                            <img data-src="./img/gravano/Bolts/10.png" alt="">
                                            <img data-src="./img/gravano/Bolts/11.png" alt="">
                                            <img data-src="./img/gravano/Bolts/12.png" alt="">
                                            <img data-src="./img/gravano/Bolts/13.png" alt="">
                                            <img data-src="./img/gravano/Bolts/14.png" alt="">
                                            <img data-src="./img/gravano/Bolts/18.png" alt="">
                                            <img data-src="./img/gravano/Bolts/20.png" alt="">
                                            <img data-src="./img/gravano/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/gravano/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/gravano/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gravano/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/gravano/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./gravano-sf-9438.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
