...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'DONNO | SF-7412', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper donno-sf-7412 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>DONNO <span>its easy to build</span></h3>
                                <h1>SF-7412</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/donno/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/donno/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/donno/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/donno/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/donno/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/donno/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/donno/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/donno/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/donno/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Accents/2.png" alt="">
                                            <img data-src="./img/donno/Accents/4.png" alt="">
                                            <img data-src="./img/donno/Accents/5.png" alt="">
                                            <img data-src="./img/donno/Accents/6.png" alt="">
                                            <img data-src="./img/donno/Accents/7.png" alt="">
                                            <img data-src="./img/donno/Accents/8.png" alt="">
                                            <img data-src="./img/donno/Accents/9.png" alt="">
                                            <img data-src="./img/donno/Accents/10.png" alt="">
                                            <img data-src="./img/donno/Accents/11.png" alt="">
                                            <img data-src="./img/donno/Accents/12.png" alt="">
                                            <img data-src="./img/donno/Accents/13.png" alt="">
                                            <img data-src="./img/donno/Accents/14.png" alt="">
                                            <img data-src="./img/donno/Accents/18.png" alt="">
                                            <img data-src="./img/donno/Accents/20.png" alt="">
                                            <img data-src="./img/donno/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Face Letter/2.png" alt="">
                                            <img data-src="./img/donno/Face Letter/4.png" alt="">
                                            <img data-src="./img/donno/Face Letter/5.png" alt="">
                                            <img data-src="./img/donno/Face Letter/6.png" alt="">
                                            <img data-src="./img/donno/Face Letter/7.png" alt="">
                                            <img data-src="./img/donno/Face Letter/8.png" alt="">
                                            <img data-src="./img/donno/Face Letter/9.png" alt="">
                                            <img data-src="./img/donno/Face Letter/10.png" alt="">
                                            <img data-src="./img/donno/Face Letter/11.png" alt="">
                                            <img data-src="./img/donno/Face Letter/12.png" alt="">
                                            <img data-src="./img/donno/Face Letter/13.png" alt="">
                                            <img data-src="./img/donno/Face Letter/14.png" alt="">
                                            <img data-src="./img/donno/Face Letter/18.png" alt="">
                                            <img data-src="./img/donno/Face Letter/20.png" alt="">
                                            <img data-src="./img/donno/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Face/2.png" alt="">
                                            <img data-src="./img/donno/Face/4.png" alt="">
                                            <img data-src="./img/donno/Face/5.png" alt="">
                                            <img data-src="./img/donno/Face/6.png" alt="">
                                            <img data-src="./img/donno/Face/7.png" alt="">
                                            <img data-src="./img/donno/Face/8.png" alt="">
                                            <img data-src="./img/donno/Face/9.png" alt="">
                                            <img data-src="./img/donno/Face/10.png" alt="">
                                            <img data-src="./img/donno/Face/11.png" alt="">
                                            <img data-src="./img/donno/Face/12.png" alt="">
                                            <img data-src="./img/donno/Face/13.png" alt="">
                                            <img data-src="./img/donno/Face/14.png" alt="">
                                            <img data-src="./img/donno/Face/18.png" alt="">
                                            <img data-src="./img/donno/Face/20.png" alt="">
                                            <img data-src="./img/donno/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Cap Letter/2.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/4.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/5.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/6.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/7.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/8.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/9.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/10.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/11.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/12.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/13.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/14.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/18.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/20.png" alt="">
                                            <img data-src="./img/donno/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Cap/2.png" alt="">
                                            <img data-src="./img/donno/Cap/4.png" alt="">
                                            <img data-src="./img/donno/Cap/5.png" alt="">
                                            <img data-src="./img/donno/Cap/6.png" alt="">
                                            <img data-src="./img/donno/Cap/7.png" alt="">
                                            <img data-src="./img/donno/Cap/8.png" alt="">
                                            <img data-src="./img/donno/Cap/9.png" alt="">
                                            <img data-src="./img/donno/Cap/10.png" alt="">
                                            <img data-src="./img/donno/Cap/11.png" alt="">
                                            <img data-src="./img/donno/Cap/12.png" alt="">
                                            <img data-src="./img/donno/Cap/13.png" alt="">
                                            <img data-src="./img/donno/Cap/14.png" alt="">
                                            <img data-src="./img/donno/Cap/18.png" alt="">
                                            <img data-src="./img/donno/Cap/20.png" alt="">
                                            <img data-src="./img/donno/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/donno/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Bolts/2.png" alt="">
                                            <img data-src="./img/donno/Bolts/4.png" alt="">
                                            <img data-src="./img/donno/Bolts/5.png" alt="">
                                            <img data-src="./img/donno/Bolts/6.png" alt="">
                                            <img data-src="./img/donno/Bolts/7.png" alt="">
                                            <img data-src="./img/donno/Bolts/8.png" alt="">
                                            <img data-src="./img/donno/Bolts/9.png" alt="">
                                            <img data-src="./img/donno/Bolts/10.png" alt="">
                                            <img data-src="./img/donno/Bolts/11.png" alt="">
                                            <img data-src="./img/donno/Bolts/12.png" alt="">
                                            <img data-src="./img/donno/Bolts/13.png" alt="">
                                            <img data-src="./img/donno/Bolts/14.png" alt="">
                                            <img data-src="./img/donno/Bolts/18.png" alt="">
                                            <img data-src="./img/donno/Bolts/20.png" alt="">
                                            <img data-src="./img/donno/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/donno/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/donno/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/donno/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/donno/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./donno-sf-7412.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
