...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'RICCA | SF-4563', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap, 'outerbarrel' => $outerbarrel, 'innerbarrrel' => $innerbarrrel,'image_path' => $image_path    ));
    ...
    <div class="config-wrapper ricca-sf-4563 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>RICCA <span>its easy to build</span></h3>
                                <h1>SF-4563</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/ricca/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ricca/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ricca/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ricca/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ricca/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ricca/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/ricca/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/ricca/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Accents/2.png" alt="">
                                            <img data-src="./img/ricca/Accents/4.png" alt="">
                                            <img data-src="./img/ricca/Accents/5.png" alt="">
                                            <img data-src="./img/ricca/Accents/6.png" alt="">
                                            <img data-src="./img/ricca/Accents/7.png" alt="">
                                            <img data-src="./img/ricca/Accents/8.png" alt="">
                                            <img data-src="./img/ricca/Accents/9.png" alt="">
                                            <img data-src="./img/ricca/Accents/10.png" alt="">
                                            <img data-src="./img/ricca/Accents/11.png" alt="">
                                            <img data-src="./img/ricca/Accents/12.png" alt="">
                                            <img data-src="./img/ricca/Accents/13.png" alt="">
                                            <img data-src="./img/ricca/Accents/14.png" alt="">
                                            <img data-src="./img/ricca/Accents/18.png" alt="">
                                            <img data-src="./img/ricca/Accents/20.png" alt="">
                                            <img data-src="./img/ricca/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Face Letter/2.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/4.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/5.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/6.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/7.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/8.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/9.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/10.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/11.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/12.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/13.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/14.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/18.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/20.png" alt="">
                                            <img data-src="./img/ricca/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Face/2.png" alt="">
                                            <img data-src="./img/ricca/Face/4.png" alt="">
                                            <img data-src="./img/ricca/Face/5.png" alt="">
                                            <img data-src="./img/ricca/Face/6.png" alt="">
                                            <img data-src="./img/ricca/Face/7.png" alt="">
                                            <img data-src="./img/ricca/Face/8.png" alt="">
                                            <img data-src="./img/ricca/Face/9.png" alt="">
                                            <img data-src="./img/ricca/Face/10.png" alt="">
                                            <img data-src="./img/ricca/Face/11.png" alt="">
                                            <img data-src="./img/ricca/Face/12.png" alt="">
                                            <img data-src="./img/ricca/Face/13.png" alt="">
                                            <img data-src="./img/ricca/Face/14.png" alt="">
                                            <img data-src="./img/ricca/Face/18.png" alt="">
                                            <img data-src="./img/ricca/Face/20.png" alt="">
                                            <img data-src="./img/ricca/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Cap Letter/2.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/4.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/5.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/6.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/7.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/8.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/9.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/10.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/11.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/12.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/13.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/14.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/18.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/20.png" alt="">
                                            <img data-src="./img/ricca/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Cap/2.png" alt="">
                                            <img data-src="./img/ricca/Cap/4.png" alt="">
                                            <img data-src="./img/ricca/Cap/5.png" alt="">
                                            <img data-src="./img/ricca/Cap/6.png" alt="">
                                            <img data-src="./img/ricca/Cap/7.png" alt="">
                                            <img data-src="./img/ricca/Cap/8.png" alt="">
                                            <img data-src="./img/ricca/Cap/9.png" alt="">
                                            <img data-src="./img/ricca/Cap/10.png" alt="">
                                            <img data-src="./img/ricca/Cap/11.png" alt="">
                                            <img data-src="./img/ricca/Cap/12.png" alt="">
                                            <img data-src="./img/ricca/Cap/13.png" alt="">
                                            <img data-src="./img/ricca/Cap/14.png" alt="">
                                            <img data-src="./img/ricca/Cap/18.png" alt="">
                                            <img data-src="./img/ricca/Cap/20.png" alt="">
                                            <img data-src="./img/ricca/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/ricca/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/ricca/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/ricca/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/ricca/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/ricca/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./ricca-sf-4563.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
