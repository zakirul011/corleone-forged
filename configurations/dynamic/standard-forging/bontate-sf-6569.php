...
<body>
    ...
    <div class="config-wrapper bontate-sf-6569 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>BONTATE <span>its easy to build</span></h3>
                                <h1>SF-6569</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/bontate/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bontate/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bontate/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bontate/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bontate/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bontate/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bontate/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/bontate/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/bontate/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Accents/2.png" alt="">
                                            <img data-src="./img/bontate/Accents/4.png" alt="">
                                            <img data-src="./img/bontate/Accents/5.png" alt="">
                                            <img data-src="./img/bontate/Accents/6.png" alt="">
                                            <img data-src="./img/bontate/Accents/7.png" alt="">
                                            <img data-src="./img/bontate/Accents/8.png" alt="">
                                            <img data-src="./img/bontate/Accents/9.png" alt="">
                                            <img data-src="./img/bontate/Accents/10.png" alt="">
                                            <img data-src="./img/bontate/Accents/11.png" alt="">
                                            <img data-src="./img/bontate/Accents/12.png" alt="">
                                            <img data-src="./img/bontate/Accents/13.png" alt="">
                                            <img data-src="./img/bontate/Accents/14.png" alt="">
                                            <img data-src="./img/bontate/Accents/18.png" alt="">
                                            <img data-src="./img/bontate/Accents/20.png" alt="">
                                            <img data-src="./img/bontate/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Face Letter/2.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/4.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/5.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/6.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/7.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/8.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/9.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/10.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/11.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/12.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/13.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/14.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/18.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/20.png" alt="">
                                            <img data-src="./img/bontate/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Face/2.png" alt="">
                                            <img data-src="./img/bontate/Face/4.png" alt="">
                                            <img data-src="./img/bontate/Face/5.png" alt="">
                                            <img data-src="./img/bontate/Face/6.png" alt="">
                                            <img data-src="./img/bontate/Face/7.png" alt="">
                                            <img data-src="./img/bontate/Face/8.png" alt="">
                                            <img data-src="./img/bontate/Face/9.png" alt="">
                                            <img data-src="./img/bontate/Face/10.png" alt="">
                                            <img data-src="./img/bontate/Face/11.png" alt="">
                                            <img data-src="./img/bontate/Face/12.png" alt="">
                                            <img data-src="./img/bontate/Face/13.png" alt="">
                                            <img data-src="./img/bontate/Face/14.png" alt="">
                                            <img data-src="./img/bontate/Face/18.png" alt="">
                                            <img data-src="./img/bontate/Face/20.png" alt="">
                                            <img data-src="./img/bontate/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Cap Letter/2.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/4.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/5.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/6.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/7.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/8.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/9.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/10.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/11.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/12.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/13.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/14.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/18.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/20.png" alt="">
                                            <img data-src="./img/bontate/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Cap/2.png" alt="">
                                            <img data-src="./img/bontate/Cap/4.png" alt="">
                                            <img data-src="./img/bontate/Cap/5.png" alt="">
                                            <img data-src="./img/bontate/Cap/6.png" alt="">
                                            <img data-src="./img/bontate/Cap/7.png" alt="">
                                            <img data-src="./img/bontate/Cap/8.png" alt="">
                                            <img data-src="./img/bontate/Cap/9.png" alt="">
                                            <img data-src="./img/bontate/Cap/10.png" alt="">
                                            <img data-src="./img/bontate/Cap/11.png" alt="">
                                            <img data-src="./img/bontate/Cap/12.png" alt="">
                                            <img data-src="./img/bontate/Cap/13.png" alt="">
                                            <img data-src="./img/bontate/Cap/14.png" alt="">
                                            <img data-src="./img/bontate/Cap/18.png" alt="">
                                            <img data-src="./img/bontate/Cap/20.png" alt="">
                                            <img data-src="./img/bontate/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/bontate/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Bolts/2.png" alt="">
                                            <img data-src="./img/bontate/Bolts/4.png" alt="">
                                            <img data-src="./img/bontate/Bolts/5.png" alt="">
                                            <img data-src="./img/bontate/Bolts/6.png" alt="">
                                            <img data-src="./img/bontate/Bolts/7.png" alt="">
                                            <img data-src="./img/bontate/Bolts/8.png" alt="">
                                            <img data-src="./img/bontate/Bolts/9.png" alt="">
                                            <img data-src="./img/bontate/Bolts/10.png" alt="">
                                            <img data-src="./img/bontate/Bolts/11.png" alt="">
                                            <img data-src="./img/bontate/Bolts/12.png" alt="">
                                            <img data-src="./img/bontate/Bolts/13.png" alt="">
                                            <img data-src="./img/bontate/Bolts/14.png" alt="">
                                            <img data-src="./img/bontate/Bolts/18.png" alt="">
                                            <img data-src="./img/bontate/Bolts/20.png" alt="">
                                            <img data-src="./img/bontate/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/bontate/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/bontate/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/bontate/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/bontate/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./bontate-sf-6569.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
