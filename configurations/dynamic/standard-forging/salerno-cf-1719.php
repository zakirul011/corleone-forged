...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'SALERNO | CF-1719', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper salerno-cf-1719 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>SALERNO <span>its easy to build</span></h3>
                                <h1>CF-1719</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/salerno/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/salerno/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/salerno/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/salerno/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/salerno/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/salerno/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/salerno/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/salerno/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/salerno/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Accents/2.png" alt="">
                                            <img data-src="./img/salerno/Accents/4.png" alt="">
                                            <img data-src="./img/salerno/Accents/5.png" alt="">
                                            <img data-src="./img/salerno/Accents/6.png" alt="">
                                            <img data-src="./img/salerno/Accents/7.png" alt="">
                                            <img data-src="./img/salerno/Accents/8.png" alt="">
                                            <img data-src="./img/salerno/Accents/9.png" alt="">
                                            <img data-src="./img/salerno/Accents/10.png" alt="">
                                            <img data-src="./img/salerno/Accents/11.png" alt="">
                                            <img data-src="./img/salerno/Accents/12.png" alt="">
                                            <img data-src="./img/salerno/Accents/13.png" alt="">
                                            <img data-src="./img/salerno/Accents/14.png" alt="">
                                            <img data-src="./img/salerno/Accents/18.png" alt="">
                                            <img data-src="./img/salerno/Accents/20.png" alt="">
                                            <img data-src="./img/salerno/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Face Letter/2.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/4.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/5.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/6.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/7.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/8.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/9.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/10.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/11.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/12.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/13.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/14.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/18.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/20.png" alt="">
                                            <img data-src="./img/salerno/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Face/2.png" alt="">
                                            <img data-src="./img/salerno/Face/4.png" alt="">
                                            <img data-src="./img/salerno/Face/5.png" alt="">
                                            <img data-src="./img/salerno/Face/6.png" alt="">
                                            <img data-src="./img/salerno/Face/7.png" alt="">
                                            <img data-src="./img/salerno/Face/8.png" alt="">
                                            <img data-src="./img/salerno/Face/9.png" alt="">
                                            <img data-src="./img/salerno/Face/10.png" alt="">
                                            <img data-src="./img/salerno/Face/11.png" alt="">
                                            <img data-src="./img/salerno/Face/12.png" alt="">
                                            <img data-src="./img/salerno/Face/13.png" alt="">
                                            <img data-src="./img/salerno/Face/14.png" alt="">
                                            <img data-src="./img/salerno/Face/18.png" alt="">
                                            <img data-src="./img/salerno/Face/20.png" alt="">
                                            <img data-src="./img/salerno/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Cap Letter/2.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/4.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/5.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/6.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/7.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/8.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/9.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/10.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/11.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/12.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/13.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/14.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/18.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/20.png" alt="">
                                            <img data-src="./img/salerno/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Cap/2.png" alt="">
                                            <img data-src="./img/salerno/Cap/4.png" alt="">
                                            <img data-src="./img/salerno/Cap/5.png" alt="">
                                            <img data-src="./img/salerno/Cap/6.png" alt="">
                                            <img data-src="./img/salerno/Cap/7.png" alt="">
                                            <img data-src="./img/salerno/Cap/8.png" alt="">
                                            <img data-src="./img/salerno/Cap/9.png" alt="">
                                            <img data-src="./img/salerno/Cap/10.png" alt="">
                                            <img data-src="./img/salerno/Cap/11.png" alt="">
                                            <img data-src="./img/salerno/Cap/12.png" alt="">
                                            <img data-src="./img/salerno/Cap/13.png" alt="">
                                            <img data-src="./img/salerno/Cap/14.png" alt="">
                                            <img data-src="./img/salerno/Cap/18.png" alt="">
                                            <img data-src="./img/salerno/Cap/20.png" alt="">
                                            <img data-src="./img/salerno/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/salerno/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Bolts/2.png" alt="">
                                            <img data-src="./img/salerno/Bolts/4.png" alt="">
                                            <img data-src="./img/salerno/Bolts/5.png" alt="">
                                            <img data-src="./img/salerno/Bolts/6.png" alt="">
                                            <img data-src="./img/salerno/Bolts/7.png" alt="">
                                            <img data-src="./img/salerno/Bolts/8.png" alt="">
                                            <img data-src="./img/salerno/Bolts/9.png" alt="">
                                            <img data-src="./img/salerno/Bolts/10.png" alt="">
                                            <img data-src="./img/salerno/Bolts/11.png" alt="">
                                            <img data-src="./img/salerno/Bolts/12.png" alt="">
                                            <img data-src="./img/salerno/Bolts/13.png" alt="">
                                            <img data-src="./img/salerno/Bolts/14.png" alt="">
                                            <img data-src="./img/salerno/Bolts/18.png" alt="">
                                            <img data-src="./img/salerno/Bolts/20.png" alt="">
                                            <img data-src="./img/salerno/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/salerno/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/salerno/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/salerno/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/salerno/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./salerno-cf-1719.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
