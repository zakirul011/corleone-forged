...
<body>
    ...
    <div class="config-wrapper decarlo-sf-6259 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>DECARLO <span>its easy to build</span></h3>
                                <h1>SF-6259</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/decarlo/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/decarlo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Accents/2.png" alt="">
                                            <img data-src="./img/decarlo/Accents/4.png" alt="">
                                            <img data-src="./img/decarlo/Accents/5.png" alt="">
                                            <img data-src="./img/decarlo/Accents/6.png" alt="">
                                            <img data-src="./img/decarlo/Accents/7.png" alt="">
                                            <img data-src="./img/decarlo/Accents/8.png" alt="">
                                            <img data-src="./img/decarlo/Accents/9.png" alt="">
                                            <img data-src="./img/decarlo/Accents/10.png" alt="">
                                            <img data-src="./img/decarlo/Accents/11.png" alt="">
                                            <img data-src="./img/decarlo/Accents/12.png" alt="">
                                            <img data-src="./img/decarlo/Accents/13.png" alt="">
                                            <img data-src="./img/decarlo/Accents/14.png" alt="">
                                            <img data-src="./img/decarlo/Accents/18.png" alt="">
                                            <img data-src="./img/decarlo/Accents/20.png" alt="">
                                            <img data-src="./img/decarlo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Face Letter/2.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/4.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/5.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/6.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/7.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/8.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/9.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/10.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/11.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/12.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/13.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/14.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/18.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/20.png" alt="">
                                            <img data-src="./img/decarlo/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Face/2.png" alt="">
                                            <img data-src="./img/decarlo/Face/4.png" alt="">
                                            <img data-src="./img/decarlo/Face/5.png" alt="">
                                            <img data-src="./img/decarlo/Face/6.png" alt="">
                                            <img data-src="./img/decarlo/Face/7.png" alt="">
                                            <img data-src="./img/decarlo/Face/8.png" alt="">
                                            <img data-src="./img/decarlo/Face/9.png" alt="">
                                            <img data-src="./img/decarlo/Face/10.png" alt="">
                                            <img data-src="./img/decarlo/Face/11.png" alt="">
                                            <img data-src="./img/decarlo/Face/12.png" alt="">
                                            <img data-src="./img/decarlo/Face/13.png" alt="">
                                            <img data-src="./img/decarlo/Face/14.png" alt="">
                                            <img data-src="./img/decarlo/Face/18.png" alt="">
                                            <img data-src="./img/decarlo/Face/20.png" alt="">
                                            <img data-src="./img/decarlo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/decarlo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Cap/2.png" alt="">
                                            <img data-src="./img/decarlo/Cap/4.png" alt="">
                                            <img data-src="./img/decarlo/Cap/5.png" alt="">
                                            <img data-src="./img/decarlo/Cap/6.png" alt="">
                                            <img data-src="./img/decarlo/Cap/7.png" alt="">
                                            <img data-src="./img/decarlo/Cap/8.png" alt="">
                                            <img data-src="./img/decarlo/Cap/9.png" alt="">
                                            <img data-src="./img/decarlo/Cap/10.png" alt="">
                                            <img data-src="./img/decarlo/Cap/11.png" alt="">
                                            <img data-src="./img/decarlo/Cap/12.png" alt="">
                                            <img data-src="./img/decarlo/Cap/13.png" alt="">
                                            <img data-src="./img/decarlo/Cap/14.png" alt="">
                                            <img data-src="./img/decarlo/Cap/18.png" alt="">
                                            <img data-src="./img/decarlo/Cap/20.png" alt="">
                                            <img data-src="./img/decarlo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/decarlo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Bolts/2.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/4.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/5.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/6.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/7.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/8.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/9.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/10.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/11.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/12.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/13.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/14.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/18.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/20.png" alt="">
                                            <img data-src="./img/decarlo/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/decarlo/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/decarlo/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/decarlo/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/decarlo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./decarlo-sf-6259.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
