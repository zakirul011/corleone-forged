...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'FARINA | SF-9946', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap
    ...
    <div class="config-wrapper farina-sf-9946 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>FARINA <span>its easy to build</span></h3>
                                <h1>SF-9946</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/farina/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/farina/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/farina/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/farina/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/farina/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/farina/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/farina/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/farina/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Accents/2.png" alt="">
                                            <img data-src="./img/farina/Accents/4.png" alt="">
                                            <img data-src="./img/farina/Accents/5.png" alt="">
                                            <img data-src="./img/farina/Accents/6.png" alt="">
                                            <img data-src="./img/farina/Accents/7.png" alt="">
                                            <img data-src="./img/farina/Accents/8.png" alt="">
                                            <img data-src="./img/farina/Accents/9.png" alt="">
                                            <img data-src="./img/farina/Accents/10.png" alt="">
                                            <img data-src="./img/farina/Accents/11.png" alt="">
                                            <img data-src="./img/farina/Accents/12.png" alt="">
                                            <img data-src="./img/farina/Accents/13.png" alt="">
                                            <img data-src="./img/farina/Accents/14.png" alt="">
                                            <img data-src="./img/farina/Accents/18.png" alt="">
                                            <img data-src="./img/farina/Accents/20.png" alt="">
                                            <img data-src="./img/farina/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Face Letter/2.png" alt="">
                                            <img data-src="./img/farina/Face Letter/4.png" alt="">
                                            <img data-src="./img/farina/Face Letter/5.png" alt="">
                                            <img data-src="./img/farina/Face Letter/6.png" alt="">
                                            <img data-src="./img/farina/Face Letter/7.png" alt="">
                                            <img data-src="./img/farina/Face Letter/8.png" alt="">
                                            <img data-src="./img/farina/Face Letter/9.png" alt="">
                                            <img data-src="./img/farina/Face Letter/10.png" alt="">
                                            <img data-src="./img/farina/Face Letter/11.png" alt="">
                                            <img data-src="./img/farina/Face Letter/12.png" alt="">
                                            <img data-src="./img/farina/Face Letter/13.png" alt="">
                                            <img data-src="./img/farina/Face Letter/14.png" alt="">
                                            <img data-src="./img/farina/Face Letter/18.png" alt="">
                                            <img data-src="./img/farina/Face Letter/20.png" alt="">
                                            <img data-src="./img/farina/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Face/2.png" alt="">
                                            <img data-src="./img/farina/Face/4.png" alt="">
                                            <img data-src="./img/farina/Face/5.png" alt="">
                                            <img data-src="./img/farina/Face/6.png" alt="">
                                            <img data-src="./img/farina/Face/7.png" alt="">
                                            <img data-src="./img/farina/Face/8.png" alt="">
                                            <img data-src="./img/farina/Face/9.png" alt="">
                                            <img data-src="./img/farina/Face/10.png" alt="">
                                            <img data-src="./img/farina/Face/11.png" alt="">
                                            <img data-src="./img/farina/Face/12.png" alt="">
                                            <img data-src="./img/farina/Face/13.png" alt="">
                                            <img data-src="./img/farina/Face/14.png" alt="">
                                            <img data-src="./img/farina/Face/18.png" alt="">
                                            <img data-src="./img/farina/Face/20.png" alt="">
                                            <img data-src="./img/farina/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Cap Letter/2.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/4.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/5.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/6.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/7.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/8.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/9.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/10.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/11.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/12.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/13.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/14.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/18.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/20.png" alt="">
                                            <img data-src="./img/farina/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Cap/2.png" alt="">
                                            <img data-src="./img/farina/Cap/4.png" alt="">
                                            <img data-src="./img/farina/Cap/5.png" alt="">
                                            <img data-src="./img/farina/Cap/6.png" alt="">
                                            <img data-src="./img/farina/Cap/7.png" alt="">
                                            <img data-src="./img/farina/Cap/8.png" alt="">
                                            <img data-src="./img/farina/Cap/9.png" alt="">
                                            <img data-src="./img/farina/Cap/10.png" alt="">
                                            <img data-src="./img/farina/Cap/11.png" alt="">
                                            <img data-src="./img/farina/Cap/12.png" alt="">
                                            <img data-src="./img/farina/Cap/13.png" alt="">
                                            <img data-src="./img/farina/Cap/14.png" alt="">
                                            <img data-src="./img/farina/Cap/18.png" alt="">
                                            <img data-src="./img/farina/Cap/20.png" alt="">
                                            <img data-src="./img/farina/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/farina/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/farina/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/farina/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/farina/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/farina/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./farina-sf-9946.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
