...
<body>
    ...
    <div class="config-wrapper falcone-sf-2372 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>FALCONE <span>its easy to build</span></h3>
                                <h1>SF-2372</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/falcone/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/falcone/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/falcone/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/falcone/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/falcone/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/falcone/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/falcone/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/falcone/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/falcone/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Accents/2.png" alt="">
                                            <img data-src="./img/falcone/Accents/4.png" alt="">
                                            <img data-src="./img/falcone/Accents/5.png" alt="">
                                            <img data-src="./img/falcone/Accents/6.png" alt="">
                                            <img data-src="./img/falcone/Accents/7.png" alt="">
                                            <img data-src="./img/falcone/Accents/8.png" alt="">
                                            <img data-src="./img/falcone/Accents/9.png" alt="">
                                            <img data-src="./img/falcone/Accents/10.png" alt="">
                                            <img data-src="./img/falcone/Accents/11.png" alt="">
                                            <img data-src="./img/falcone/Accents/12.png" alt="">
                                            <img data-src="./img/falcone/Accents/13.png" alt="">
                                            <img data-src="./img/falcone/Accents/14.png" alt="">
                                            <img data-src="./img/falcone/Accents/18.png" alt="">
                                            <img data-src="./img/falcone/Accents/20.png" alt="">
                                            <img data-src="./img/falcone/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Face Letter/2.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/4.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/5.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/6.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/7.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/8.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/9.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/10.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/11.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/12.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/13.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/14.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/18.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/20.png" alt="">
                                            <img data-src="./img/falcone/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Face/2.png" alt="">
                                            <img data-src="./img/falcone/Face/4.png" alt="">
                                            <img data-src="./img/falcone/Face/5.png" alt="">
                                            <img data-src="./img/falcone/Face/6.png" alt="">
                                            <img data-src="./img/falcone/Face/7.png" alt="">
                                            <img data-src="./img/falcone/Face/8.png" alt="">
                                            <img data-src="./img/falcone/Face/9.png" alt="">
                                            <img data-src="./img/falcone/Face/10.png" alt="">
                                            <img data-src="./img/falcone/Face/11.png" alt="">
                                            <img data-src="./img/falcone/Face/12.png" alt="">
                                            <img data-src="./img/falcone/Face/13.png" alt="">
                                            <img data-src="./img/falcone/Face/14.png" alt="">
                                            <img data-src="./img/falcone/Face/18.png" alt="">
                                            <img data-src="./img/falcone/Face/20.png" alt="">
                                            <img data-src="./img/falcone/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Cap Letter/2.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/4.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/5.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/6.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/7.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/8.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/9.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/10.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/11.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/12.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/13.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/14.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/18.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/20.png" alt="">
                                            <img data-src="./img/falcone/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Cap/2.png" alt="">
                                            <img data-src="./img/falcone/Cap/4.png" alt="">
                                            <img data-src="./img/falcone/Cap/5.png" alt="">
                                            <img data-src="./img/falcone/Cap/6.png" alt="">
                                            <img data-src="./img/falcone/Cap/7.png" alt="">
                                            <img data-src="./img/falcone/Cap/8.png" alt="">
                                            <img data-src="./img/falcone/Cap/9.png" alt="">
                                            <img data-src="./img/falcone/Cap/10.png" alt="">
                                            <img data-src="./img/falcone/Cap/11.png" alt="">
                                            <img data-src="./img/falcone/Cap/12.png" alt="">
                                            <img data-src="./img/falcone/Cap/13.png" alt="">
                                            <img data-src="./img/falcone/Cap/14.png" alt="">
                                            <img data-src="./img/falcone/Cap/18.png" alt="">
                                            <img data-src="./img/falcone/Cap/20.png" alt="">
                                            <img data-src="./img/falcone/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/falcone/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Bolts/2.png" alt="">
                                            <img data-src="./img/falcone/Bolts/4.png" alt="">
                                            <img data-src="./img/falcone/Bolts/5.png" alt="">
                                            <img data-src="./img/falcone/Bolts/6.png" alt="">
                                            <img data-src="./img/falcone/Bolts/7.png" alt="">
                                            <img data-src="./img/falcone/Bolts/8.png" alt="">
                                            <img data-src="./img/falcone/Bolts/9.png" alt="">
                                            <img data-src="./img/falcone/Bolts/10.png" alt="">
                                            <img data-src="./img/falcone/Bolts/11.png" alt="">
                                            <img data-src="./img/falcone/Bolts/12.png" alt="">
                                            <img data-src="./img/falcone/Bolts/13.png" alt="">
                                            <img data-src="./img/falcone/Bolts/14.png" alt="">
                                            <img data-src="./img/falcone/Bolts/18.png" alt="">
                                            <img data-src="./img/falcone/Bolts/20.png" alt="">
                                            <img data-src="./img/falcone/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/falcone/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/falcone/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/falcone/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/falcone/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./falcone-sf-2372.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
