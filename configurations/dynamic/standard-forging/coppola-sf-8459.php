...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'COPPOLA | SF-8459', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap, 'outerbarrel' => $outerbarrel, 'innerbarrrel' => $innerbarrrel,'image_path' => $image_path    ));
    ...
    <div class="config-wrapper coppola-sf-8459 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>COPPOLA <span>its easy to build</span></h3>
                                <h1>SF-8459</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/coppola/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/coppola/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/coppola/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/coppola/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/coppola/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/coppola/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/coppola/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/coppola/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Accents/2.png" alt="">
                                            <img data-src="./img/coppola/Accents/4.png" alt="">
                                            <img data-src="./img/coppola/Accents/5.png" alt="">
                                            <img data-src="./img/coppola/Accents/6.png" alt="">
                                            <img data-src="./img/coppola/Accents/7.png" alt="">
                                            <img data-src="./img/coppola/Accents/8.png" alt="">
                                            <img data-src="./img/coppola/Accents/9.png" alt="">
                                            <img data-src="./img/coppola/Accents/10.png" alt="">
                                            <img data-src="./img/coppola/Accents/11.png" alt="">
                                            <img data-src="./img/coppola/Accents/12.png" alt="">
                                            <img data-src="./img/coppola/Accents/13.png" alt="">
                                            <img data-src="./img/coppola/Accents/14.png" alt="">
                                            <img data-src="./img/coppola/Accents/18.png" alt="">
                                            <img data-src="./img/coppola/Accents/20.png" alt="">
                                            <img data-src="./img/coppola/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Face Letter/2.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/4.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/5.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/6.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/7.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/8.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/9.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/10.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/11.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/12.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/13.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/14.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/18.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/20.png" alt="">
                                            <img data-src="./img/coppola/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Face/2.png" alt="">
                                            <img data-src="./img/coppola/Face/4.png" alt="">
                                            <img data-src="./img/coppola/Face/5.png" alt="">
                                            <img data-src="./img/coppola/Face/6.png" alt="">
                                            <img data-src="./img/coppola/Face/7.png" alt="">
                                            <img data-src="./img/coppola/Face/8.png" alt="">
                                            <img data-src="./img/coppola/Face/9.png" alt="">
                                            <img data-src="./img/coppola/Face/10.png" alt="">
                                            <img data-src="./img/coppola/Face/11.png" alt="">
                                            <img data-src="./img/coppola/Face/12.png" alt="">
                                            <img data-src="./img/coppola/Face/13.png" alt="">
                                            <img data-src="./img/coppola/Face/14.png" alt="">
                                            <img data-src="./img/coppola/Face/18.png" alt="">
                                            <img data-src="./img/coppola/Face/20.png" alt="">
                                            <img data-src="./img/coppola/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Cap Letter/2.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/4.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/5.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/6.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/7.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/8.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/9.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/10.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/11.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/12.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/13.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/14.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/18.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/20.png" alt="">
                                            <img data-src="./img/coppola/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Cap/2.png" alt="">
                                            <img data-src="./img/coppola/Cap/4.png" alt="">
                                            <img data-src="./img/coppola/Cap/5.png" alt="">
                                            <img data-src="./img/coppola/Cap/6.png" alt="">
                                            <img data-src="./img/coppola/Cap/7.png" alt="">
                                            <img data-src="./img/coppola/Cap/8.png" alt="">
                                            <img data-src="./img/coppola/Cap/9.png" alt="">
                                            <img data-src="./img/coppola/Cap/10.png" alt="">
                                            <img data-src="./img/coppola/Cap/11.png" alt="">
                                            <img data-src="./img/coppola/Cap/12.png" alt="">
                                            <img data-src="./img/coppola/Cap/13.png" alt="">
                                            <img data-src="./img/coppola/Cap/14.png" alt="">
                                            <img data-src="./img/coppola/Cap/18.png" alt="">
                                            <img data-src="./img/coppola/Cap/20.png" alt="">
                                            <img data-src="./img/coppola/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/coppola/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/coppola/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/coppola/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/coppola/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/coppola/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./coppola-sf-8459.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
