...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'CASSO | SF-5289', 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper casso-sf-5289 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>CASSO <span>its easy to build</span></h3>
                                <h1>SF-5289</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/casso/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <img src="./img/casso/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/casso/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/casso/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/casso/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/casso/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/casso/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Accents/2.png" alt="">
                                            <img data-src="./img/casso/Accents/4.png" alt="">
                                            <img data-src="./img/casso/Accents/5.png" alt="">
                                            <img data-src="./img/casso/Accents/6.png" alt="">
                                            <img data-src="./img/casso/Accents/7.png" alt="">
                                            <img data-src="./img/casso/Accents/8.png" alt="">
                                            <img data-src="./img/casso/Accents/9.png" alt="">
                                            <img data-src="./img/casso/Accents/10.png" alt="">
                                            <img data-src="./img/casso/Accents/11.png" alt="">
                                            <img data-src="./img/casso/Accents/12.png" alt="">
                                            <img data-src="./img/casso/Accents/13.png" alt="">
                                            <img data-src="./img/casso/Accents/14.png" alt="">
                                            <img data-src="./img/casso/Accents/18.png" alt="">
                                            <img data-src="./img/casso/Accents/20.png" alt="">
                                            <img data-src="./img/casso/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Face/2.png" alt="">
                                            <img data-src="./img/casso/Face/4.png" alt="">
                                            <img data-src="./img/casso/Face/5.png" alt="">
                                            <img data-src="./img/casso/Face/6.png" alt="">
                                            <img data-src="./img/casso/Face/7.png" alt="">
                                            <img data-src="./img/casso/Face/8.png" alt="">
                                            <img data-src="./img/casso/Face/9.png" alt="">
                                            <img data-src="./img/casso/Face/10.png" alt="">
                                            <img data-src="./img/casso/Face/11.png" alt="">
                                            <img data-src="./img/casso/Face/12.png" alt="">
                                            <img data-src="./img/casso/Face/13.png" alt="">
                                            <img data-src="./img/casso/Face/14.png" alt="">
                                            <img data-src="./img/casso/Face/18.png" alt="">
                                            <img data-src="./img/casso/Face/20.png" alt="">
                                            <img data-src="./img/casso/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Cap Letter/2.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/4.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/5.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/6.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/7.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/8.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/9.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/10.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/11.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/12.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/13.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/14.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/18.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/20.png" alt="">
                                            <img data-src="./img/casso/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Cap/2.png" alt="">
                                            <img data-src="./img/casso/Cap/4.png" alt="">
                                            <img data-src="./img/casso/Cap/5.png" alt="">
                                            <img data-src="./img/casso/Cap/6.png" alt="">
                                            <img data-src="./img/casso/Cap/7.png" alt="">
                                            <img data-src="./img/casso/Cap/8.png" alt="">
                                            <img data-src="./img/casso/Cap/9.png" alt="">
                                            <img data-src="./img/casso/Cap/10.png" alt="">
                                            <img data-src="./img/casso/Cap/11.png" alt="">
                                            <img data-src="./img/casso/Cap/12.png" alt="">
                                            <img data-src="./img/casso/Cap/13.png" alt="">
                                            <img data-src="./img/casso/Cap/14.png" alt="">
                                            <img data-src="./img/casso/Cap/18.png" alt="">
                                            <img data-src="./img/casso/Cap/20.png" alt="">
                                            <img data-src="./img/casso/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/casso/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Bolts/2.png" alt="">
                                            <img data-src="./img/casso/Bolts/4.png" alt="">
                                            <img data-src="./img/casso/Bolts/5.png" alt="">
                                            <img data-src="./img/casso/Bolts/6.png" alt="">
                                            <img data-src="./img/casso/Bolts/7.png" alt="">
                                            <img data-src="./img/casso/Bolts/8.png" alt="">
                                            <img data-src="./img/casso/Bolts/9.png" alt="">
                                            <img data-src="./img/casso/Bolts/10.png" alt="">
                                            <img data-src="./img/casso/Bolts/11.png" alt="">
                                            <img data-src="./img/casso/Bolts/12.png" alt="">
                                            <img data-src="./img/casso/Bolts/13.png" alt="">
                                            <img data-src="./img/casso/Bolts/14.png" alt="">
                                            <img data-src="./img/casso/Bolts/18.png" alt="">
                                            <img data-src="./img/casso/Bolts/20.png" alt="">
                                            <img data-src="./img/casso/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/casso/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/casso/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/casso/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/casso/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./casso-sf-5289.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
