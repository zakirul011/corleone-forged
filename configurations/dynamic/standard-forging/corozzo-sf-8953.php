...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'COROZZO | SF-8953', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper corozzo-sf-8953 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>COROZZO <span>its easy to build</span></h3>
                                <h1>SF-8953</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/corozzo/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/corozzo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Accents/2.png" alt="">
                                            <img data-src="./img/corozzo/Accents/4.png" alt="">
                                            <img data-src="./img/corozzo/Accents/5.png" alt="">
                                            <img data-src="./img/corozzo/Accents/6.png" alt="">
                                            <img data-src="./img/corozzo/Accents/7.png" alt="">
                                            <img data-src="./img/corozzo/Accents/8.png" alt="">
                                            <img data-src="./img/corozzo/Accents/9.png" alt="">
                                            <img data-src="./img/corozzo/Accents/10.png" alt="">
                                            <img data-src="./img/corozzo/Accents/11.png" alt="">
                                            <img data-src="./img/corozzo/Accents/12.png" alt="">
                                            <img data-src="./img/corozzo/Accents/13.png" alt="">
                                            <img data-src="./img/corozzo/Accents/14.png" alt="">
                                            <img data-src="./img/corozzo/Accents/18.png" alt="">
                                            <img data-src="./img/corozzo/Accents/20.png" alt="">
                                            <img data-src="./img/corozzo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Face Letter/2.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/4.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/5.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/6.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/7.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/8.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/9.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/10.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/11.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/12.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/13.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/14.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/18.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/20.png" alt="">
                                            <img data-src="./img/corozzo/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Face/2.png" alt="">
                                            <img data-src="./img/corozzo/Face/4.png" alt="">
                                            <img data-src="./img/corozzo/Face/5.png" alt="">
                                            <img data-src="./img/corozzo/Face/6.png" alt="">
                                            <img data-src="./img/corozzo/Face/7.png" alt="">
                                            <img data-src="./img/corozzo/Face/8.png" alt="">
                                            <img data-src="./img/corozzo/Face/9.png" alt="">
                                            <img data-src="./img/corozzo/Face/10.png" alt="">
                                            <img data-src="./img/corozzo/Face/11.png" alt="">
                                            <img data-src="./img/corozzo/Face/12.png" alt="">
                                            <img data-src="./img/corozzo/Face/13.png" alt="">
                                            <img data-src="./img/corozzo/Face/14.png" alt="">
                                            <img data-src="./img/corozzo/Face/18.png" alt="">
                                            <img data-src="./img/corozzo/Face/20.png" alt="">
                                            <img data-src="./img/corozzo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/corozzo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Cap/2.png" alt="">
                                            <img data-src="./img/corozzo/Cap/4.png" alt="">
                                            <img data-src="./img/corozzo/Cap/5.png" alt="">
                                            <img data-src="./img/corozzo/Cap/6.png" alt="">
                                            <img data-src="./img/corozzo/Cap/7.png" alt="">
                                            <img data-src="./img/corozzo/Cap/8.png" alt="">
                                            <img data-src="./img/corozzo/Cap/9.png" alt="">
                                            <img data-src="./img/corozzo/Cap/10.png" alt="">
                                            <img data-src="./img/corozzo/Cap/11.png" alt="">
                                            <img data-src="./img/corozzo/Cap/12.png" alt="">
                                            <img data-src="./img/corozzo/Cap/13.png" alt="">
                                            <img data-src="./img/corozzo/Cap/14.png" alt="">
                                            <img data-src="./img/corozzo/Cap/18.png" alt="">
                                            <img data-src="./img/corozzo/Cap/20.png" alt="">
                                            <img data-src="./img/corozzo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/corozzo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Bolts/2.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/4.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/5.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/6.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/7.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/8.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/9.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/10.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/11.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/12.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/13.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/14.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/18.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/20.png" alt="">
                                            <img data-src="./img/corozzo/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/corozzo/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/corozzo/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/corozzo/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/corozzo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./corozzo-sf-8953.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
