...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'MAGARI | SF-7258', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap, 'outerbarrel' => $outerbarrel, 'innerbarrrel' => $innerbarrrel,'image_path' => $image_path    ));
    ...
    <div class="config-wrapper magari-sf-7258 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>MAGARI <span>its easy to build</span></h3>
                                <h1>SF-7258</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/magari/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/magari/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/magari/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/magari/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/magari/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/magari/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/magari/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/magari/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Accents/2.png" alt="">
                                            <img data-src="./img/magari/Accents/4.png" alt="">
                                            <img data-src="./img/magari/Accents/5.png" alt="">
                                            <img data-src="./img/magari/Accents/6.png" alt="">
                                            <img data-src="./img/magari/Accents/7.png" alt="">
                                            <img data-src="./img/magari/Accents/8.png" alt="">
                                            <img data-src="./img/magari/Accents/9.png" alt="">
                                            <img data-src="./img/magari/Accents/10.png" alt="">
                                            <img data-src="./img/magari/Accents/11.png" alt="">
                                            <img data-src="./img/magari/Accents/12.png" alt="">
                                            <img data-src="./img/magari/Accents/13.png" alt="">
                                            <img data-src="./img/magari/Accents/14.png" alt="">
                                            <img data-src="./img/magari/Accents/18.png" alt="">
                                            <img data-src="./img/magari/Accents/20.png" alt="">
                                            <img data-src="./img/magari/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Face Letter/2.png" alt="">
                                            <img data-src="./img/magari/Face Letter/4.png" alt="">
                                            <img data-src="./img/magari/Face Letter/5.png" alt="">
                                            <img data-src="./img/magari/Face Letter/6.png" alt="">
                                            <img data-src="./img/magari/Face Letter/7.png" alt="">
                                            <img data-src="./img/magari/Face Letter/8.png" alt="">
                                            <img data-src="./img/magari/Face Letter/9.png" alt="">
                                            <img data-src="./img/magari/Face Letter/10.png" alt="">
                                            <img data-src="./img/magari/Face Letter/11.png" alt="">
                                            <img data-src="./img/magari/Face Letter/12.png" alt="">
                                            <img data-src="./img/magari/Face Letter/13.png" alt="">
                                            <img data-src="./img/magari/Face Letter/14.png" alt="">
                                            <img data-src="./img/magari/Face Letter/18.png" alt="">
                                            <img data-src="./img/magari/Face Letter/20.png" alt="">
                                            <img data-src="./img/magari/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Face/2.png" alt="">
                                            <img data-src="./img/magari/Face/4.png" alt="">
                                            <img data-src="./img/magari/Face/5.png" alt="">
                                            <img data-src="./img/magari/Face/6.png" alt="">
                                            <img data-src="./img/magari/Face/7.png" alt="">
                                            <img data-src="./img/magari/Face/8.png" alt="">
                                            <img data-src="./img/magari/Face/9.png" alt="">
                                            <img data-src="./img/magari/Face/10.png" alt="">
                                            <img data-src="./img/magari/Face/11.png" alt="">
                                            <img data-src="./img/magari/Face/12.png" alt="">
                                            <img data-src="./img/magari/Face/13.png" alt="">
                                            <img data-src="./img/magari/Face/14.png" alt="">
                                            <img data-src="./img/magari/Face/18.png" alt="">
                                            <img data-src="./img/magari/Face/20.png" alt="">
                                            <img data-src="./img/magari/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Cap Letter/2.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/4.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/5.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/6.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/7.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/8.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/9.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/10.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/11.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/12.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/13.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/14.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/18.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/20.png" alt="">
                                            <img data-src="./img/magari/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Cap/2.png" alt="">
                                            <img data-src="./img/magari/Cap/4.png" alt="">
                                            <img data-src="./img/magari/Cap/5.png" alt="">
                                            <img data-src="./img/magari/Cap/6.png" alt="">
                                            <img data-src="./img/magari/Cap/7.png" alt="">
                                            <img data-src="./img/magari/Cap/8.png" alt="">
                                            <img data-src="./img/magari/Cap/9.png" alt="">
                                            <img data-src="./img/magari/Cap/10.png" alt="">
                                            <img data-src="./img/magari/Cap/11.png" alt="">
                                            <img data-src="./img/magari/Cap/12.png" alt="">
                                            <img data-src="./img/magari/Cap/13.png" alt="">
                                            <img data-src="./img/magari/Cap/14.png" alt="">
                                            <img data-src="./img/magari/Cap/18.png" alt="">
                                            <img data-src="./img/magari/Cap/20.png" alt="">
                                            <img data-src="./img/magari/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/magari/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/magari/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/magari/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/magari/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/magari/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./magari-sf-7258.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
