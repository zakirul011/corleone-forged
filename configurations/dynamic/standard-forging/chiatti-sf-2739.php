...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'CHIATTI | SF-2739', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper chiatti-sf-2739 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>CHIATTI <span>its easy to build</span></h3>
                                <h1>SF-2739</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/chiatti/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/chiatti/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Accents/2.png" alt="">
                                            <img data-src="./img/chiatti/Accents/4.png" alt="">
                                            <img data-src="./img/chiatti/Accents/5.png" alt="">
                                            <img data-src="./img/chiatti/Accents/6.png" alt="">
                                            <img data-src="./img/chiatti/Accents/7.png" alt="">
                                            <img data-src="./img/chiatti/Accents/8.png" alt="">
                                            <img data-src="./img/chiatti/Accents/9.png" alt="">
                                            <img data-src="./img/chiatti/Accents/10.png" alt="">
                                            <img data-src="./img/chiatti/Accents/11.png" alt="">
                                            <img data-src="./img/chiatti/Accents/12.png" alt="">
                                            <img data-src="./img/chiatti/Accents/13.png" alt="">
                                            <img data-src="./img/chiatti/Accents/14.png" alt="">
                                            <img data-src="./img/chiatti/Accents/18.png" alt="">
                                            <img data-src="./img/chiatti/Accents/20.png" alt="">
                                            <img data-src="./img/chiatti/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Face Letter/2.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/4.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/5.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/6.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/7.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/8.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/9.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/10.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/11.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/12.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/13.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/14.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/18.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/20.png" alt="">
                                            <img data-src="./img/chiatti/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Face/2.png" alt="">
                                            <img data-src="./img/chiatti/Face/4.png" alt="">
                                            <img data-src="./img/chiatti/Face/5.png" alt="">
                                            <img data-src="./img/chiatti/Face/6.png" alt="">
                                            <img data-src="./img/chiatti/Face/7.png" alt="">
                                            <img data-src="./img/chiatti/Face/8.png" alt="">
                                            <img data-src="./img/chiatti/Face/9.png" alt="">
                                            <img data-src="./img/chiatti/Face/10.png" alt="">
                                            <img data-src="./img/chiatti/Face/11.png" alt="">
                                            <img data-src="./img/chiatti/Face/12.png" alt="">
                                            <img data-src="./img/chiatti/Face/13.png" alt="">
                                            <img data-src="./img/chiatti/Face/14.png" alt="">
                                            <img data-src="./img/chiatti/Face/18.png" alt="">
                                            <img data-src="./img/chiatti/Face/20.png" alt="">
                                            <img data-src="./img/chiatti/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Cap Letter/2.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/4.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/5.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/6.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/7.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/8.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/9.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/10.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/11.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/12.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/13.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/14.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/18.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/20.png" alt="">
                                            <img data-src="./img/chiatti/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Cap/2.png" alt="">
                                            <img data-src="./img/chiatti/Cap/4.png" alt="">
                                            <img data-src="./img/chiatti/Cap/5.png" alt="">
                                            <img data-src="./img/chiatti/Cap/6.png" alt="">
                                            <img data-src="./img/chiatti/Cap/7.png" alt="">
                                            <img data-src="./img/chiatti/Cap/8.png" alt="">
                                            <img data-src="./img/chiatti/Cap/9.png" alt="">
                                            <img data-src="./img/chiatti/Cap/10.png" alt="">
                                            <img data-src="./img/chiatti/Cap/11.png" alt="">
                                            <img data-src="./img/chiatti/Cap/12.png" alt="">
                                            <img data-src="./img/chiatti/Cap/13.png" alt="">
                                            <img data-src="./img/chiatti/Cap/14.png" alt="">
                                            <img data-src="./img/chiatti/Cap/18.png" alt="">
                                            <img data-src="./img/chiatti/Cap/20.png" alt="">
                                            <img data-src="./img/chiatti/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/chiatti/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Bolts/2.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/4.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/5.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/6.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/7.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/8.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/9.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/10.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/11.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/12.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/13.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/14.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/18.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/20.png" alt="">
                                            <img data-src="./img/chiatti/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/chiatti/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/chiatti/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/chiatti/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/chiatti/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./chiatti-sf-2739.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
