...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'VASTOLA | SF-2646', 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper vastola-sf-2646 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>VASTOLA <span>its easy to build</span></h3>
                                <h1>SF-2646</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/vastola/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vastola/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vastola/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vastola/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vastola/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vastola/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/vastola/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/vastola/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Accents/2.png" alt="">
                                            <img data-src="./img/vastola/Accents/4.png" alt="">
                                            <img data-src="./img/vastola/Accents/5.png" alt="">
                                            <img data-src="./img/vastola/Accents/6.png" alt="">
                                            <img data-src="./img/vastola/Accents/7.png" alt="">
                                            <img data-src="./img/vastola/Accents/8.png" alt="">
                                            <img data-src="./img/vastola/Accents/9.png" alt="">
                                            <img data-src="./img/vastola/Accents/10.png" alt="">
                                            <img data-src="./img/vastola/Accents/11.png" alt="">
                                            <img data-src="./img/vastola/Accents/12.png" alt="">
                                            <img data-src="./img/vastola/Accents/13.png" alt="">
                                            <img data-src="./img/vastola/Accents/14.png" alt="">
                                            <img data-src="./img/vastola/Accents/18.png" alt="">
                                            <img data-src="./img/vastola/Accents/20.png" alt="">
                                            <img data-src="./img/vastola/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Face/2.png" alt="">
                                            <img data-src="./img/vastola/Face/4.png" alt="">
                                            <img data-src="./img/vastola/Face/5.png" alt="">
                                            <img data-src="./img/vastola/Face/6.png" alt="">
                                            <img data-src="./img/vastola/Face/7.png" alt="">
                                            <img data-src="./img/vastola/Face/8.png" alt="">
                                            <img data-src="./img/vastola/Face/9.png" alt="">
                                            <img data-src="./img/vastola/Face/10.png" alt="">
                                            <img data-src="./img/vastola/Face/11.png" alt="">
                                            <img data-src="./img/vastola/Face/12.png" alt="">
                                            <img data-src="./img/vastola/Face/13.png" alt="">
                                            <img data-src="./img/vastola/Face/14.png" alt="">
                                            <img data-src="./img/vastola/Face/18.png" alt="">
                                            <img data-src="./img/vastola/Face/20.png" alt="">
                                            <img data-src="./img/vastola/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Cap Letter/2.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/4.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/5.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/6.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/7.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/8.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/9.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/10.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/11.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/12.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/13.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/14.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/18.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/20.png" alt="">
                                            <img data-src="./img/vastola/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Cap/2.png" alt="">
                                            <img data-src="./img/vastola/Cap/4.png" alt="">
                                            <img data-src="./img/vastola/Cap/5.png" alt="">
                                            <img data-src="./img/vastola/Cap/6.png" alt="">
                                            <img data-src="./img/vastola/Cap/7.png" alt="">
                                            <img data-src="./img/vastola/Cap/8.png" alt="">
                                            <img data-src="./img/vastola/Cap/9.png" alt="">
                                            <img data-src="./img/vastola/Cap/10.png" alt="">
                                            <img data-src="./img/vastola/Cap/11.png" alt="">
                                            <img data-src="./img/vastola/Cap/12.png" alt="">
                                            <img data-src="./img/vastola/Cap/13.png" alt="">
                                            <img data-src="./img/vastola/Cap/14.png" alt="">
                                            <img data-src="./img/vastola/Cap/18.png" alt="">
                                            <img data-src="./img/vastola/Cap/20.png" alt="">
                                            <img data-src="./img/vastola/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/vastola/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Bolts/2.png" alt="">
                                            <img data-src="./img/vastola/Bolts/4.png" alt="">
                                            <img data-src="./img/vastola/Bolts/5.png" alt="">
                                            <img data-src="./img/vastola/Bolts/6.png" alt="">
                                            <img data-src="./img/vastola/Bolts/7.png" alt="">
                                            <img data-src="./img/vastola/Bolts/8.png" alt="">
                                            <img data-src="./img/vastola/Bolts/9.png" alt="">
                                            <img data-src="./img/vastola/Bolts/10.png" alt="">
                                            <img data-src="./img/vastola/Bolts/11.png" alt="">
                                            <img data-src="./img/vastola/Bolts/12.png" alt="">
                                            <img data-src="./img/vastola/Bolts/13.png" alt="">
                                            <img data-src="./img/vastola/Bolts/14.png" alt="">
                                            <img data-src="./img/vastola/Bolts/18.png" alt="">
                                            <img data-src="./img/vastola/Bolts/20.png" alt="">
                                            <img data-src="./img/vastola/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/vastola/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/vastola/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/vastola/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/vastola/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./vastola-sf-2646.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
