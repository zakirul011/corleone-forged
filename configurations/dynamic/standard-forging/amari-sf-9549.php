...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'AMARI | SF-9549', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper amari-sf-9549 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>AMARI <span>its easy to build</span></h3>
                                <h1>SF-9549</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/amari/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/amari/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/amari/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/amari/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/amari/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/amari/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/amari/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/amari/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/amari/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Accents/2.png" alt="">
                                            <img data-src="./img/amari/Accents/4.png" alt="">
                                            <img data-src="./img/amari/Accents/5.png" alt="">
                                            <img data-src="./img/amari/Accents/6.png" alt="">
                                            <img data-src="./img/amari/Accents/7.png" alt="">
                                            <img data-src="./img/amari/Accents/8.png" alt="">
                                            <img data-src="./img/amari/Accents/9.png" alt="">
                                            <img data-src="./img/amari/Accents/10.png" alt="">
                                            <img data-src="./img/amari/Accents/11.png" alt="">
                                            <img data-src="./img/amari/Accents/12.png" alt="">
                                            <img data-src="./img/amari/Accents/13.png" alt="">
                                            <img data-src="./img/amari/Accents/14.png" alt="">
                                            <img data-src="./img/amari/Accents/18.png" alt="">
                                            <img data-src="./img/amari/Accents/20.png" alt="">
                                            <img data-src="./img/amari/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Face Letter/2.png" alt="">
                                            <img data-src="./img/amari/Face Letter/4.png" alt="">
                                            <img data-src="./img/amari/Face Letter/5.png" alt="">
                                            <img data-src="./img/amari/Face Letter/6.png" alt="">
                                            <img data-src="./img/amari/Face Letter/7.png" alt="">
                                            <img data-src="./img/amari/Face Letter/8.png" alt="">
                                            <img data-src="./img/amari/Face Letter/9.png" alt="">
                                            <img data-src="./img/amari/Face Letter/10.png" alt="">
                                            <img data-src="./img/amari/Face Letter/11.png" alt="">
                                            <img data-src="./img/amari/Face Letter/12.png" alt="">
                                            <img data-src="./img/amari/Face Letter/13.png" alt="">
                                            <img data-src="./img/amari/Face Letter/14.png" alt="">
                                            <img data-src="./img/amari/Face Letter/18.png" alt="">
                                            <img data-src="./img/amari/Face Letter/20.png" alt="">
                                            <img data-src="./img/amari/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Face/2.png" alt="">
                                            <img data-src="./img/amari/Face/4.png" alt="">
                                            <img data-src="./img/amari/Face/5.png" alt="">
                                            <img data-src="./img/amari/Face/6.png" alt="">
                                            <img data-src="./img/amari/Face/7.png" alt="">
                                            <img data-src="./img/amari/Face/8.png" alt="">
                                            <img data-src="./img/amari/Face/9.png" alt="">
                                            <img data-src="./img/amari/Face/10.png" alt="">
                                            <img data-src="./img/amari/Face/11.png" alt="">
                                            <img data-src="./img/amari/Face/12.png" alt="">
                                            <img data-src="./img/amari/Face/13.png" alt="">
                                            <img data-src="./img/amari/Face/14.png" alt="">
                                            <img data-src="./img/amari/Face/18.png" alt="">
                                            <img data-src="./img/amari/Face/20.png" alt="">
                                            <img data-src="./img/amari/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Cap Letter/2.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/4.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/5.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/6.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/7.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/8.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/9.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/10.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/11.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/12.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/13.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/14.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/18.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/20.png" alt="">
                                            <img data-src="./img/amari/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Cap/2.png" alt="">
                                            <img data-src="./img/amari/Cap/4.png" alt="">
                                            <img data-src="./img/amari/Cap/5.png" alt="">
                                            <img data-src="./img/amari/Cap/6.png" alt="">
                                            <img data-src="./img/amari/Cap/7.png" alt="">
                                            <img data-src="./img/amari/Cap/8.png" alt="">
                                            <img data-src="./img/amari/Cap/9.png" alt="">
                                            <img data-src="./img/amari/Cap/10.png" alt="">
                                            <img data-src="./img/amari/Cap/11.png" alt="">
                                            <img data-src="./img/amari/Cap/12.png" alt="">
                                            <img data-src="./img/amari/Cap/13.png" alt="">
                                            <img data-src="./img/amari/Cap/14.png" alt="">
                                            <img data-src="./img/amari/Cap/18.png" alt="">
                                            <img data-src="./img/amari/Cap/20.png" alt="">
                                            <img data-src="./img/amari/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/amari/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Bolts/2.png" alt="">
                                            <img data-src="./img/amari/Bolts/4.png" alt="">
                                            <img data-src="./img/amari/Bolts/5.png" alt="">
                                            <img data-src="./img/amari/Bolts/6.png" alt="">
                                            <img data-src="./img/amari/Bolts/7.png" alt="">
                                            <img data-src="./img/amari/Bolts/8.png" alt="">
                                            <img data-src="./img/amari/Bolts/9.png" alt="">
                                            <img data-src="./img/amari/Bolts/10.png" alt="">
                                            <img data-src="./img/amari/Bolts/11.png" alt="">
                                            <img data-src="./img/amari/Bolts/12.png" alt="">
                                            <img data-src="./img/amari/Bolts/13.png" alt="">
                                            <img data-src="./img/amari/Bolts/14.png" alt="">
                                            <img data-src="./img/amari/Bolts/18.png" alt="">
                                            <img data-src="./img/amari/Bolts/20.png" alt="">
                                            <img data-src="./img/amari/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/amari/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/amari/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/amari/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/amari/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./amari-sf-9549.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
