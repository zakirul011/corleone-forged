...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'ARTEMUS | SF-3844', 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper artemus-sf-3844 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>ARTEMUS <span>its easy to build</span></h3>
                                <h1>SF-3844</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/artemus/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/artemus/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/artemus/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/artemus/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/artemus/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/artemus/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/artemus/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/artemus/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Accents/2.png" alt="">
                                            <img data-src="./img/artemus/Accents/4.png" alt="">
                                            <img data-src="./img/artemus/Accents/5.png" alt="">
                                            <img data-src="./img/artemus/Accents/6.png" alt="">
                                            <img data-src="./img/artemus/Accents/7.png" alt="">
                                            <img data-src="./img/artemus/Accents/8.png" alt="">
                                            <img data-src="./img/artemus/Accents/9.png" alt="">
                                            <img data-src="./img/artemus/Accents/10.png" alt="">
                                            <img data-src="./img/artemus/Accents/11.png" alt="">
                                            <img data-src="./img/artemus/Accents/12.png" alt="">
                                            <img data-src="./img/artemus/Accents/13.png" alt="">
                                            <img data-src="./img/artemus/Accents/14.png" alt="">
                                            <img data-src="./img/artemus/Accents/18.png" alt="">
                                            <img data-src="./img/artemus/Accents/20.png" alt="">
                                            <img data-src="./img/artemus/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Face/2.png" alt="">
                                            <img data-src="./img/artemus/Face/4.png" alt="">
                                            <img data-src="./img/artemus/Face/5.png" alt="">
                                            <img data-src="./img/artemus/Face/6.png" alt="">
                                            <img data-src="./img/artemus/Face/7.png" alt="">
                                            <img data-src="./img/artemus/Face/8.png" alt="">
                                            <img data-src="./img/artemus/Face/9.png" alt="">
                                            <img data-src="./img/artemus/Face/10.png" alt="">
                                            <img data-src="./img/artemus/Face/11.png" alt="">
                                            <img data-src="./img/artemus/Face/12.png" alt="">
                                            <img data-src="./img/artemus/Face/13.png" alt="">
                                            <img data-src="./img/artemus/Face/14.png" alt="">
                                            <img data-src="./img/artemus/Face/18.png" alt="">
                                            <img data-src="./img/artemus/Face/20.png" alt="">
                                            <img data-src="./img/artemus/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Cap Letter/2.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/4.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/5.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/6.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/7.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/8.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/9.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/10.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/11.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/12.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/13.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/14.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/18.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/20.png" alt="">
                                            <img data-src="./img/artemus/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Cap/2.png" alt="">
                                            <img data-src="./img/artemus/Cap/4.png" alt="">
                                            <img data-src="./img/artemus/Cap/5.png" alt="">
                                            <img data-src="./img/artemus/Cap/6.png" alt="">
                                            <img data-src="./img/artemus/Cap/7.png" alt="">
                                            <img data-src="./img/artemus/Cap/8.png" alt="">
                                            <img data-src="./img/artemus/Cap/9.png" alt="">
                                            <img data-src="./img/artemus/Cap/10.png" alt="">
                                            <img data-src="./img/artemus/Cap/11.png" alt="">
                                            <img data-src="./img/artemus/Cap/12.png" alt="">
                                            <img data-src="./img/artemus/Cap/13.png" alt="">
                                            <img data-src="./img/artemus/Cap/14.png" alt="">
                                            <img data-src="./img/artemus/Cap/18.png" alt="">
                                            <img data-src="./img/artemus/Cap/20.png" alt="">
                                            <img data-src="./img/artemus/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/artemus/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Bolts/2.png" alt="">
                                            <img data-src="./img/artemus/Bolts/4.png" alt="">
                                            <img data-src="./img/artemus/Bolts/5.png" alt="">
                                            <img data-src="./img/artemus/Bolts/6.png" alt="">
                                            <img data-src="./img/artemus/Bolts/7.png" alt="">
                                            <img data-src="./img/artemus/Bolts/8.png" alt="">
                                            <img data-src="./img/artemus/Bolts/9.png" alt="">
                                            <img data-src="./img/artemus/Bolts/10.png" alt="">
                                            <img data-src="./img/artemus/Bolts/11.png" alt="">
                                            <img data-src="./img/artemus/Bolts/12.png" alt="">
                                            <img data-src="./img/artemus/Bolts/13.png" alt="">
                                            <img data-src="./img/artemus/Bolts/14.png" alt="">
                                            <img data-src="./img/artemus/Bolts/18.png" alt="">
                                            <img data-src="./img/artemus/Bolts/20.png" alt="">
                                            <img data-src="./img/artemus/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/artemus/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/artemus/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/artemus/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/artemus/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./artemus-sf-3844.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
