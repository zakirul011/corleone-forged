...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'BRASI | SF-8653', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper brasi-sf-8653 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>BRASI <span>its easy to build</span></h3>
                                <h1>SF-8653</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/brasi/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brasi/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brasi/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brasi/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brasi/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brasi/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brasi/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/brasi/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/brasi/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Accents/2.png" alt="">
                                            <img data-src="./img/brasi/Accents/4.png" alt="">
                                            <img data-src="./img/brasi/Accents/5.png" alt="">
                                            <img data-src="./img/brasi/Accents/6.png" alt="">
                                            <img data-src="./img/brasi/Accents/7.png" alt="">
                                            <img data-src="./img/brasi/Accents/8.png" alt="">
                                            <img data-src="./img/brasi/Accents/9.png" alt="">
                                            <img data-src="./img/brasi/Accents/10.png" alt="">
                                            <img data-src="./img/brasi/Accents/11.png" alt="">
                                            <img data-src="./img/brasi/Accents/12.png" alt="">
                                            <img data-src="./img/brasi/Accents/13.png" alt="">
                                            <img data-src="./img/brasi/Accents/14.png" alt="">
                                            <img data-src="./img/brasi/Accents/18.png" alt="">
                                            <img data-src="./img/brasi/Accents/20.png" alt="">
                                            <img data-src="./img/brasi/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Face Letter/2.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/4.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/5.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/6.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/7.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/8.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/9.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/10.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/11.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/12.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/13.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/14.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/18.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/20.png" alt="">
                                            <img data-src="./img/brasi/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Face/2.png" alt="">
                                            <img data-src="./img/brasi/Face/4.png" alt="">
                                            <img data-src="./img/brasi/Face/5.png" alt="">
                                            <img data-src="./img/brasi/Face/6.png" alt="">
                                            <img data-src="./img/brasi/Face/7.png" alt="">
                                            <img data-src="./img/brasi/Face/8.png" alt="">
                                            <img data-src="./img/brasi/Face/9.png" alt="">
                                            <img data-src="./img/brasi/Face/10.png" alt="">
                                            <img data-src="./img/brasi/Face/11.png" alt="">
                                            <img data-src="./img/brasi/Face/12.png" alt="">
                                            <img data-src="./img/brasi/Face/13.png" alt="">
                                            <img data-src="./img/brasi/Face/14.png" alt="">
                                            <img data-src="./img/brasi/Face/18.png" alt="">
                                            <img data-src="./img/brasi/Face/20.png" alt="">
                                            <img data-src="./img/brasi/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Cap Letter/2.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/4.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/5.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/6.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/7.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/8.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/9.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/10.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/11.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/12.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/13.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/14.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/18.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/20.png" alt="">
                                            <img data-src="./img/brasi/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Cap/2.png" alt="">
                                            <img data-src="./img/brasi/Cap/4.png" alt="">
                                            <img data-src="./img/brasi/Cap/5.png" alt="">
                                            <img data-src="./img/brasi/Cap/6.png" alt="">
                                            <img data-src="./img/brasi/Cap/7.png" alt="">
                                            <img data-src="./img/brasi/Cap/8.png" alt="">
                                            <img data-src="./img/brasi/Cap/9.png" alt="">
                                            <img data-src="./img/brasi/Cap/10.png" alt="">
                                            <img data-src="./img/brasi/Cap/11.png" alt="">
                                            <img data-src="./img/brasi/Cap/12.png" alt="">
                                            <img data-src="./img/brasi/Cap/13.png" alt="">
                                            <img data-src="./img/brasi/Cap/14.png" alt="">
                                            <img data-src="./img/brasi/Cap/18.png" alt="">
                                            <img data-src="./img/brasi/Cap/20.png" alt="">
                                            <img data-src="./img/brasi/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/brasi/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Bolts/2.png" alt="">
                                            <img data-src="./img/brasi/Bolts/4.png" alt="">
                                            <img data-src="./img/brasi/Bolts/5.png" alt="">
                                            <img data-src="./img/brasi/Bolts/6.png" alt="">
                                            <img data-src="./img/brasi/Bolts/7.png" alt="">
                                            <img data-src="./img/brasi/Bolts/8.png" alt="">
                                            <img data-src="./img/brasi/Bolts/9.png" alt="">
                                            <img data-src="./img/brasi/Bolts/10.png" alt="">
                                            <img data-src="./img/brasi/Bolts/11.png" alt="">
                                            <img data-src="./img/brasi/Bolts/12.png" alt="">
                                            <img data-src="./img/brasi/Bolts/13.png" alt="">
                                            <img data-src="./img/brasi/Bolts/14.png" alt="">
                                            <img data-src="./img/brasi/Bolts/18.png" alt="">
                                            <img data-src="./img/brasi/Bolts/20.png" alt="">
                                            <img data-src="./img/brasi/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/brasi/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/brasi/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/brasi/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/brasi/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./brasi-sf-8653.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
