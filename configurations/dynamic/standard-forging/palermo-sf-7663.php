...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'PALERMO | SF-7663', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper palermo-sf-7663 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>PALERMO <span>its easy to build</span></h3>
                                <h1>SF-7663</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/palermo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/palermo/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/palermo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/palermo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/palermo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/palermo/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/palermo/Navigation/outer-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/palermo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Accents/2.png" alt="">
                                            <img data-src="./img/palermo/Accents/4.png" alt="">
                                            <img data-src="./img/palermo/Accents/5.png" alt="">
                                            <img data-src="./img/palermo/Accents/6.png" alt="">
                                            <img data-src="./img/palermo/Accents/7.png" alt="">
                                            <img data-src="./img/palermo/Accents/8.png" alt="">
                                            <img data-src="./img/palermo/Accents/9.png" alt="">
                                            <img data-src="./img/palermo/Accents/10.png" alt="">
                                            <img data-src="./img/palermo/Accents/11.png" alt="">
                                            <img data-src="./img/palermo/Accents/12.png" alt="">
                                            <img data-src="./img/palermo/Accents/13.png" alt="">
                                            <img data-src="./img/palermo/Accents/14.png" alt="">
                                            <img data-src="./img/palermo/Accents/18.png" alt="">
                                            <img data-src="./img/palermo/Accents/20.png" alt="">
                                            <img data-src="./img/palermo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Face Letter/2.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/4.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/5.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/6.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/7.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/8.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/9.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/10.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/11.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/12.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/13.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/14.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/18.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/20.png" alt="">
                                            <img data-src="./img/palermo/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Face/2.png" alt="">
                                            <img data-src="./img/palermo/Face/4.png" alt="">
                                            <img data-src="./img/palermo/Face/5.png" alt="">
                                            <img data-src="./img/palermo/Face/6.png" alt="">
                                            <img data-src="./img/palermo/Face/7.png" alt="">
                                            <img data-src="./img/palermo/Face/8.png" alt="">
                                            <img data-src="./img/palermo/Face/9.png" alt="">
                                            <img data-src="./img/palermo/Face/10.png" alt="">
                                            <img data-src="./img/palermo/Face/11.png" alt="">
                                            <img data-src="./img/palermo/Face/12.png" alt="">
                                            <img data-src="./img/palermo/Face/13.png" alt="">
                                            <img data-src="./img/palermo/Face/14.png" alt="">
                                            <img data-src="./img/palermo/Face/18.png" alt="">
                                            <img data-src="./img/palermo/Face/20.png" alt="">
                                            <img data-src="./img/palermo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/palermo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Cap/2.png" alt="">
                                            <img data-src="./img/palermo/Cap/4.png" alt="">
                                            <img data-src="./img/palermo/Cap/5.png" alt="">
                                            <img data-src="./img/palermo/Cap/6.png" alt="">
                                            <img data-src="./img/palermo/Cap/7.png" alt="">
                                            <img data-src="./img/palermo/Cap/8.png" alt="">
                                            <img data-src="./img/palermo/Cap/9.png" alt="">
                                            <img data-src="./img/palermo/Cap/10.png" alt="">
                                            <img data-src="./img/palermo/Cap/11.png" alt="">
                                            <img data-src="./img/palermo/Cap/12.png" alt="">
                                            <img data-src="./img/palermo/Cap/13.png" alt="">
                                            <img data-src="./img/palermo/Cap/14.png" alt="">
                                            <img data-src="./img/palermo/Cap/18.png" alt="">
                                            <img data-src="./img/palermo/Cap/20.png" alt="">
                                            <img data-src="./img/palermo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/palermo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Bolts/2.png" alt="">
                                            <img data-src="./img/palermo/Bolts/4.png" alt="">
                                            <img data-src="./img/palermo/Bolts/5.png" alt="">
                                            <img data-src="./img/palermo/Bolts/6.png" alt="">
                                            <img data-src="./img/palermo/Bolts/7.png" alt="">
                                            <img data-src="./img/palermo/Bolts/8.png" alt="">
                                            <img data-src="./img/palermo/Bolts/9.png" alt="">
                                            <img data-src="./img/palermo/Bolts/10.png" alt="">
                                            <img data-src="./img/palermo/Bolts/11.png" alt="">
                                            <img data-src="./img/palermo/Bolts/12.png" alt="">
                                            <img data-src="./img/palermo/Bolts/13.png" alt="">
                                            <img data-src="./img/palermo/Bolts/14.png" alt="">
                                            <img data-src="./img/palermo/Bolts/18.png" alt="">
                                            <img data-src="./img/palermo/Bolts/20.png" alt="">
                                            <img data-src="./img/palermo/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/palermo/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/palermo/Outer Barrel/2.png" alt="">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/palermo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./palermo-sf-7663.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
