...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'ACUTO | SF-6775', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper acuto-sf-6775 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>ACUTO <span>its easy to build</span></h3>
                                <h1>SF-6775</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/acuto/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/acuto/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/acuto/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/acuto/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/acuto/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/acuto/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/acuto/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/acuto/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/acuto/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Accents/2.png" alt="">
                                            <img data-src="./img/acuto/Accents/4.png" alt="">
                                            <img data-src="./img/acuto/Accents/5.png" alt="">
                                            <img data-src="./img/acuto/Accents/6.png" alt="">
                                            <img data-src="./img/acuto/Accents/7.png" alt="">
                                            <img data-src="./img/acuto/Accents/8.png" alt="">
                                            <img data-src="./img/acuto/Accents/9.png" alt="">
                                            <img data-src="./img/acuto/Accents/10.png" alt="">
                                            <img data-src="./img/acuto/Accents/11.png" alt="">
                                            <img data-src="./img/acuto/Accents/12.png" alt="">
                                            <img data-src="./img/acuto/Accents/13.png" alt="">
                                            <img data-src="./img/acuto/Accents/14.png" alt="">
                                            <img data-src="./img/acuto/Accents/18.png" alt="">
                                            <img data-src="./img/acuto/Accents/20.png" alt="">
                                            <img data-src="./img/acuto/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Face Letter/2.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/4.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/5.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/6.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/7.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/8.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/9.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/10.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/11.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/12.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/13.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/14.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/18.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/20.png" alt="">
                                            <img data-src="./img/acuto/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Face/2.png" alt="">
                                            <img data-src="./img/acuto/Face/4.png" alt="">
                                            <img data-src="./img/acuto/Face/5.png" alt="">
                                            <img data-src="./img/acuto/Face/6.png" alt="">
                                            <img data-src="./img/acuto/Face/7.png" alt="">
                                            <img data-src="./img/acuto/Face/8.png" alt="">
                                            <img data-src="./img/acuto/Face/9.png" alt="">
                                            <img data-src="./img/acuto/Face/10.png" alt="">
                                            <img data-src="./img/acuto/Face/11.png" alt="">
                                            <img data-src="./img/acuto/Face/12.png" alt="">
                                            <img data-src="./img/acuto/Face/13.png" alt="">
                                            <img data-src="./img/acuto/Face/14.png" alt="">
                                            <img data-src="./img/acuto/Face/18.png" alt="">
                                            <img data-src="./img/acuto/Face/20.png" alt="">
                                            <img data-src="./img/acuto/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Cap Letter/2.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/4.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/5.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/6.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/7.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/8.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/9.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/10.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/11.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/12.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/13.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/14.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/18.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/20.png" alt="">
                                            <img data-src="./img/acuto/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Cap/2.png" alt="">
                                            <img data-src="./img/acuto/Cap/4.png" alt="">
                                            <img data-src="./img/acuto/Cap/5.png" alt="">
                                            <img data-src="./img/acuto/Cap/6.png" alt="">
                                            <img data-src="./img/acuto/Cap/7.png" alt="">
                                            <img data-src="./img/acuto/Cap/8.png" alt="">
                                            <img data-src="./img/acuto/Cap/9.png" alt="">
                                            <img data-src="./img/acuto/Cap/10.png" alt="">
                                            <img data-src="./img/acuto/Cap/11.png" alt="">
                                            <img data-src="./img/acuto/Cap/12.png" alt="">
                                            <img data-src="./img/acuto/Cap/13.png" alt="">
                                            <img data-src="./img/acuto/Cap/14.png" alt="">
                                            <img data-src="./img/acuto/Cap/18.png" alt="">
                                            <img data-src="./img/acuto/Cap/20.png" alt="">
                                            <img data-src="./img/acuto/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/acuto/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Bolts/2.png" alt="">
                                            <img data-src="./img/acuto/Bolts/4.png" alt="">
                                            <img data-src="./img/acuto/Bolts/5.png" alt="">
                                            <img data-src="./img/acuto/Bolts/6.png" alt="">
                                            <img data-src="./img/acuto/Bolts/7.png" alt="">
                                            <img data-src="./img/acuto/Bolts/8.png" alt="">
                                            <img data-src="./img/acuto/Bolts/9.png" alt="">
                                            <img data-src="./img/acuto/Bolts/10.png" alt="">
                                            <img data-src="./img/acuto/Bolts/11.png" alt="">
                                            <img data-src="./img/acuto/Bolts/12.png" alt="">
                                            <img data-src="./img/acuto/Bolts/13.png" alt="">
                                            <img data-src="./img/acuto/Bolts/14.png" alt="">
                                            <img data-src="./img/acuto/Bolts/18.png" alt="">
                                            <img data-src="./img/acuto/Bolts/20.png" alt="">
                                            <img data-src="./img/acuto/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/acuto/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/acuto/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/acuto/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/acuto/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./acuto-sf-6775.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
