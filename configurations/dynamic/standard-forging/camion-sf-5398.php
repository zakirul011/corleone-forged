...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'CAMION | SF-5398', 'accents' => $accents, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper camion-sf-5398 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>CAMION <span>its easy to build</span></h3>
                                <h1>SF-5398</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/camion/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <img src="./img/camion/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/camion/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/camion/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/camion/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/camion/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/camion/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Accents/2.png" alt="">
                                            <img data-src="./img/camion/Accents/4.png" alt="">
                                            <img data-src="./img/camion/Accents/5.png" alt="">
                                            <img data-src="./img/camion/Accents/6.png" alt="">
                                            <img data-src="./img/camion/Accents/7.png" alt="">
                                            <img data-src="./img/camion/Accents/8.png" alt="">
                                            <img data-src="./img/camion/Accents/9.png" alt="">
                                            <img data-src="./img/camion/Accents/10.png" alt="">
                                            <img data-src="./img/camion/Accents/11.png" alt="">
                                            <img data-src="./img/camion/Accents/12.png" alt="">
                                            <img data-src="./img/camion/Accents/13.png" alt="">
                                            <img data-src="./img/camion/Accents/14.png" alt="">
                                            <img data-src="./img/camion/Accents/18.png" alt="">
                                            <img data-src="./img/camion/Accents/20.png" alt="">
                                            <img data-src="./img/camion/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Face/2.png" alt="">
                                            <img data-src="./img/camion/Face/4.png" alt="">
                                            <img data-src="./img/camion/Face/5.png" alt="">
                                            <img data-src="./img/camion/Face/6.png" alt="">
                                            <img data-src="./img/camion/Face/7.png" alt="">
                                            <img data-src="./img/camion/Face/8.png" alt="">
                                            <img data-src="./img/camion/Face/9.png" alt="">
                                            <img data-src="./img/camion/Face/10.png" alt="">
                                            <img data-src="./img/camion/Face/11.png" alt="">
                                            <img data-src="./img/camion/Face/12.png" alt="">
                                            <img data-src="./img/camion/Face/13.png" alt="">
                                            <img data-src="./img/camion/Face/14.png" alt="">
                                            <img data-src="./img/camion/Face/18.png" alt="">
                                            <img data-src="./img/camion/Face/20.png" alt="">
                                            <img data-src="./img/camion/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Cap Letter/2.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/4.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/5.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/6.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/7.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/8.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/9.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/10.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/11.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/12.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/13.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/14.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/18.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/20.png" alt="">
                                            <img data-src="./img/camion/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Cap/2.png" alt="">
                                            <img data-src="./img/camion/Cap/4.png" alt="">
                                            <img data-src="./img/camion/Cap/5.png" alt="">
                                            <img data-src="./img/camion/Cap/6.png" alt="">
                                            <img data-src="./img/camion/Cap/7.png" alt="">
                                            <img data-src="./img/camion/Cap/8.png" alt="">
                                            <img data-src="./img/camion/Cap/9.png" alt="">
                                            <img data-src="./img/camion/Cap/10.png" alt="">
                                            <img data-src="./img/camion/Cap/11.png" alt="">
                                            <img data-src="./img/camion/Cap/12.png" alt="">
                                            <img data-src="./img/camion/Cap/13.png" alt="">
                                            <img data-src="./img/camion/Cap/14.png" alt="">
                                            <img data-src="./img/camion/Cap/18.png" alt="">
                                            <img data-src="./img/camion/Cap/20.png" alt="">
                                            <img data-src="./img/camion/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/camion/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Bolts/2.png" alt="">
                                            <img data-src="./img/camion/Bolts/4.png" alt="">
                                            <img data-src="./img/camion/Bolts/5.png" alt="">
                                            <img data-src="./img/camion/Bolts/6.png" alt="">
                                            <img data-src="./img/camion/Bolts/7.png" alt="">
                                            <img data-src="./img/camion/Bolts/8.png" alt="">
                                            <img data-src="./img/camion/Bolts/9.png" alt="">
                                            <img data-src="./img/camion/Bolts/10.png" alt="">
                                            <img data-src="./img/camion/Bolts/11.png" alt="">
                                            <img data-src="./img/camion/Bolts/12.png" alt="">
                                            <img data-src="./img/camion/Bolts/13.png" alt="">
                                            <img data-src="./img/camion/Bolts/14.png" alt="">
                                            <img data-src="./img/camion/Bolts/18.png" alt="">
                                            <img data-src="./img/camion/Bolts/20.png" alt="">
                                            <img data-src="./img/camion/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/camion/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/camion/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/camion/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/camion/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./camion-sf-5398.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
