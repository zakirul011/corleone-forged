...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'STIMA | SF-6566', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper stima-sf-6566 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>STIMA <span>its easy to build</span></h3>
                                <h1>SF-6566</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/stima/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/stima/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/stima/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/stima/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/stima/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/stima/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/stima/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/stima/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/stima/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Accents/2.png" alt="">
                                            <img data-src="./img/stima/Accents/4.png" alt="">
                                            <img data-src="./img/stima/Accents/5.png" alt="">
                                            <img data-src="./img/stima/Accents/6.png" alt="">
                                            <img data-src="./img/stima/Accents/7.png" alt="">
                                            <img data-src="./img/stima/Accents/8.png" alt="">
                                            <img data-src="./img/stima/Accents/9.png" alt="">
                                            <img data-src="./img/stima/Accents/10.png" alt="">
                                            <img data-src="./img/stima/Accents/11.png" alt="">
                                            <img data-src="./img/stima/Accents/12.png" alt="">
                                            <img data-src="./img/stima/Accents/13.png" alt="">
                                            <img data-src="./img/stima/Accents/14.png" alt="">
                                            <img data-src="./img/stima/Accents/18.png" alt="">
                                            <img data-src="./img/stima/Accents/20.png" alt="">
                                            <img data-src="./img/stima/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Face Letter/2.png" alt="">
                                            <img data-src="./img/stima/Face Letter/4.png" alt="">
                                            <img data-src="./img/stima/Face Letter/5.png" alt="">
                                            <img data-src="./img/stima/Face Letter/6.png" alt="">
                                            <img data-src="./img/stima/Face Letter/7.png" alt="">
                                            <img data-src="./img/stima/Face Letter/8.png" alt="">
                                            <img data-src="./img/stima/Face Letter/9.png" alt="">
                                            <img data-src="./img/stima/Face Letter/10.png" alt="">
                                            <img data-src="./img/stima/Face Letter/11.png" alt="">
                                            <img data-src="./img/stima/Face Letter/12.png" alt="">
                                            <img data-src="./img/stima/Face Letter/13.png" alt="">
                                            <img data-src="./img/stima/Face Letter/14.png" alt="">
                                            <img data-src="./img/stima/Face Letter/18.png" alt="">
                                            <img data-src="./img/stima/Face Letter/20.png" alt="">
                                            <img data-src="./img/stima/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Face/2.png" alt="">
                                            <img data-src="./img/stima/Face/4.png" alt="">
                                            <img data-src="./img/stima/Face/5.png" alt="">
                                            <img data-src="./img/stima/Face/6.png" alt="">
                                            <img data-src="./img/stima/Face/7.png" alt="">
                                            <img data-src="./img/stima/Face/8.png" alt="">
                                            <img data-src="./img/stima/Face/9.png" alt="">
                                            <img data-src="./img/stima/Face/10.png" alt="">
                                            <img data-src="./img/stima/Face/11.png" alt="">
                                            <img data-src="./img/stima/Face/12.png" alt="">
                                            <img data-src="./img/stima/Face/13.png" alt="">
                                            <img data-src="./img/stima/Face/14.png" alt="">
                                            <img data-src="./img/stima/Face/18.png" alt="">
                                            <img data-src="./img/stima/Face/20.png" alt="">
                                            <img data-src="./img/stima/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Cap Letter/2.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/4.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/5.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/6.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/7.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/8.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/9.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/10.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/11.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/12.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/13.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/14.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/18.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/20.png" alt="">
                                            <img data-src="./img/stima/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Cap/2.png" alt="">
                                            <img data-src="./img/stima/Cap/4.png" alt="">
                                            <img data-src="./img/stima/Cap/5.png" alt="">
                                            <img data-src="./img/stima/Cap/6.png" alt="">
                                            <img data-src="./img/stima/Cap/7.png" alt="">
                                            <img data-src="./img/stima/Cap/8.png" alt="">
                                            <img data-src="./img/stima/Cap/9.png" alt="">
                                            <img data-src="./img/stima/Cap/10.png" alt="">
                                            <img data-src="./img/stima/Cap/11.png" alt="">
                                            <img data-src="./img/stima/Cap/12.png" alt="">
                                            <img data-src="./img/stima/Cap/13.png" alt="">
                                            <img data-src="./img/stima/Cap/14.png" alt="">
                                            <img data-src="./img/stima/Cap/18.png" alt="">
                                            <img data-src="./img/stima/Cap/20.png" alt="">
                                            <img data-src="./img/stima/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/stima/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Bolts/2.png" alt="">
                                            <img data-src="./img/stima/Bolts/4.png" alt="">
                                            <img data-src="./img/stima/Bolts/5.png" alt="">
                                            <img data-src="./img/stima/Bolts/6.png" alt="">
                                            <img data-src="./img/stima/Bolts/7.png" alt="">
                                            <img data-src="./img/stima/Bolts/8.png" alt="">
                                            <img data-src="./img/stima/Bolts/9.png" alt="">
                                            <img data-src="./img/stima/Bolts/10.png" alt="">
                                            <img data-src="./img/stima/Bolts/11.png" alt="">
                                            <img data-src="./img/stima/Bolts/12.png" alt="">
                                            <img data-src="./img/stima/Bolts/13.png" alt="">
                                            <img data-src="./img/stima/Bolts/14.png" alt="">
                                            <img data-src="./img/stima/Bolts/18.png" alt="">
                                            <img data-src="./img/stima/Bolts/20.png" alt="">
                                            <img data-src="./img/stima/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/stima/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/stima/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/stima/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/stima/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./stima-sf-6566.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
