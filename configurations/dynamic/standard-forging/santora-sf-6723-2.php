...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'SANTORA | SF-6723-2', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper santora-sf-6723-2 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>SANTORA <span>its easy to build</span></h3>
                                <h1>SF-6723-2</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/santora/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/santora/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/santora/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/santora/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/santora/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/santora/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/santora/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/santora/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/santora/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Accents/2.png" alt="">
                                            <img data-src="./img/santora/Accents/4.png" alt="">
                                            <img data-src="./img/santora/Accents/5.png" alt="">
                                            <img data-src="./img/santora/Accents/6.png" alt="">
                                            <img data-src="./img/santora/Accents/7.png" alt="">
                                            <img data-src="./img/santora/Accents/8.png" alt="">
                                            <img data-src="./img/santora/Accents/9.png" alt="">
                                            <img data-src="./img/santora/Accents/10.png" alt="">
                                            <img data-src="./img/santora/Accents/11.png" alt="">
                                            <img data-src="./img/santora/Accents/12.png" alt="">
                                            <img data-src="./img/santora/Accents/13.png" alt="">
                                            <img data-src="./img/santora/Accents/14.png" alt="">
                                            <img data-src="./img/santora/Accents/18.png" alt="">
                                            <img data-src="./img/santora/Accents/20.png" alt="">
                                            <img data-src="./img/santora/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Face Letter/2.png" alt="">
                                            <img data-src="./img/santora/Face Letter/4.png" alt="">
                                            <img data-src="./img/santora/Face Letter/5.png" alt="">
                                            <img data-src="./img/santora/Face Letter/6.png" alt="">
                                            <img data-src="./img/santora/Face Letter/7.png" alt="">
                                            <img data-src="./img/santora/Face Letter/8.png" alt="">
                                            <img data-src="./img/santora/Face Letter/9.png" alt="">
                                            <img data-src="./img/santora/Face Letter/10.png" alt="">
                                            <img data-src="./img/santora/Face Letter/11.png" alt="">
                                            <img data-src="./img/santora/Face Letter/12.png" alt="">
                                            <img data-src="./img/santora/Face Letter/13.png" alt="">
                                            <img data-src="./img/santora/Face Letter/14.png" alt="">
                                            <img data-src="./img/santora/Face Letter/18.png" alt="">
                                            <img data-src="./img/santora/Face Letter/20.png" alt="">
                                            <img data-src="./img/santora/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Face/2.png" alt="">
                                            <img data-src="./img/santora/Face/4.png" alt="">
                                            <img data-src="./img/santora/Face/5.png" alt="">
                                            <img data-src="./img/santora/Face/6.png" alt="">
                                            <img data-src="./img/santora/Face/7.png" alt="">
                                            <img data-src="./img/santora/Face/8.png" alt="">
                                            <img data-src="./img/santora/Face/9.png" alt="">
                                            <img data-src="./img/santora/Face/10.png" alt="">
                                            <img data-src="./img/santora/Face/11.png" alt="">
                                            <img data-src="./img/santora/Face/12.png" alt="">
                                            <img data-src="./img/santora/Face/13.png" alt="">
                                            <img data-src="./img/santora/Face/14.png" alt="">
                                            <img data-src="./img/santora/Face/18.png" alt="">
                                            <img data-src="./img/santora/Face/20.png" alt="">
                                            <img data-src="./img/santora/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Cap Letter/2.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/4.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/5.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/6.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/7.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/8.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/9.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/10.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/11.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/12.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/13.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/14.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/18.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/20.png" alt="">
                                            <img data-src="./img/santora/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Cap/2.png" alt="">
                                            <img data-src="./img/santora/Cap/4.png" alt="">
                                            <img data-src="./img/santora/Cap/5.png" alt="">
                                            <img data-src="./img/santora/Cap/6.png" alt="">
                                            <img data-src="./img/santora/Cap/7.png" alt="">
                                            <img data-src="./img/santora/Cap/8.png" alt="">
                                            <img data-src="./img/santora/Cap/9.png" alt="">
                                            <img data-src="./img/santora/Cap/10.png" alt="">
                                            <img data-src="./img/santora/Cap/11.png" alt="">
                                            <img data-src="./img/santora/Cap/12.png" alt="">
                                            <img data-src="./img/santora/Cap/13.png" alt="">
                                            <img data-src="./img/santora/Cap/14.png" alt="">
                                            <img data-src="./img/santora/Cap/18.png" alt="">
                                            <img data-src="./img/santora/Cap/20.png" alt="">
                                            <img data-src="./img/santora/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/santora/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Bolts/2.png" alt="">
                                            <img data-src="./img/santora/Bolts/4.png" alt="">
                                            <img data-src="./img/santora/Bolts/5.png" alt="">
                                            <img data-src="./img/santora/Bolts/6.png" alt="">
                                            <img data-src="./img/santora/Bolts/7.png" alt="">
                                            <img data-src="./img/santora/Bolts/8.png" alt="">
                                            <img data-src="./img/santora/Bolts/9.png" alt="">
                                            <img data-src="./img/santora/Bolts/10.png" alt="">
                                            <img data-src="./img/santora/Bolts/11.png" alt="">
                                            <img data-src="./img/santora/Bolts/12.png" alt="">
                                            <img data-src="./img/santora/Bolts/13.png" alt="">
                                            <img data-src="./img/santora/Bolts/14.png" alt="">
                                            <img data-src="./img/santora/Bolts/18.png" alt="">
                                            <img data-src="./img/santora/Bolts/20.png" alt="">
                                            <img data-src="./img/santora/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/santora/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/santora/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/santora/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/santora/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./santora-sf-6723-2.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
