...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'GALLO | SF-4437', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap,'bolts' => $bolts
    ...
    <div class="config-wrapper gallo-sf-4437 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>GALLO <span>its easy to build</span></h3>
                                <h1>SF-4437</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/gallo/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gallo/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gallo/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gallo/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gallo/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gallo/Navigation/bolts.png" alt="">
                                                    <span>Bolts</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gallo/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/gallo/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/gallo/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Accents/2.png" alt="">
                                            <img data-src="./img/gallo/Accents/4.png" alt="">
                                            <img data-src="./img/gallo/Accents/5.png" alt="">
                                            <img data-src="./img/gallo/Accents/6.png" alt="">
                                            <img data-src="./img/gallo/Accents/7.png" alt="">
                                            <img data-src="./img/gallo/Accents/8.png" alt="">
                                            <img data-src="./img/gallo/Accents/9.png" alt="">
                                            <img data-src="./img/gallo/Accents/10.png" alt="">
                                            <img data-src="./img/gallo/Accents/11.png" alt="">
                                            <img data-src="./img/gallo/Accents/12.png" alt="">
                                            <img data-src="./img/gallo/Accents/13.png" alt="">
                                            <img data-src="./img/gallo/Accents/14.png" alt="">
                                            <img data-src="./img/gallo/Accents/18.png" alt="">
                                            <img data-src="./img/gallo/Accents/20.png" alt="">
                                            <img data-src="./img/gallo/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Face Letter/2.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/4.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/5.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/6.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/7.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/8.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/9.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/10.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/11.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/12.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/13.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/14.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/18.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/20.png" alt="">
                                            <img data-src="./img/gallo/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Face/2.png" alt="">
                                            <img data-src="./img/gallo/Face/4.png" alt="">
                                            <img data-src="./img/gallo/Face/5.png" alt="">
                                            <img data-src="./img/gallo/Face/6.png" alt="">
                                            <img data-src="./img/gallo/Face/7.png" alt="">
                                            <img data-src="./img/gallo/Face/8.png" alt="">
                                            <img data-src="./img/gallo/Face/9.png" alt="">
                                            <img data-src="./img/gallo/Face/10.png" alt="">
                                            <img data-src="./img/gallo/Face/11.png" alt="">
                                            <img data-src="./img/gallo/Face/12.png" alt="">
                                            <img data-src="./img/gallo/Face/13.png" alt="">
                                            <img data-src="./img/gallo/Face/14.png" alt="">
                                            <img data-src="./img/gallo/Face/18.png" alt="">
                                            <img data-src="./img/gallo/Face/20.png" alt="">
                                            <img data-src="./img/gallo/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Cap Letter/2.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/4.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/5.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/6.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/7.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/8.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/9.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/10.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/11.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/12.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/13.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/14.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/18.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/20.png" alt="">
                                            <img data-src="./img/gallo/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Cap/2.png" alt="">
                                            <img data-src="./img/gallo/Cap/4.png" alt="">
                                            <img data-src="./img/gallo/Cap/5.png" alt="">
                                            <img data-src="./img/gallo/Cap/6.png" alt="">
                                            <img data-src="./img/gallo/Cap/7.png" alt="">
                                            <img data-src="./img/gallo/Cap/8.png" alt="">
                                            <img data-src="./img/gallo/Cap/9.png" alt="">
                                            <img data-src="./img/gallo/Cap/10.png" alt="">
                                            <img data-src="./img/gallo/Cap/11.png" alt="">
                                            <img data-src="./img/gallo/Cap/12.png" alt="">
                                            <img data-src="./img/gallo/Cap/13.png" alt="">
                                            <img data-src="./img/gallo/Cap/14.png" alt="">
                                            <img data-src="./img/gallo/Cap/18.png" alt="">
                                            <img data-src="./img/gallo/Cap/20.png" alt="">
                                            <img data-src="./img/gallo/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/gallo/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Bolts/2.png" alt="">
                                            <img data-src="./img/gallo/Bolts/4.png" alt="">
                                            <img data-src="./img/gallo/Bolts/5.png" alt="">
                                            <img data-src="./img/gallo/Bolts/6.png" alt="">
                                            <img data-src="./img/gallo/Bolts/7.png" alt="">
                                            <img data-src="./img/gallo/Bolts/8.png" alt="">
                                            <img data-src="./img/gallo/Bolts/9.png" alt="">
                                            <img data-src="./img/gallo/Bolts/10.png" alt="">
                                            <img data-src="./img/gallo/Bolts/11.png" alt="">
                                            <img data-src="./img/gallo/Bolts/12.png" alt="">
                                            <img data-src="./img/gallo/Bolts/13.png" alt="">
                                            <img data-src="./img/gallo/Bolts/14.png" alt="">
                                            <img data-src="./img/gallo/Bolts/18.png" alt="">
                                            <img data-src="./img/gallo/Bolts/20.png" alt="">
                                            <img data-src="./img/gallo/Bolts/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Bolts/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/gallo/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/gallo/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/gallo/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/gallo/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./gallo-sf-4437.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
