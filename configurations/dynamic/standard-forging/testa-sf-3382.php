...
<body>
    ...
    <main>
        ...
        $email_content = includeWithVariables($_SERVER['DOCUMENT_ROOT'].'standard-forging/email-template/email.php', array('name' => $name, 'email' => $email, 'phone'=> $phone, 'zipcode' => $zipcode, 'city' => $city, 'city' => $city, 'state' => $state, 'status' => $dealer, 'message' => $message, 'wheel-name' => 'TESTA | SF-3382', 'accents' => $accents, 'faceletter' => $faceletter, 'face' => $face, 'capletter' => $capletter, 'cap' => $cap, 'outerbarrel' => $outerbarrel, 'innerbarrrel' => $innerbarrrel,'image_path' => $image_path    ));
    ...
    <div class="config-wrapper testa-sf-3382 pb-120 pb-xs-60 pb-md-80 bg-attachment" style="background-image: url(./../assets/img/config/config-bg.jpg);">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-3 col-md-5">
                            <div class="config-title">
                                ...
                                <h3>TESTA <span>its easy to build</span></h3>
                                <h1>SF-3382</h1>
                                ...
                                <div class="config-navigation-wrap">
                                    ...
                                    <div class="config-navigation mt-50 mt-xs-20 mt-md-20">
                                        <div class="navigation-slider">
                                            <ul>
                                                <li>
                                                    <img src="./img/testa/Navigation/accents.png" alt="">
                                                    <span>accents</span>
                                                </li>
                                                <li>
                                                    <img src="./img/testa/Navigation/face-letter.png" alt="">
                                                    <span>face-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/testa/Navigation/face.png" alt="">
                                                    <span>face</span>
                                                </li>
                                                <li>
                                                    <img src="./img/testa/Navigation/cap-letter.png" alt="">
                                                    <span>cap-letter</span>
                                                </li>
                                                <li>
                                                    <img src="./img/testa/Navigation/cap.png" alt="">
                                                    <span>cap</span>
                                                </li>
                                                <li>
                                                    <img src="./img/testa/Navigation/outer-barrel.png" alt="">
                                                    <span>outer-barrel</span>
                                                </li>
                                                <li>
                                                    <img src="./img/testa/Navigation/inner-barrel.png" alt="">
                        ...
                        <div class="col-lg-5 col-md-7 text-center text-md-start">
                            <div class="config-wheel-wrap" id="capture">
                                ...
                                <div class="config-main-wheel">
                                    ...
                                    <img src="./img/testa/default-model.png" alt="">
                                </div>
                                ...
                                <div class="config-part-wrap">
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Accents/2.png" alt="">
                                            <img data-src="./img/testa/Accents/4.png" alt="">
                                            <img data-src="./img/testa/Accents/5.png" alt="">
                                            <img data-src="./img/testa/Accents/6.png" alt="">
                                            <img data-src="./img/testa/Accents/7.png" alt="">
                                            <img data-src="./img/testa/Accents/8.png" alt="">
                                            <img data-src="./img/testa/Accents/9.png" alt="">
                                            <img data-src="./img/testa/Accents/10.png" alt="">
                                            <img data-src="./img/testa/Accents/11.png" alt="">
                                            <img data-src="./img/testa/Accents/12.png" alt="">
                                            <img data-src="./img/testa/Accents/13.png" alt="">
                                            <img data-src="./img/testa/Accents/14.png" alt="">
                                            <img data-src="./img/testa/Accents/18.png" alt="">
                                            <img data-src="./img/testa/Accents/20.png" alt="">
                                            <img data-src="./img/testa/Accents/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Accents/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Face Letter/2.png" alt="">
                                            <img data-src="./img/testa/Face Letter/4.png" alt="">
                                            <img data-src="./img/testa/Face Letter/5.png" alt="">
                                            <img data-src="./img/testa/Face Letter/6.png" alt="">
                                            <img data-src="./img/testa/Face Letter/7.png" alt="">
                                            <img data-src="./img/testa/Face Letter/8.png" alt="">
                                            <img data-src="./img/testa/Face Letter/9.png" alt="">
                                            <img data-src="./img/testa/Face Letter/10.png" alt="">
                                            <img data-src="./img/testa/Face Letter/11.png" alt="">
                                            <img data-src="./img/testa/Face Letter/12.png" alt="">
                                            <img data-src="./img/testa/Face Letter/13.png" alt="">
                                            <img data-src="./img/testa/Face Letter/14.png" alt="">
                                            <img data-src="./img/testa/Face Letter/18.png" alt="">
                                            <img data-src="./img/testa/Face Letter/20.png" alt="">
                                            <img data-src="./img/testa/Face Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Face Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Face/2.png" alt="">
                                            <img data-src="./img/testa/Face/4.png" alt="">
                                            <img data-src="./img/testa/Face/5.png" alt="">
                                            <img data-src="./img/testa/Face/6.png" alt="">
                                            <img data-src="./img/testa/Face/7.png" alt="">
                                            <img data-src="./img/testa/Face/8.png" alt="">
                                            <img data-src="./img/testa/Face/9.png" alt="">
                                            <img data-src="./img/testa/Face/10.png" alt="">
                                            <img data-src="./img/testa/Face/11.png" alt="">
                                            <img data-src="./img/testa/Face/12.png" alt="">
                                            <img data-src="./img/testa/Face/13.png" alt="">
                                            <img data-src="./img/testa/Face/14.png" alt="">
                                            <img data-src="./img/testa/Face/18.png" alt="">
                                            <img data-src="./img/testa/Face/20.png" alt="">
                                            <img data-src="./img/testa/Face/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Face/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Cap Letter/2.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/4.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/5.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/6.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/7.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/8.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/9.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/10.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/11.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/12.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/13.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/14.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/18.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/20.png" alt="">
                                            <img data-src="./img/testa/Cap Letter/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Cap Letter/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Cap/2.png" alt="">
                                            <img data-src="./img/testa/Cap/4.png" alt="">
                                            <img data-src="./img/testa/Cap/5.png" alt="">
                                            <img data-src="./img/testa/Cap/6.png" alt="">
                                            <img data-src="./img/testa/Cap/7.png" alt="">
                                            <img data-src="./img/testa/Cap/8.png" alt="">
                                            <img data-src="./img/testa/Cap/9.png" alt="">
                                            <img data-src="./img/testa/Cap/10.png" alt="">
                                            <img data-src="./img/testa/Cap/11.png" alt="">
                                            <img data-src="./img/testa/Cap/12.png" alt="">
                                            <img data-src="./img/testa/Cap/13.png" alt="">
                                            <img data-src="./img/testa/Cap/14.png" alt="">
                                            <img data-src="./img/testa/Cap/18.png" alt="">
                                            <img data-src="./img/testa/Cap/20.png" alt="">
                                            <img data-src="./img/testa/Cap/1.png" alt="">
                                        </div>
                                      <div class="config-part-category">
                                          <img data-src="./img/testa/Cap/2.png" alt="">
                                      </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Outer Barrel/2.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/4.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/5.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/6.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/7.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/8.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/9.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/10.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/11.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/12.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/13.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/14.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/18.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/20.png" alt="">
                                            <img data-src="./img/testa/Outer Barrel/1.png" alt="">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Outer Barrel/2.png" alt="">
                                        </div>
                                    ...
                                    <div class="config-part-page">
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Inner Barrel/2.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/4.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/5.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/6.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/7.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/8.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/9.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/10.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/11.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/12.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/13.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/14.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/18.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/20.png" alt="Inner Barrel">
                                            <img data-src="./img/testa/Inner Barrel/1.png" alt="Inner Barrel">
                                        </div>
                                        <div class="config-part-category">
                                            <img data-src="./img/testa/Inner Barrel/2.png" alt="Inner Barrel">
                                        </div>
                                            ...
                                            <div class="selected-color-wrap active boxed-blur bg-attachment mb-50 mb-xs-20 mb-md-40" style="background-image: url(./../assets/img/config/selected-color-bg.jpg);">
                                                ...
                                                <div class="preview-wheel-wrap">
                                                    <div class="preview-wheel mt-30">
                                                        ...
                                                        <img src="./img/testa/default-model.png" class="preview">
                    ...
                    <div class="col-lg-10">
                        <div class="thankyou-content text-center bg-attachment" style="background-image: url(./../assets/img/thankyou/thankyou-bg.jpg)">
                            ...
                            <div class="black-shop">
                                <a href="./testa-sf-3382.php" class="bordered-btn-v2 white-border">Back To Configurator</a>
                            </div>
