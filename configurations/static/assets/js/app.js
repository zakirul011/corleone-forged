...
let navigationMarginLeft;
let navigationMarginRight;
let navigationWidth;
            ...
            if (pageCounter < 0) {
               ...
               if (window.matchMedia("(max-width: 767px)").matches) {
                  if (pageCounter >= navigationShow) {
                     ...
                     configNavigationSlide.style.transform = `translate(${-(
                         navigationWidth * navigationSlideCount
                     )}px)`;
                  }
               }
            }else{
...
function getNavigationWidth() {
   if (window.matchMedia("(max-width: 767px)").matches) {
      navigationMarginLeft = parseInt(window.getComputedStyle(configNavigationLink[0]).marginLeft)
      navigationMarginRight = parseInt(window.getComputedStyle(configNavigationLink[0]).marginRight)
      let realWidth = configNavigationLink[0].clientWidth
      navigationWidth = realWidth + navigationMarginLeft + navigationMarginRight
